...
//!
//! So the three applications in `md-docs/20-cookbook.md` are extracted from the
...
fn cookbook() -> String {
    std::fs::read_to_string(repo_root().join("md-docs/20-cookbook.md")).expect("read the cookbook")
}
