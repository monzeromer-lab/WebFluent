...
function Page_Animation(params) {
  ...
  const _e622 = WF.h("p", { className: "wf-text" }, "Add an animation modifier to any component. It plays when the element appears. Hover each card to replay.");
  ...
  const _e625 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn"); } });
  ...
  const _e629 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideUp", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideUp"); } });
  ...
  const _e633 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-scaleIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "scaleIn"); } });
  ...
  const _e637 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideDown", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideDown"); } });
  ...
  const _e641 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideLeft", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideLeft"); } });
  ...
  const _e645 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-bounce", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "bounce"); } });
  ...
  const _e649 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-shake", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "shake"); } });
  const _e650 = WF.h("div", { className: "wf-card__body" });
  const _e651 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "shake");
  _e650.appendChild(_e651);
  const _e652 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Horizontal shake");
  _e650.appendChild(_e652);
  _e649.appendChild(_e650);
  _e624.appendChild(_e649);
  const _e653 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-pulse", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "pulse"); } });
  const _e654 = WF.h("div", { className: "wf-card__body" });
  const _e655 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "pulse");
  _e654.appendChild(_e655);
  const _e656 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Gentle scale pulse");
  _e654.appendChild(_e656);
  _e653.appendChild(_e654);
  _e624.appendChild(_e653);
  const _e657 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideRight", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideRight"); } });
  const _e658 = WF.h("div", { className: "wf-card__body" });
  const _e659 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slideRight");
  _e658.appendChild(_e659);
  const _e660 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Slides from left");
  _e658.appendChild(_e660);
  _e657.appendChild(_e658);
  _e624.appendChild(_e657);
  _e616.appendChild(_e624);
  const _e661 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e661);
  const _e662 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e663 = WF.h("div", { className: "wf-card__body" });
  const _e664 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn) { ... }\nHeading(\"Title\", h1, slideUp)\nButton(\"Click\", primary, bounce)");
  _e663.appendChild(_e664);
  _e662.appendChild(_e663);
  _e616.appendChild(_e662);
  const _e665 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e665);
  const _e666 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e666);
  const _e667 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e667);
  const _e668 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Live: Conditional Animation");
  _e616.appendChild(_e668);
  const _e669 = WF.h("p", { className: "wf-text" }, "Toggle the switch to see enter/exit animations on the card below.");
  _e616.appendChild(_e669);
  const _e670 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e670);
  const _e671 = WF.h("label", { className: "wf-switch" });
  const _e672 = WF.h("input", { type: "checkbox", checked: () => _showCard(), "on:change": () => _showCard.set(!_showCard()) });
  _e671.appendChild(_e672);
  const _e673 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e671.appendChild(_e673);
  _e671.appendChild(WF.text("Show animated card"));
  ...
  WF.condRender(_e616,
    () => _showCard(),
    () => {
      const _e675 = document.createDocumentFragment();
      const _e676 = WF.h("div", { className: "wf-card wf-card--elevated" });
      const _e677 = WF.h("div", { className: "wf-card__body" });
      const _e678 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Animated!");
      _e677.appendChild(_e678);
      const _e679 = WF.h("div", { className: "wf-spacer" });
      _e677.appendChild(_e679);
      const _e680 = WF.h("p", { className: "wf-text" }, "This card scales in and fades out.");
      _e677.appendChild(_e680);
      const _e681 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Controlled by: if showCard, animate(scaleIn, fadeOut)");
      _e677.appendChild(_e681);
      _e676.appendChild(_e677);
      _e675.appendChild(_e676);
      return _e675;
    },
    null,
  ...
  _e616.appendChild(_e682);
  const _e683 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e684 = WF.h("div", { className: "wf-card__body" });
  const _e685 = WF.h("code", { className: "wf-code wf-code--block" }, "if showCard, animate(scaleIn, fadeOut) {\n    Card(elevated) {\n        Text(\"Animated content\")\n    }\n}");
  _e684.appendChild(_e685);
  _e683.appendChild(_e684);
  _e616.appendChild(_e683);
  const _e686 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e686);
  const _e687 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e687);
  const _e688 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e688);
  const _e689 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Speed Variants");
  _e616.appendChild(_e689);
  const _e690 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e690);
  const _e691 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e692 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn", "150ms"); } });
  const _e693 = WF.h("div", { className: "wf-card__body" });
  const _e694 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "fast");
  _e693.appendChild(_e694);
  const _e695 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "150ms");
  _e693.appendChild(_e695);
  const _e696 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn, fast)");
  _e693.appendChild(_e696);
  _e692.appendChild(_e693);
  _e691.appendChild(_e692);
  const _e697 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn"); } });
  const _e698 = WF.h("div", { className: "wf-card__body" });
  const _e699 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "default");
  _e698.appendChild(_e699);
  const _e700 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "300ms");
  _e698.appendChild(_e700);
  const _e701 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn)");
  _e698.appendChild(_e701);
  _e697.appendChild(_e698);
  _e691.appendChild(_e697);
  const _e702 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn", "500ms"); } });
  const _e703 = WF.h("div", { className: "wf-card__body" });
  const _e704 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slow");
  _e703.appendChild(_e704);
  const _e705 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "500ms");
  _e703.appendChild(_e705);
  const _e706 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn, slow)");
  _e703.appendChild(_e706);
  _e702.appendChild(_e703);
  _e691.appendChild(_e702);
  _e616.appendChild(_e691);
  const _e707 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e707);
  const _e708 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e708);
  const _e709 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e709);
  const _e710 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "All 12 Animations");
  _e616.appendChild(_e710);
  const _e711 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e711);
  const _e712 = WF.h("table", { className: "wf-table" });
  const _e713 = WF.h("thead", {});
  const _e714 = WF.h("td", {}, "Name");
  _e713.appendChild(_e714);
  const _e715 = WF.h("td", {}, "Effect");
  _e713.appendChild(_e715);
  const _e716 = WF.h("td", {}, "Usage");
  _e713.appendChild(_e716);
  _e712.appendChild(_e713);
  const _e717 = WF.h("tr", {});
  const _e718 = WF.h("td", {}, "fadeIn / fadeOut");
  _e717.appendChild(_e718);
  const _e719 = WF.h("td", {}, "Opacity fade");
  _e717.appendChild(_e719);
  const _e720 = WF.h("td", {}, "Card(elevated, fadeIn)");
  _e717.appendChild(_e720);
  _e712.appendChild(_e717);
  const _e721 = WF.h("tr", {});
  const _e722 = WF.h("td", {}, "slideUp / slideDown");
  _e721.appendChild(_e722);
  const _e723 = WF.h("td", {}, "Vertical slide + fade");
  _e721.appendChild(_e723);
  const _e724 = WF.h("td", {}, "Heading(\"Hi\", h1, slideUp)");
  _e721.appendChild(_e724);
  _e712.appendChild(_e721);
  const _e725 = WF.h("tr", {});
  const _e726 = WF.h("td", {}, "slideLeft / slideRight");
  _e725.appendChild(_e726);
  const _e727 = WF.h("td", {}, "Horizontal slide + fade");
  _e725.appendChild(_e727);
  const _e728 = WF.h("td", {}, "Text(\"Hello\", slideLeft)");
  _e725.appendChild(_e728);
  _e712.appendChild(_e725);
  const _e729 = WF.h("tr", {});
  const _e730 = WF.h("td", {}, "scaleIn / scaleOut");
  _e729.appendChild(_e730);
  const _e731 = WF.h("td", {}, "Scale from/to 90%");
  _e729.appendChild(_e731);
  const _e732 = WF.h("td", {}, "Badge(\"New\", scaleIn)");
  _e729.appendChild(_e732);
  _e712.appendChild(_e729);
  const _e733 = WF.h("tr", {});
  const _e734 = WF.h("td", {}, "bounce");
  _e733.appendChild(_e734);
  const _e735 = WF.h("td", {}, "Bouncy entrance");
  _e733.appendChild(_e735);
  const _e736 = WF.h("td", {}, "Button(\"Go\", bounce)");
  _e733.appendChild(_e736);
  _e712.appendChild(_e733);
  const _e737 = WF.h("tr", {});
  const _e738 = WF.h("td", {}, "shake");
  _e737.appendChild(_e738);
  const _e739 = WF.h("td", {}, "Horizontal shake");
  _e737.appendChild(_e739);
  const _e740 = WF.h("td", {}, "Alert(\"Error!\", shake)");
  _e737.appendChild(_e740);
  _e712.appendChild(_e737);
  const _e741 = WF.h("tr", {});
  const _e742 = WF.h("td", {}, "pulse");
  _e741.appendChild(_e742);
  const _e743 = WF.h("td", {}, "Scale pulse (infinite)");
  _e741.appendChild(_e743);
  const _e744 = WF.h("td", {}, "Badge(\"Live\", pulse)");
  _e741.appendChild(_e744);
  _e712.appendChild(_e741);
  const _e745 = WF.h("tr", {});
  const _e746 = WF.h("td", {}, "spin");
  _e745.appendChild(_e746);
  const _e747 = WF.h("td", {}, "360-degree rotation");
  _e745.appendChild(_e747);
  const _e748 = WF.h("td", {}, "Spinner(spin)");
  _e745.appendChild(_e748);
  _e712.appendChild(_e745);
  _e616.appendChild(_e712);
  const _e749 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e749);
  const _e750 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e750);
  const _e751 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e751);
  const _e752 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Conditional Animations");
  _e616.appendChild(_e752);
  const _e753 = WF.h("p", { className: "wf-text" }, "Attach enter and exit animations to if blocks.");
  _e616.appendChild(_e753);
  const _e754 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e754);
  const _e755 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e756 = WF.h("div", { className: "wf-card__body" });
  const _e757 = WF.h("code", { className: "wf-code wf-code--block" }, "if visible, animate(slideUp, fadeOut) {\n    Card { Text(\"Appears with slideUp, exits with fadeOut\") }\n}\n\nif expanded, animate(scaleIn, scaleOut) {\n    Text(\"Scales in and out\")\n}");
  _e756.appendChild(_e757);
  _e755.appendChild(_e756);
  _e616.appendChild(_e755);
  const _e758 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e758);
  const _e759 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e759);
  const _e760 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e760);
  const _e761 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "List Stagger");
  _e616.appendChild(_e761);
  const _e762 = WF.h("p", { className: "wf-text" }, "Animate list items with staggered delays.");
  _e616.appendChild(_e762);
  const _e763 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e763);
  const _e764 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e765 = WF.h("div", { className: "wf-card__body" });
  const _e766 = WF.h("code", { className: "wf-code wf-code--block" }, "for item in items, animate(slideUp, fadeOut, stagger: \"50ms\") {\n    Card { Text(item.name) }\n}");
  _e765.appendChild(_e766);
  _e764.appendChild(_e765);
  _e616.appendChild(_e764);
  const _e767 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e767);
  const _e768 = WF.h("hr", { className: "wf-divider" });
  _e616.appendChild(_e768);
  const _e769 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e769);
  const _e770 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Transition Blocks");
  _e616.appendChild(_e770);
  const _e771 = WF.h("p", { className: "wf-text" }, "Smooth CSS transitions on property changes.");
  _e616.appendChild(_e771);
  const _e772 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e772);
  const _e773 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e774 = WF.h("div", { className: "wf-card__body" });
  const _e775 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Hover me\") {\n    transition {\n        background 200ms ease\n        transform 150ms spring\n    }\n}");
  _e774.appendChild(_e775);
  _e773.appendChild(_e774);
  _e616.appendChild(_e773);
  const _e776 = WF.h("div", { className: "wf-spacer" });
  _e616.appendChild(_e776);
...
function Page_I18n(params) {
  const _root = document.createDocumentFragment();
  const _e777 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e778 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e778);
  const _e779 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Internationalization (i18n)");
  _e777.appendChild(_e779);
  const _e780 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built-in multi-language support with reactive locale switching and automatic RTL.");
  _e777.appendChild(_e780);
  const _e781 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e781);
  const _e782 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Setup");
  _e777.appendChild(_e782);
  const _e783 = WF.h("p", { className: "wf-text" }, "Create a JSON file per locale in your translations directory.");
  _e777.appendChild(_e783);
  const _e784 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e784);
  const _e785 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e786 = WF.h("div", { className: "wf-card__body" });
  const _e787 = WF.h("code", { className: "wf-code wf-code--block" }, "// src/translations/en.json\n{\n    \"greeting\": \"Hello, {name}!\",\n    \"nav.home\": \"Home\",\n    \"nav.about\": \"About\"\n}\n\n// src/translations/ar.json\n{\n    \"greeting\": \"!أهلاً، {name}\",\n    \"nav.home\": \"الرئيسية\",\n    \"nav.about\": \"حول\"\n}");
  _e786.appendChild(_e787);
  _e785.appendChild(_e786);
  _e777.appendChild(_e785);
  const _e788 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e788);
  const _e789 = WF.h("p", { className: "wf-text wf-text--bold" }, "Add i18n config to webfluent.app.json:");
  _e777.appendChild(_e789);
  const _e790 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e791 = WF.h("div", { className: "wf-card__body" });
  const _e792 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"i18n\": {\n    \"defaultLocale\": \"en\",\n    \"locales\": [\"en\", \"ar\"],\n    \"dir\": \"src/translations\"\n  }\n}");
  _e791.appendChild(_e792);
  _e790.appendChild(_e791);
  _e777.appendChild(_e790);
  const _e793 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e793);
  const _e794 = WF.h("hr", { className: "wf-divider" });
  _e777.appendChild(_e794);
  const _e795 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e795);
  const _e796 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "The t() Function");
  _e777.appendChild(_e796);
  const _e797 = WF.h("p", { className: "wf-text" }, "Use t() to look up translated text. It is reactive — all t() calls update when the locale changes.");
  _e777.appendChild(_e797);
  const _e798 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e798);
  const _e799 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e800 = WF.h("div", { className: "wf-card__body" });
  const _e801 = WF.h("code", { className: "wf-code wf-code--block" }, "// Simple key lookup\nText(t(\"nav.home\"))\n\n// With interpolation\nText(t(\"greeting\", name: user.name))\n\n// In any component\nButton(t(\"actions.save\"), primary)\nHeading(t(\"page.title\"), h1)");
  _e800.appendChild(_e801);
  _e799.appendChild(_e800);
  _e777.appendChild(_e799);
  const _e802 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e802);
  const _e803 = WF.h("hr", { className: "wf-divider" });
  _e777.appendChild(_e803);
  const _e804 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e804);
  const _e805 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Locale Switching");
  _e777.appendChild(_e805);
  const _e806 = WF.h("p", { className: "wf-text" }, "Switch the locale at runtime with setLocale(). All translated text updates instantly.");
  _e777.appendChild(_e806);
  const _e807 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e807);
  const _e808 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e809 = WF.h("div", { className: "wf-card__body" });
  const _e810 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"English\") { setLocale(\"en\") }\nButton(\"العربية\") { setLocale(\"ar\") }\nButton(\"Espanol\") { setLocale(\"es\") }\n\n// Access current locale\nText(\"Current: {locale}\")\nText(\"Direction: {dir}\")");
  _e809.appendChild(_e810);
  _e808.appendChild(_e809);
  _e777.appendChild(_e808);
  const _e811 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e811);
  const _e812 = WF.h("hr", { className: "wf-divider" });
  _e777.appendChild(_e812);
  const _e813 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e813);
  const _e814 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "RTL Support");
  _e777.appendChild(_e814);
  const _e815 = WF.h("p", { className: "wf-text" }, "WebFluent automatically detects RTL locales and updates the document direction.");
  _e777.appendChild(_e815);
  const _e816 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e816);
  const _e817 = WF.h("table", { className: "wf-table" });
  const _e818 = WF.h("thead", {});
  const _e819 = WF.h("td", {}, "Locale");
  _e818.appendChild(_e819);
  const _e820 = WF.h("td", {}, "Direction");
  _e818.appendChild(_e820);
  _e817.appendChild(_e818);
  const _e821 = WF.h("tr", {});
  const _e822 = WF.h("td", {}, "ar (Arabic)");
  _e821.appendChild(_e822);
  const _e823 = WF.h("td", {}, "RTL");
  _e821.appendChild(_e823);
  _e817.appendChild(_e821);
  const _e824 = WF.h("tr", {});
  const _e825 = WF.h("td", {}, "he (Hebrew)");
  _e824.appendChild(_e825);
  const _e826 = WF.h("td", {}, "RTL");
  _e824.appendChild(_e826);
  _e817.appendChild(_e824);
  const _e827 = WF.h("tr", {});
  const _e828 = WF.h("td", {}, "fa (Farsi)");
  _e827.appendChild(_e828);
  const _e829 = WF.h("td", {}, "RTL");
  _e827.appendChild(_e829);
  _e817.appendChild(_e827);
  const _e830 = WF.h("tr", {});
  const _e831 = WF.h("td", {}, "ur (Urdu)");
  _e830.appendChild(_e831);
  const _e832 = WF.h("td", {}, "RTL");
  _e830.appendChild(_e832);
  _e817.appendChild(_e830);
  const _e833 = WF.h("tr", {});
  const _e834 = WF.h("td", {}, "All others");
  _e833.appendChild(_e834);
  const _e835 = WF.h("td", {}, "LTR");
  _e833.appendChild(_e835);
  _e817.appendChild(_e833);
  _e777.appendChild(_e817);
  const _e836 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e836);
  const _e837 = WF.h("p", { className: "wf-text wf-text--muted" }, "When setLocale(\"ar\") is called, the HTML element gets dir=\"rtl\" and lang=\"ar\" automatically.");
  _e777.appendChild(_e837);
  const _e838 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e838);
  const _e839 = WF.h("hr", { className: "wf-divider" });
  _e777.appendChild(_e839);
  const _e840 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e840);
  const _e841 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Fallback Behavior");
  _e777.appendChild(_e841);
  const _e842 = WF.h("p", { className: "wf-text" }, "If a key is missing in the current locale:");
  _e777.appendChild(_e842);
  const _e843 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e844 = WF.h("p", { className: "wf-text" }, "1. Falls back to the defaultLocale translation");
  _e843.appendChild(_e844);
  const _e845 = WF.h("p", { className: "wf-text" }, "2. If still missing, returns the key itself (e.g., \"nav.home\")");
  _e843.appendChild(_e845);
  _e777.appendChild(_e843);
  const _e846 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e846);
  const _e847 = WF.h("hr", { className: "wf-divider" });
  _e777.appendChild(_e847);
  const _e848 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e848);
  const _e849 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "SSG + i18n");
  _e777.appendChild(_e849);
  const _e850 = WF.h("p", { className: "wf-text wf-text--muted" }, "When both SSG and i18n are enabled, pages are pre-rendered with the default locale text. After JavaScript loads, locale switching works normally.");
  _e777.appendChild(_e850);
  const _e851 = WF.h("div", { className: "wf-spacer" });
  _e777.appendChild(_e851);
  _root.appendChild(_e777);
  return _root;
}
...
function Page_GettingStarted(params) {
  ...
  const _e854 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Getting Started");
  _e852.appendChild(_e854);
  const _e855 = WF.h("p", { className: "wf-text wf-text--muted" }, "Get up and running with WebFluent in under a minute.");
  _e852.appendChild(_e855);
  const _e856 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e856);
  const _e857 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Install");
  _e852.appendChild(_e857);
  const _e858 = WF.h("p", { className: "wf-text" }, "Build from source (requires Rust):");
  ...
  const _e862 = WF.h("code", { className: "wf-code wf-code--block" }, "git clone https://github.com/user/webfluent.git\ncd webfluent\ncargo build --release");
  _e861.appendChild(_e862);
  _e860.appendChild(_e861);
  _e852.appendChild(_e860);
  const _e863 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e863);
  const _e864 = WF.h("p", { className: "wf-text wf-text--muted" }, "The binary is at target/release/wf. Add it to your PATH.");
  _e852.appendChild(_e864);
  const _e865 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e865);
  const _e866 = WF.h("hr", { className: "wf-divider" });
  _e852.appendChild(_e866);
  const _e867 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e867);
  const _e868 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Create a Project");
  _e852.appendChild(_e868);
  const _e869 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e869);
  const _e870 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e871 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e872 = WF.h("div", { className: "wf-card__body" });
  const _e873 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "SPA");
  _e872.appendChild(_e873);
  const _e874 = WF.h("div", { className: "wf-spacer" });
  _e872.appendChild(_e874);
  const _e875 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Interactive App");
  _e872.appendChild(_e875);
  const _e876 = WF.h("p", { className: "wf-text wf-text--muted" }, "Dashboard with routing, stores, forms, modals, animations.");
  _e872.appendChild(_e876);
  const _e877 = WF.h("div", { className: "wf-spacer" });
  _e872.appendChild(_e877);
  const _e878 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-app -t spa");
  _e872.appendChild(_e878);
  _e871.appendChild(_e872);
  _e870.appendChild(_e871);
  const _e879 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e880 = WF.h("div", { className: "wf-card__body" });
  const _e881 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Static");
  _e880.appendChild(_e881);
  const _e882 = WF.h("div", { className: "wf-spacer" });
  _e880.appendChild(_e882);
  const _e883 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Static Site");
  _e880.appendChild(_e883);
  const _e884 = WF.h("p", { className: "wf-text wf-text--muted" }, "Marketing site with SSG, i18n, blog, contact form.");
  _e880.appendChild(_e884);
  const _e885 = WF.h("div", { className: "wf-spacer" });
  _e880.appendChild(_e885);
  const _e886 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-site -t static");
  _e880.appendChild(_e886);
  _e879.appendChild(_e880);
  _e870.appendChild(_e879);
  const _e887 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e888 = WF.h("div", { className: "wf-card__body" });
  const _e889 = WF.h("span", { className: "wf-badge wf-badge--info" }, "PDF");
  _e888.appendChild(_e889);
  const _e890 = WF.h("div", { className: "wf-spacer" });
  _e888.appendChild(_e890);
  const _e891 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "PDF Document");
  _e888.appendChild(_e891);
  const _e892 = WF.h("p", { className: "wf-text wf-text--muted" }, "Reports, invoices, docs. Tables, code blocks, auto page breaks.");
  _e888.appendChild(_e892);
  const _e893 = WF.h("div", { className: "wf-spacer" });
  _e888.appendChild(_e893);
  const _e894 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-report -t pdf");
  _e888.appendChild(_e894);
  _e887.appendChild(_e888);
  _e870.appendChild(_e887);
  _e852.appendChild(_e870);
  const _e895 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e895);
  const _e896 = WF.h("hr", { className: "wf-divider" });
  _e852.appendChild(_e896);
  const _e897 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e897);
  const _e898 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Build and Serve");
  _e852.appendChild(_e898);
  const _e899 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e900 = WF.h("div", { className: "wf-card__body" });
  const _e901 = WF.h("code", { className: "wf-code wf-code--block" }, "cd my-app\nwf build\nwf serve");
  _e900.appendChild(_e901);
  _e899.appendChild(_e900);
  _e852.appendChild(_e899);
  const _e902 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e902);
  const _e903 = WF.h("p", { className: "wf-text wf-text--muted" }, "Open http://localhost:3000 in your browser.");
  _e852.appendChild(_e903);
  const _e904 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e904);
  const _e905 = WF.h("hr", { className: "wf-divider" });
  _e852.appendChild(_e905);
  const _e906 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e906);
  const _e907 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Project Structure");
  _e852.appendChild(_e907);
  const _e908 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e909 = WF.h("div", { className: "wf-card__body" });
  const _e910 = WF.h("code", { className: "wf-code wf-code--block" }, "my-app/\n+-- webfluent.app.json       # Config\n+-- src/\n|   +-- App.wf               # Root (router, layout)\n|   +-- pages/\n|   +-- components/\n|   +-- stores/\n|   +-- translations/\n+-- public/\n+-- build/");
  ...
  const _e912 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e913 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { WF.navigate("/guide"); } }, "Read the Guide");
  _e912.appendChild(_e913);
  const _e914 = WF.h("button", { className: "wf-btn", "on:click": (e) => { WF.navigate("/components"); } }, "Browse Components");
  _e912.appendChild(_e914);
  _e852.appendChild(_e912);
  const _e915 = WF.h("div", { className: "wf-spacer" });
  _e852.appendChild(_e915);
...
function Page_Cli(params) {
  const _root = document.createDocumentFragment();
  const _e916 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e917 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e917);
  const _e918 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "CLI Reference");
  _e916.appendChild(_e918);
  const _e919 = WF.h("p", { className: "wf-text wf-text--muted" }, "The WebFluent command-line interface.");
  _e916.appendChild(_e919);
  const _e920 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e920);
  const _e921 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf init");
  _e916.appendChild(_e921);
  const _e922 = WF.h("p", { className: "wf-text" }, "Create a new WebFluent project.");
  _e916.appendChild(_e922);
  const _e923 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e923);
  const _e924 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e925 = WF.h("div", { className: "wf-card__body" });
  const _e926 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init <name> [--template spa|static|pdf]");
  _e925.appendChild(_e926);
  _e924.appendChild(_e925);
  _e916.appendChild(_e924);
  const _e927 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e927);
  const _e928 = WF.h("table", { className: "wf-table" });
  const _e929 = WF.h("thead", {});
  const _e930 = WF.h("td", {}, "Argument");
  _e929.appendChild(_e930);
  const _e931 = WF.h("td", {}, "Description");
  _e929.appendChild(_e931);
  _e928.appendChild(_e929);
  const _e932 = WF.h("tr", {});
  const _e933 = WF.h("td", {}, "name");
  _e932.appendChild(_e933);
  const _e934 = WF.h("td", {}, "Project name (creates a directory)");
  _e932.appendChild(_e934);
  _e928.appendChild(_e932);
  const _e935 = WF.h("tr", {});
  const _e936 = WF.h("td", {}, "--template, -t");
  _e935.appendChild(_e936);
  const _e937 = WF.h("td", {}, "Template: spa (default), static, or pdf");
  _e935.appendChild(_e937);
  _e928.appendChild(_e935);
  _e916.appendChild(_e928);
  const _e938 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e938);
  const _e939 = WF.h("p", { className: "wf-text wf-text--muted" }, "SPA: interactive app with routing and state. Static: SSG site with i18n. PDF: document generation with tables, headings, and auto page breaks.");
  _e916.appendChild(_e939);
  const _e940 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e940);
  const _e941 = WF.h("hr", { className: "wf-divider" });
  _e916.appendChild(_e941);
  const _e942 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e942);
  const _e943 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf build");
  _e916.appendChild(_e943);
  const _e944 = WF.h("p", { className: "wf-text" }, "Compile .wf files to HTML, CSS, and JavaScript.");
  _e916.appendChild(_e944);
  const _e945 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e945);
  const _e946 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e947 = WF.h("div", { className: "wf-card__body" });
  const _e948 = WF.h("code", { className: "wf-code wf-code--block" }, "wf build [--dir DIR]");
  _e947.appendChild(_e948);
  _e946.appendChild(_e947);
  _e916.appendChild(_e946);
  const _e949 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e949);
  const _e950 = WF.h("table", { className: "wf-table" });
  const _e951 = WF.h("thead", {});
  const _e952 = WF.h("td", {}, "Option");
  _e951.appendChild(_e952);
  const _e953 = WF.h("td", {}, "Description");
  _e951.appendChild(_e953);
  _e950.appendChild(_e951);
  const _e954 = WF.h("tr", {});
  const _e955 = WF.h("td", {}, "--dir, -d");
  _e954.appendChild(_e955);
  const _e956 = WF.h("td", {}, "Project directory (default: current directory)");
  _e954.appendChild(_e956);
  _e950.appendChild(_e954);
  _e916.appendChild(_e950);
  const _e957 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e957);
  const _e958 = WF.h("p", { className: "wf-text wf-text--muted" }, "The build pipeline: Lex all .wf files, parse to AST, run accessibility linter, generate HTML + CSS + JS, write to output directory.");
  _e916.appendChild(_e958);
  const _e959 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e959);
  const _e960 = WF.h("p", { className: "wf-text" }, "Output depends on config:");
  _e916.appendChild(_e960);
  const _e961 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e962 = WF.h("p", { className: "wf-text" }, "SPA mode (default): single index.html + app.js + styles.css");
  _e961.appendChild(_e962);
  const _e963 = WF.h("p", { className: "wf-text" }, "SSG mode (ssg: true): one HTML per page + app.js + styles.css");
  _e961.appendChild(_e963);
  const _e964 = WF.h("p", { className: "wf-text" }, "PDF mode (output_type: pdf): a single .pdf file");
  _e961.appendChild(_e964);
  _e916.appendChild(_e961);
  const _e965 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e965);
  const _e966 = WF.h("hr", { className: "wf-divider" });
  _e916.appendChild(_e966);
  const _e967 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e967);
  const _e968 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf serve");
  _e916.appendChild(_e968);
  const _e969 = WF.h("p", { className: "wf-text" }, "Start a development server that serves the built output.");
  _e916.appendChild(_e969);
  const _e970 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e970);
  const _e971 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e972 = WF.h("div", { className: "wf-card__body" });
  const _e973 = WF.h("code", { className: "wf-code wf-code--block" }, "wf serve [--dir DIR]");
  _e972.appendChild(_e973);
  _e971.appendChild(_e972);
  _e916.appendChild(_e971);
  const _e974 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e974);
  const _e975 = WF.h("p", { className: "wf-text wf-text--muted" }, "Serves files from the build directory. SPA fallback: all routes serve index.html so client-side routing works. Port is configured in webfluent.app.json (default: 3000).");
  _e916.appendChild(_e975);
  const _e976 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e976);
  const _e977 = WF.h("hr", { className: "wf-divider" });
  _e916.appendChild(_e977);
  const _e978 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e978);
  const _e979 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf generate");
  _e916.appendChild(_e979);
  const _e980 = WF.h("p", { className: "wf-text" }, "Scaffold a new page, component, or store.");
  _e916.appendChild(_e980);
  const _e981 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e981);
  const _e982 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e983 = WF.h("div", { className: "wf-card__body" });
  const _e984 = WF.h("code", { className: "wf-code wf-code--block" }, "wf generate <kind> <name> [--dir DIR]");
  _e983.appendChild(_e984);
  _e982.appendChild(_e983);
  _e916.appendChild(_e982);
  const _e985 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e985);
  const _e986 = WF.h("table", { className: "wf-table" });
  const _e987 = WF.h("thead", {});
  const _e988 = WF.h("td", {}, "Kind");
  _e987.appendChild(_e988);
  const _e989 = WF.h("td", {}, "Creates");
  _e987.appendChild(_e989);
  const _e990 = WF.h("td", {}, "Example");
  _e987.appendChild(_e990);
  _e986.appendChild(_e987);
  const _e991 = WF.h("tr", {});
  const _e992 = WF.h("td", {}, "page");
  _e991.appendChild(_e992);
  const _e993 = WF.h("td", {}, "src/pages/Name.wf");
  _e991.appendChild(_e993);
  const _e994 = WF.h("td", {}, "wf generate page About");
  _e991.appendChild(_e994);
  _e986.appendChild(_e991);
  const _e995 = WF.h("tr", {});
  const _e996 = WF.h("td", {}, "component");
  _e995.appendChild(_e996);
  const _e997 = WF.h("td", {}, "src/components/Name.wf");
  _e995.appendChild(_e997);
  const _e998 = WF.h("td", {}, "wf generate component Header");
  _e995.appendChild(_e998);
  _e986.appendChild(_e995);
  const _e999 = WF.h("tr", {});
  const _e1000 = WF.h("td", {}, "store");
  _e999.appendChild(_e1000);
  const _e1001 = WF.h("td", {}, "src/stores/name.wf");
  _e999.appendChild(_e1001);
  const _e1002 = WF.h("td", {}, "wf generate store CartStore");
  _e999.appendChild(_e1002);
  _e986.appendChild(_e999);
  _e916.appendChild(_e986);
  const _e1003 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e1003);
  const _e1004 = WF.h("hr", { className: "wf-divider" });
  _e916.appendChild(_e1004);
  const _e1005 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e1005);
  const _e1006 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Configuration");
  _e916.appendChild(_e1006);
  const _e1007 = WF.h("p", { className: "wf-text" }, "All config is in webfluent.app.json at the project root.");
  _e916.appendChild(_e1007);
  const _e1008 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e1008);
  const _e1009 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1010 = WF.h("div", { className: "wf-card__body" });
  const _e1011 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"name\": \"My App\",\n  \"version\": \"1.0.0\",\n  \"author\": \"Your Name\",\n  \"theme\": {\n    \"name\": \"default\",\n    \"mode\": \"light\",\n    \"tokens\": { \"color-primary\": \"#6366F1\" }\n  },\n  \"build\": {\n    \"output\": \"./build\",\n    \"minify\": true,\n    \"ssg\": false,\n    \"output_type\": \"spa\",\n    \"pdf\": {\n      \"page_size\": \"A4\",\n      \"default_font\": \"Helvetica\",\n      \"output_filename\": \"report.pdf\"\n    }\n  },\n  \"dev\": { \"port\": 3000 },\n  \"meta\": {\n    \"title\": \"My App\",\n    \"description\": \"Built with WebFluent\",\n    \"lang\": \"en\"\n  },\n  \"i18n\": {\n    \"defaultLocale\": \"en\",\n    \"locales\": [\"en\", \"ar\"],\n    \"dir\": \"src/translations\"\n  }\n}");
  _e1010.appendChild(_e1011);
  _e1009.appendChild(_e1010);
  _e916.appendChild(_e1009);
  const _e1012 = WF.h("div", { className: "wf-spacer" });
  _e916.appendChild(_e1012);
  _root.appendChild(_e916);
  return _root;
}
...
function Page_Home(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e1013 = WF.h("div", { className: "wf-container" });
  const _e1014 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1014);
  const _e1015 = WF.h("h2", { className: "wf-heading wf-heading--h1 wf-text--center wf-animate-slideUp" }, () => WF.i18n.t("hero.title"));
  _e1013.appendChild(_e1015);
  const _e1016 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1016);
  const _e1017 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center wf-animate-fadeIn" }, () => WF.i18n.t("hero.sub1"));
  _e1013.appendChild(_e1017);
  const _e1018 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center wf-animate-fadeIn" }, () => WF.i18n.t("hero.sub2"));
  _e1013.appendChild(_e1018);
  const _e1019 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1019);
  const _e1020 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1021 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { WF.navigate("/getting-started"); } }, () => WF.i18n.t("hero.cta"));
  _e1020.appendChild(_e1021);
  const _e1022 = WF.h("button", { className: "wf-btn wf-btn--large", "on:click": (e) => { WF.navigate("/guide"); } }, () => WF.i18n.t("hero.guide"));
  _e1020.appendChild(_e1022);
  _e1013.appendChild(_e1020);
  const _e1023 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1023);
  const _e1024 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1025 = WF.h("div", { className: "wf-card__body" });
  const _e1026 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Home (path: \"/\") {\n    Container {\n        Heading(\"Hello, WebFluent!\", h1)\n        Text(\"Build for the web. Nothing else.\")\n\n        Button(\"Get Started\", primary, large) {\n            navigate(\"/docs\")\n        }\n    }\n}");
  _e1025.appendChild(_e1026);
  _e1024.appendChild(_e1025);
  _e1013.appendChild(_e1024);
  const _e1027 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1027);
  const _e1028 = WF.h("hr", { className: "wf-divider" });
  _e1013.appendChild(_e1028);
  const _e1029 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1029);
  const _e1030 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-text--center" }, () => WF.i18n.t("demo.title"));
  _e1013.appendChild(_e1030);
  const _e1031 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("demo.subtitle"));
  _e1013.appendChild(_e1031);
  const _e1032 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1032);
  const _e1033 = WF.h("div", { className: "wf-grid wf-grid--gap-lg", style: { gridTemplateColumns: 'repeat(2, 1fr)' } });
  const _e1034 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1035 = WF.h("div", { className: "wf-card__header" });
  const _e1036 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.counter"));
  _e1035.appendChild(_e1036);
  _e1034.appendChild(_e1035);
  const _e1037 = WF.h("div", { className: "wf-card__body" });
  const _e1038 = WF.h("div", { className: "wf-row wf-row--center wf-row--gap-md" });
  const _e1039 = WF.h("button", { className: "wf-btn wf-btn--large", "on:click": (e) => { _counter.set((_counter() - 1)); } }, "-");
  _e1038.appendChild(_e1039);
  const _e1040 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-heading--primary" }, () => `${_counter()}`);
  _e1038.appendChild(_e1040);
  const _e1041 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { _counter.set((_counter() + 1)); } }, "+");
  _e1038.appendChild(_e1041);
  _e1037.appendChild(_e1038);
  const _e1042 = WF.h("div", { className: "wf-spacer" });
  _e1037.appendChild(_e1042);
  const _e1043 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.counter.hint"));
  _e1037.appendChild(_e1043);
  _e1034.appendChild(_e1037);
  _e1033.appendChild(_e1034);
  const _e1044 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1045 = WF.h("div", { className: "wf-card__header" });
  const _e1046 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.binding"));
  _e1045.appendChild(_e1046);
  _e1044.appendChild(_e1045);
  const _e1047 = WF.h("div", { className: "wf-card__body" });
  const _e1048 = WF.h("input", { className: "wf-input", value: () => _taskInput(), "on:input": (e) => _taskInput.set(e.target.value), placeholder: WF.i18n.t("demo.binding.placeholder"), label: "Input", type: "text" });
  _e1047.appendChild(_e1048);
  const _e1049 = WF.h("div", { className: "wf-spacer" });
  _e1047.appendChild(_e1049);
  WF.condRender(_e1047,
    () => (_taskInput() !== ""),
    () => {
      const _e1050 = document.createDocumentFragment();
      const _e1051 = WF.h("div", { className: "wf-alert wf-alert--info" }, () => `You typed: ${_taskInput()}`);
  ...
  const _e1052 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.binding.hint"));
  _e1047.appendChild(_e1052);
  _e1044.appendChild(_e1047);
  _e1033.appendChild(_e1044);
  const _e1053 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1054 = WF.h("div", { className: "wf-card__header" });
  const _e1055 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.conditional"));
  _e1054.appendChild(_e1055);
  _e1053.appendChild(_e1054);
  const _e1056 = WF.h("div", { className: "wf-card__body" });
  const _e1057 = WF.h("label", { className: "wf-switch" });
  const _e1058 = WF.h("input", { type: "checkbox", checked: () => _showDemo(), "on:change": () => _showDemo.set(!_showDemo()) });
  _e1057.appendChild(_e1058);
  const _e1059 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1057.appendChild(_e1059);
  _e1057.appendChild(WF.text(WF.i18n.t("demo.conditional.toggle")));
  _e1056.appendChild(_e1057);
  const _e1060 = WF.h("div", { className: "wf-spacer" });
  _e1056.appendChild(_e1060);
  WF.condRender(_e1056,
    () => _showDemo(),
    () => {
      const _e1061 = document.createDocumentFragment();
      const _e1062 = WF.h("div", { className: "wf-card wf-card--outlined" });
      const _e1063 = WF.h("div", { className: "wf-card__body" });
      const _e1064 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Visible!");
      _e1063.appendChild(_e1064);
      const _e1065 = WF.h("div", { className: "wf-spacer" });
      _e1063.appendChild(_e1065);
      const _e1066 = WF.h("p", { className: "wf-text" }, () => WF.i18n.t("demo.conditional.text"));
      _e1063.appendChild(_e1066);
  ...
  _e1053.appendChild(_e1056);
  _e1033.appendChild(_e1053);
  const _e1067 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1068 = WF.h("div", { className: "wf-card__header" });
  const _e1069 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.components"));
  _e1068.appendChild(_e1069);
  _e1067.appendChild(_e1068);
  const _e1070 = WF.h("div", { className: "wf-card__body" });
  const _e1071 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1072 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1073 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Primary");
  _e1072.appendChild(_e1073);
  const _e1074 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e1072.appendChild(_e1074);
  const _e1075 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e1072.appendChild(_e1075);
  _e1071.appendChild(_e1072);
  const _e1076 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1077 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "New");
  _e1076.appendChild(_e1077);
  const _e1078 = WF.h("span", { className: "wf-badge wf-badge--danger" }, "Sale");
  _e1076.appendChild(_e1078);
  const _e1079 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Active");
  _e1076.appendChild(_e1079);
  const _e1080 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e1076.appendChild(_e1080);
  _e1071.appendChild(_e1076);
  const _e1081 = WF.h("progress", { className: "wf-progress", value: 72, max: 100 });
  _e1071.appendChild(_e1081);
  const _e1082 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.components.hint"));
  _e1071.appendChild(_e1082);
  _e1070.appendChild(_e1071);
  _e1067.appendChild(_e1070);
  _e1033.appendChild(_e1067);
  _e1013.appendChild(_e1033);
  const _e1083 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1083);
  const _e1084 = WF.h("hr", { className: "wf-divider" });
  _e1013.appendChild(_e1084);
  const _e1085 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1085);
  const _e1086 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-text--center" }, () => WF.i18n.t("why.title"));
  _e1013.appendChild(_e1086);
  const _e1087 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("why.subtitle"));
  _e1013.appendChild(_e1087);
  const _e1088 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1088);
  const _e1089 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e1090 = Component_FeatureCard({ title: WF.i18n.t("why.syntax"), description: WF.i18n.t("why.syntax.desc") });
  _e1089.appendChild(_e1090);
  const _e1091 = Component_FeatureCard({ title: WF.i18n.t("why.components"), description: WF.i18n.t("why.components.desc") });
  _e1089.appendChild(_e1091);
  const _e1092 = Component_FeatureCard({ title: WF.i18n.t("why.reactivity"), description: WF.i18n.t("why.reactivity.desc") });
  _e1089.appendChild(_e1092);
  const _e1093 = Component_FeatureCard({ title: WF.i18n.t("why.design"), description: WF.i18n.t("why.design.desc") });
  _e1089.appendChild(_e1093);
  const _e1094 = Component_FeatureCard({ title: WF.i18n.t("why.animation"), description: WF.i18n.t("why.animation.desc") });
  _e1089.appendChild(_e1094);
  const _e1095 = Component_FeatureCard({ title: WF.i18n.t("why.i18n"), description: WF.i18n.t("why.i18n.desc") });
  _e1089.appendChild(_e1095);
  const _e1096 = Component_FeatureCard({ title: WF.i18n.t("why.ssg"), description: WF.i18n.t("why.ssg.desc") });
  _e1089.appendChild(_e1096);
  const _e1097 = Component_FeatureCard({ title: WF.i18n.t("why.a11y"), description: WF.i18n.t("why.a11y.desc") });
  _e1089.appendChild(_e1097);
  const _e1098 = Component_FeatureCard({ title: WF.i18n.t("why.zero"), description: WF.i18n.t("why.zero.desc") });
  _e1089.appendChild(_e1098);
  _e1013.appendChild(_e1089);
  const _e1099 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1099);
  const _e1100 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1101 = WF.h("div", { className: "wf-card__body" });
  const _e1102 = WF.h("div", { className: "wf-row wf-row--center wf-row--between" });
  const _e1103 = WF.h("div", { className: "wf-stack" });
  const _e1104 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("cta.title"));
  _e1103.appendChild(_e1104);
  const _e1105 = WF.h("p", { className: "wf-text wf-text--muted" }, () => WF.i18n.t("cta.subtitle"));
  _e1103.appendChild(_e1105);
  _e1102.appendChild(_e1103);
  const _e1106 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { WF.navigate("/getting-started"); } }, () => WF.i18n.t("hero.cta"));
  _e1102.appendChild(_e1106);
  _e1101.appendChild(_e1102);
  _e1100.appendChild(_e1101);
  _e1013.appendChild(_e1100);
  const _e1107 = WF.h("div", { className: "wf-spacer" });
  _e1013.appendChild(_e1107);
  _root.appendChild(_e1013);
  return _root;
}
...
function Page_Components(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e1108 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1109 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1109);
  const _e1110 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Components Reference");
  _e1108.appendChild(_e1110);
  const _e1111 = WF.h("p", { className: "wf-text wf-text--muted" }, "50+ built-in components. Below are live interactive examples you can play with.");
  _e1108.appendChild(_e1111);
  const _e1112 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1112);
  const _e1113 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Buttons");
  _e1108.appendChild(_e1113);
  const _e1114 = WF.h("p", { className: "wf-text" }, "Buttons support size, color, and shape modifiers.");
  _e1108.appendChild(_e1114);
  const _e1115 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1115);
  const _e1116 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1117 = WF.h("div", { className: "wf-card__body" });
  const _e1118 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1119 = WF.h("button", { className: "wf-btn" }, "Default");
  _e1118.appendChild(_e1119);
  const _e1120 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Primary");
  _e1118.appendChild(_e1120);
  const _e1121 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e1118.appendChild(_e1121);
  const _e1122 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e1118.appendChild(_e1122);
  const _e1123 = WF.h("button", { className: "wf-btn wf-btn--warning" }, "Warning");
  _e1118.appendChild(_e1123);
  const _e1124 = WF.h("button", { className: "wf-btn wf-btn--info" }, "Info");
  _e1118.appendChild(_e1124);
  _e1117.appendChild(_e1118);
  const _e1125 = WF.h("div", { className: "wf-spacer" });
  _e1117.appendChild(_e1125);
  const _e1126 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1127 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--small" }, "Small");
  _e1126.appendChild(_e1127);
  const _e1128 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Medium");
  _e1126.appendChild(_e1128);
  const _e1129 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large" }, "Large");
  _e1126.appendChild(_e1129);
  const _e1130 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--rounded" }, "Rounded");
  _e1126.appendChild(_e1130);
  const _e1131 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--full" }, "Full Width");
  _e1126.appendChild(_e1131);
  _e1117.appendChild(_e1126);
  _e1116.appendChild(_e1117);
  _e1108.appendChild(_e1116);
  const _e1132 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1132);
  const _e1133 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1134 = WF.h("div", { className: "wf-card__body" });
  const _e1135 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Primary\", primary)\nButton(\"Large\", primary, large)\nButton(\"Rounded\", success, rounded)\nButton(\"Full Width\", danger, full)");
  _e1134.appendChild(_e1135);
  _e1133.appendChild(_e1134);
  _e1108.appendChild(_e1133);
  const _e1136 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1136);
  const _e1137 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1137);
  const _e1138 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1138);
  const _e1139 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Cards");
  _e1108.appendChild(_e1139);
  const _e1140 = WF.h("p", { className: "wf-text" }, "Cards are surfaces for grouping content. They support Header, Body, and Footer sub-components.");
  _e1108.appendChild(_e1140);
  const _e1141 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1141);
  const _e1142 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1143 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1144 = WF.h("div", { className: "wf-card" });
  const _e1145 = WF.h("div", { className: "wf-card__header" });
  const _e1146 = WF.h("p", { className: "wf-text wf-text--bold" }, "Default Card");
  _e1145.appendChild(_e1146);
  _e1144.appendChild(_e1145);
  const _e1147 = WF.h("div", { className: "wf-card__body" });
  const _e1148 = WF.h("p", { className: "wf-text wf-text--muted" }, "Basic card with header and body.");
  _e1147.appendChild(_e1148);
  _e1144.appendChild(_e1147);
  const _e1149 = WF.h("div", { className: "wf-card__footer" });
  const _e1150 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--small" }, "Action");
  console.log("clicked");
  _e1149.appendChild(_e1150);
  _e1144.appendChild(_e1149);
  _e1143.appendChild(_e1144);
  _e1142.appendChild(_e1143);
  const _e1151 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1152 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1153 = WF.h("div", { className: "wf-card__header" });
  const _e1154 = WF.h("p", { className: "wf-text wf-text--bold" }, "Elevated");
  _e1153.appendChild(_e1154);
  _e1152.appendChild(_e1153);
  const _e1155 = WF.h("div", { className: "wf-card__body" });
  const _e1156 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with shadow elevation.");
  _e1155.appendChild(_e1156);
  _e1152.appendChild(_e1155);
  _e1151.appendChild(_e1152);
  _e1142.appendChild(_e1151);
  const _e1157 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1158 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1159 = WF.h("div", { className: "wf-card__header" });
  const _e1160 = WF.h("p", { className: "wf-text wf-text--bold" }, "Outlined");
  _e1159.appendChild(_e1160);
  _e1158.appendChild(_e1159);
  const _e1161 = WF.h("div", { className: "wf-card__body" });
  const _e1162 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with border only.");
  _e1161.appendChild(_e1162);
  _e1158.appendChild(_e1161);
  _e1157.appendChild(_e1158);
  _e1142.appendChild(_e1157);
  _e1108.appendChild(_e1142);
  const _e1163 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1163);
  const _e1164 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1164);
  const _e1165 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1165);
  const _e1166 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Form Controls");
  _e1108.appendChild(_e1166);
  const _e1167 = WF.h("p", { className: "wf-text" }, "All form inputs support two-way binding with the bind: attribute.");
  _e1108.appendChild(_e1167);
  const _e1168 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1168);
  const _e1169 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1170 = WF.h("div", { className: "wf-card__body" });
  const _e1171 = WF.h("div", { className: "wf-stack wf-stack--gap-md" });
  const _e1172 = WF.h("input", { className: "wf-input", value: () => _inputVal(), "on:input": (e) => _inputVal.set(e.target.value), label: "Text Input", placeholder: "Type here...", type: "text" });
  _e1171.appendChild(_e1172);
  WF.condRender(_e1171,
    () => (_inputVal() !== ""),
    () => {
      const _e1173 = document.createDocumentFragment();
      const _e1174 = WF.h("p", { className: "wf-text wf-text--primary wf-text--bold" }, () => `You typed: ${_inputVal()}`);
  ...
  _e1171.appendChild(_e1175);
  const _e1176 = WF.h("select", { className: "wf-select", value: () => _selectVal(), "on:input": (e) => _selectVal.set(e.target.value), label: "Select" });
  const _e1177 = WF.h("option", {}, "opt1");
  _e1176.appendChild(_e1177);
  const _e1178 = WF.h("option", {}, "opt2");
  _e1176.appendChild(_e1178);
  const _e1179 = WF.h("option", {}, "opt3");
  _e1176.appendChild(_e1179);
  _e1171.appendChild(_e1176);
  const _e1180 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_selectVal()}`);
  _e1171.appendChild(_e1180);
  const _e1181 = WF.h("hr", { className: "wf-divider" });
  _e1171.appendChild(_e1181);
  const _e1182 = WF.h("label", { className: "wf-checkbox" });
  const _e1183 = WF.h("input", { type: "checkbox", checked: () => _checkVal(), "on:change": () => _checkVal.set(!_checkVal()) });
  _e1182.appendChild(_e1183);
  _e1182.appendChild(WF.text("I agree to the terms"));
  _e1171.appendChild(_e1182);
  const _e1184 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Checked: ${_checkVal()}`);
  _e1171.appendChild(_e1184);
  const _e1185 = WF.h("hr", { className: "wf-divider" });
  _e1171.appendChild(_e1185);
  const _e1186 = WF.h("div", { className: "wf-row wf-row--gap-lg" });
  const _e1187 = WF.h("label", { className: "wf-radio" });
  const _e1188 = WF.h("input", { type: "radio", checked: () => _radioVal() === "a", "on:change": () => _radioVal.set("a") });
  _e1187.appendChild(_e1188);
  _e1187.appendChild(WF.text("Option A"));
  _e1186.appendChild(_e1187);
  const _e1189 = WF.h("label", { className: "wf-radio" });
  const _e1190 = WF.h("input", { type: "radio", checked: () => _radioVal() === "b", "on:change": () => _radioVal.set("b") });
  _e1189.appendChild(_e1190);
  _e1189.appendChild(WF.text("Option B"));
  _e1186.appendChild(_e1189);
  const _e1191 = WF.h("label", { className: "wf-radio" });
  const _e1192 = WF.h("input", { type: "radio", checked: () => _radioVal() === "c", "on:change": () => _radioVal.set("c") });
  _e1191.appendChild(_e1192);
  _e1191.appendChild(WF.text("Option C"));
  _e1186.appendChild(_e1191);
  _e1171.appendChild(_e1186);
  const _e1193 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_radioVal()}`);
  _e1171.appendChild(_e1193);
  const _e1194 = WF.h("hr", { className: "wf-divider" });
  _e1171.appendChild(_e1194);
  const _e1195 = WF.h("label", { className: "wf-switch" });
  const _e1196 = WF.h("input", { type: "checkbox", checked: () => _switchVal(), "on:change": () => _switchVal.set(!_switchVal()) });
  _e1195.appendChild(_e1196);
  const _e1197 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1195.appendChild(_e1197);
  _e1195.appendChild(WF.text("Dark Mode"));
  _e1171.appendChild(_e1195);
  const _e1198 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Enabled: ${_switchVal()}`);
  _e1171.appendChild(_e1198);
  const _e1199 = WF.h("hr", { className: "wf-divider" });
  _e1171.appendChild(_e1199);
  const _e1200 = WF.h("input", { className: "wf-slider", value: () => _sliderVal(), "on:input": (e) => _sliderVal.set(e.target.value), min: 0, max: 100, step: 1, label: "Volume" });
  _e1171.appendChild(_e1200);
  const _e1201 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Value: ${_sliderVal()}`);
  _e1171.appendChild(_e1201);
  _e1170.appendChild(_e1171);
  _e1169.appendChild(_e1170);
  _e1108.appendChild(_e1169);
  const _e1202 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1202);
  const _e1203 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1203);
  const _e1204 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1204);
  const _e1205 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Feedback");
  _e1108.appendChild(_e1205);
  const _e1206 = WF.h("p", { className: "wf-text" }, "Alerts, modals, progress bars, and loading indicators.");
  _e1108.appendChild(_e1206);
  const _e1207 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1207);
  ...
  const _e1211 = WF.h("div", { className: "wf-alert wf-alert--success" }, "This is a success alert.");
  _e1210.appendChild(_e1211);
  const _e1212 = WF.h("div", { className: "wf-alert wf-alert--warning" }, "This is a warning alert.");
  _e1210.appendChild(_e1212);
  const _e1213 = WF.h("div", { className: "wf-alert wf-alert--danger" }, "This is a danger alert.");
  _e1210.appendChild(_e1213);
  const _e1214 = WF.h("div", { className: "wf-alert wf-alert--info" }, "This is an info alert.");
  _e1210.appendChild(_e1214);
  _e1209.appendChild(_e1210);
  const _e1215 = WF.h("div", { className: "wf-spacer" });
  _e1209.appendChild(_e1215);
  const _e1216 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1217 = WF.h("div", { className: "wf-spinner" });
  _e1216.appendChild(_e1217);
  const _e1218 = WF.h("div", { className: "wf-spinner wf-spinner--large wf-spinner--primary" });
  _e1216.appendChild(_e1218);
  const _e1219 = WF.h("progress", { className: "wf-progress", value: _sliderVal(), max: 100 });
  _e1216.appendChild(_e1219);
  _e1209.appendChild(_e1216);
  const _e1220 = WF.h("div", { className: "wf-spacer" });
  _e1209.appendChild(_e1220);
  const _e1221 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(true); } }, "Open Modal");
  _e1209.appendChild(_e1221);
  _e1208.appendChild(_e1209);
  _e1108.appendChild(_e1208);
  const _e1222 = WF.h("div", { className: "wf-modal" });
  const _e1223 = WF.h("div", { className: "wf-modal__content" });
  const _e1224 = WF.h("div", { className: "wf-modal__header" }, WF.h("h3", {}, "Example Modal"));
  _e1223.appendChild(_e1224);
  const _e1225 = WF.h("div", { className: "wf-modal__body" });
  const _e1226 = WF.h("p", { className: "wf-text" }, "This is a real modal dialog. It was triggered by clicking the button.");
  _e1225.appendChild(_e1226);
  const _e1227 = WF.h("div", { className: "wf-spacer" });
  _e1225.appendChild(_e1227);
  const _e1228 = WF.h("p", { className: "wf-text wf-text--muted" }, "The modal is controlled by a state variable.");
  _e1225.appendChild(_e1228);
  _e1223.appendChild(_e1225);
  const _e1229 = WF.h("div", { className: "wf-modal__footer" });
  const _e1230 = WF.h("button", { className: "wf-btn", "on:click": (e) => { _activeModal.set(false); } }, "Close");
  _e1229.appendChild(_e1230);
  const _e1231 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(false); } }, "Confirm");
  _e1229.appendChild(_e1231);
  _e1223.appendChild(_e1229);
  _e1222.appendChild(_e1223);
  WF.effect(() => { _e1222.className = _activeModal() ? 'wf-modal open' : 'wf-modal'; });
  _e1108.appendChild(_e1222);
  const _e1232 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1232);
  const _e1233 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1233);
  const _e1234 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1234);
  const _e1235 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Data Display");
  _e1108.appendChild(_e1235);
  const _e1236 = WF.h("p", { className: "wf-text" }, "Tables, badges, avatars, tags, and tooltips.");
  _e1108.appendChild(_e1236);
  const _e1237 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1237);
  const _e1238 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1239 = WF.h("div", { className: "wf-card__body" });
  const _e1240 = WF.h("table", { className: "wf-table" });
  const _e1241 = WF.h("thead", {});
  const _e1242 = WF.h("td", {}, "Name");
  _e1241.appendChild(_e1242);
  const _e1243 = WF.h("td", {}, "Role");
  _e1241.appendChild(_e1243);
  const _e1244 = WF.h("td", {}, "Status");
  _e1241.appendChild(_e1244);
  _e1240.appendChild(_e1241);
  const _e1245 = WF.h("tr", {});
  const _e1246 = WF.h("td", {}, "Monzer Omer");
  _e1245.appendChild(_e1246);
  const _e1247 = WF.h("td", {}, "Creator");
  _e1245.appendChild(_e1247);
  const _e1248 = WF.h("td", {}, "Active");
  _e1245.appendChild(_e1248);
  _e1240.appendChild(_e1245);
  const _e1249 = WF.h("tr", {});
  const _e1250 = WF.h("td", {}, "Sara Ali");
  _e1249.appendChild(_e1250);
  const _e1251 = WF.h("td", {}, "Designer");
  _e1249.appendChild(_e1251);
  const _e1252 = WF.h("td", {}, "Active");
  _e1249.appendChild(_e1252);
  _e1240.appendChild(_e1249);
  const _e1253 = WF.h("tr", {});
  const _e1254 = WF.h("td", {}, "Omar Hassan");
  _e1253.appendChild(_e1254);
  const _e1255 = WF.h("td", {}, "Developer");
  _e1253.appendChild(_e1255);
  const _e1256 = WF.h("td", {}, "Away");
  _e1253.appendChild(_e1256);
  _e1240.appendChild(_e1253);
  _e1239.appendChild(_e1240);
  const _e1257 = WF.h("div", { className: "wf-spacer" });
  _e1239.appendChild(_e1257);
  const _e1258 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1259 = WF.h("div", { className: "wf-avatar wf-avatar--primary", initials: "MO" });
  _e1258.appendChild(_e1259);
  const _e1260 = WF.h("div", { className: "wf-avatar wf-avatar--success", initials: "SA" });
  _e1258.appendChild(_e1260);
  const _e1261 = WF.h("div", { className: "wf-avatar wf-avatar--info", initials: "OH" });
  _e1258.appendChild(_e1261);
  const _e1262 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "Admin");
  _e1258.appendChild(_e1262);
  const _e1263 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Online");
  _e1258.appendChild(_e1263);
  const _e1264 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e1258.appendChild(_e1264);
  const _e1265 = WF.h("span", { className: "wf-tag" }, "Rust");
  _e1258.appendChild(_e1265);
  const _e1266 = WF.h("span", { className: "wf-tag" }, "Open Source");
  _e1258.appendChild(_e1266);
  _e1239.appendChild(_e1258);
  _e1238.appendChild(_e1239);
  _e1108.appendChild(_e1238);
  const _e1267 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1267);
  const _e1268 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1268);
  const _e1269 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1269);
  const _e1270 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Layout");
  _e1108.appendChild(_e1270);
  const _e1271 = WF.h("p", { className: "wf-text" }, "Container, Row, Column, Grid, Stack, Spacer, Divider.");
  _e1108.appendChild(_e1271);
  const _e1272 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1272);
  const _e1273 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1274 = WF.h("div", { className: "wf-card__body" });
  const _e1275 = WF.h("p", { className: "wf-text wf-text--bold" }, "Grid with 3 columns:");
  _e1274.appendChild(_e1275);
  const _e1276 = WF.h("div", { className: "wf-spacer" });
  _e1274.appendChild(_e1276);
  const _e1277 = WF.h("div", { className: "wf-grid wf-grid--gap-sm", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e1278 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1279 = WF.h("div", { className: "wf-card__body" });
  const _e1280 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 1");
  _e1279.appendChild(_e1280);
  _e1278.appendChild(_e1279);
  _e1277.appendChild(_e1278);
  const _e1281 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1282 = WF.h("div", { className: "wf-card__body" });
  const _e1283 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 2");
  _e1282.appendChild(_e1283);
  _e1281.appendChild(_e1282);
  _e1277.appendChild(_e1281);
  const _e1284 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1285 = WF.h("div", { className: "wf-card__body" });
  const _e1286 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 3");
  _e1285.appendChild(_e1286);
  _e1284.appendChild(_e1285);
  _e1277.appendChild(_e1284);
  _e1274.appendChild(_e1277);
  const _e1287 = WF.h("div", { className: "wf-spacer" });
  _e1274.appendChild(_e1287);
  const _e1288 = WF.h("p", { className: "wf-text wf-text--bold" }, "Row with Columns (6/6 split):");
  _e1274.appendChild(_e1288);
  const _e1289 = WF.h("div", { className: "wf-spacer" });
  _e1274.appendChild(_e1289);
  const _e1290 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1291 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1292 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1293 = WF.h("div", { className: "wf-card__body" });
  const _e1294 = WF.h("p", { className: "wf-text wf-text--center" }, "Left Half");
  _e1293.appendChild(_e1294);
  _e1292.appendChild(_e1293);
  _e1291.appendChild(_e1292);
  _e1290.appendChild(_e1291);
  const _e1295 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1296 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1297 = WF.h("div", { className: "wf-card__body" });
  const _e1298 = WF.h("p", { className: "wf-text wf-text--center" }, "Right Half");
  _e1297.appendChild(_e1298);
  _e1296.appendChild(_e1297);
  _e1295.appendChild(_e1296);
  _e1290.appendChild(_e1295);
  _e1274.appendChild(_e1290);
  const _e1299 = WF.h("div", { className: "wf-spacer" });
  _e1274.appendChild(_e1299);
  const _e1300 = WF.h("p", { className: "wf-text wf-text--bold" }, "Stack (vertical):");
  _e1274.appendChild(_e1300);
  const _e1301 = WF.h("div", { className: "wf-spacer" });
  _e1274.appendChild(_e1301);
  const _e1302 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1303 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1304 = WF.h("div", { className: "wf-card__body" });
  const _e1305 = WF.h("p", { className: "wf-text" }, "Item 1");
  _e1304.appendChild(_e1305);
  _e1303.appendChild(_e1304);
  _e1302.appendChild(_e1303);
  const _e1306 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1307 = WF.h("div", { className: "wf-card__body" });
  const _e1308 = WF.h("p", { className: "wf-text" }, "Item 2");
  _e1307.appendChild(_e1308);
  _e1306.appendChild(_e1307);
  _e1302.appendChild(_e1306);
  const _e1309 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1310 = WF.h("div", { className: "wf-card__body" });
  const _e1311 = WF.h("p", { className: "wf-text" }, "Item 3");
  _e1310.appendChild(_e1311);
  _e1309.appendChild(_e1310);
  _e1302.appendChild(_e1309);
  _e1274.appendChild(_e1302);
  _e1273.appendChild(_e1274);
  _e1108.appendChild(_e1273);
  const _e1312 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1312);
  const _e1313 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1313);
  const _e1314 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1314);
  const _e1315 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Navigation");
  _e1108.appendChild(_e1315);
  const _e1316 = WF.h("p", { className: "wf-text" }, "Tabs let you switch between content panels.");
  _e1108.appendChild(_e1316);
  const _e1317 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1317);
  const _e1318 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1319 = WF.h("div", { className: "wf-card__body" });
  const _e1320 = WF.h("div", { className: "wf-tabs" });
  const _e1321 = WF.h("div", { className: "wf-tabs__nav" });
  const _e1322 = WF.signal(0);
  const _e1323 = WF.h("button", { className: () => _e1322() === 0 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1322.set(0) }, "Profile");
  _e1321.appendChild(_e1323);
  const _e1324 = WF.h("button", { className: () => _e1322() === 1 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1322.set(1) }, "Settings");
  _e1321.appendChild(_e1324);
  const _e1325 = WF.h("button", { className: () => _e1322() === 2 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1322.set(2) }, "About");
  _e1321.appendChild(_e1325);
  _e1320.appendChild(_e1321);
  const _e1326 = WF.h("div", { className: "wf-tab-page" });
  const _e1327 = WF.h("div", { className: "wf-spacer" });
  _e1326.appendChild(_e1327);
  const _e1328 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1329 = WF.h("div", { className: "wf-avatar wf-avatar--primary wf-avatar--large", initials: "MO" });
  _e1328.appendChild(_e1329);
  const _e1330 = WF.h("div", { className: "wf-stack" });
  const _e1331 = WF.h("p", { className: "wf-text wf-text--bold" }, "Monzer Omer");
  _e1330.appendChild(_e1331);
  const _e1332 = WF.h("p", { className: "wf-text wf-text--muted" }, "Creator of WebFluent");
  _e1330.appendChild(_e1332);
  _e1328.appendChild(_e1330);
  _e1326.appendChild(_e1328);
  WF.effect(() => { _e1326.style.display = _e1322() === 0 ? 'block' : 'none'; });
  _e1320.appendChild(_e1326);
  const _e1333 = WF.h("div", { className: "wf-tab-page" });
  const _e1334 = WF.h("div", { className: "wf-spacer" });
  _e1333.appendChild(_e1334);
  const _e1335 = WF.h("label", { className: "wf-switch" });
  const _e1336 = WF.h("input", { type: "checkbox", checked: () => _switchVal(), "on:change": () => _switchVal.set(!_switchVal()) });
  _e1335.appendChild(_e1336);
  const _e1337 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1335.appendChild(_e1337);
  _e1335.appendChild(WF.text("Enable notifications"));
  _e1333.appendChild(_e1335);
  const _e1338 = WF.h("div", { className: "wf-spacer" });
  _e1333.appendChild(_e1338);
  const _e1339 = WF.h("input", { className: "wf-slider", value: () => _sliderVal(), "on:input": (e) => _sliderVal.set(e.target.value), min: 0, max: 100, label: "Volume" });
  _e1333.appendChild(_e1339);
  WF.effect(() => { _e1333.style.display = _e1322() === 1 ? 'block' : 'none'; });
  _e1320.appendChild(_e1333);
  const _e1340 = WF.h("div", { className: "wf-tab-page" });
  const _e1341 = WF.h("div", { className: "wf-spacer" });
  _e1340.appendChild(_e1341);
  const _e1342 = WF.h("p", { className: "wf-text" }, "WebFluent is a web-first programming language.");
  _e1340.appendChild(_e1342);
  const _e1343 = WF.h("p", { className: "wf-text wf-text--muted" }, "It compiles to HTML, CSS, and JavaScript.");
  _e1340.appendChild(_e1343);
  WF.effect(() => { _e1340.style.display = _e1322() === 2 ? 'block' : 'none'; });
  _e1320.appendChild(_e1340);
  _e1319.appendChild(_e1320);
  _e1318.appendChild(_e1319);
  _e1108.appendChild(_e1318);
  const _e1344 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1344);
  const _e1345 = WF.h("hr", { className: "wf-divider" });
  _e1108.appendChild(_e1345);
  const _e1346 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1346);
  const _e1347 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Typography");
  _e1108.appendChild(_e1347);
  const _e1348 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1348);
  const _e1349 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1350 = WF.h("div", { className: "wf-card__body" });
  const _e1351 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Heading h2");
  _e1350.appendChild(_e1351);
  const _e1352 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Heading h2");
  _e1350.appendChild(_e1352);
  const _e1353 = WF.h("h2", { className: "wf-heading wf-heading--h3" }, "Heading h3");
  _e1350.appendChild(_e1353);
  const _e1354 = WF.h("div", { className: "wf-spacer" });
  _e1350.appendChild(_e1354);
  const _e1355 = WF.h("p", { className: "wf-text" }, "Normal text paragraph.");
  _e1350.appendChild(_e1355);
  const _e1356 = WF.h("p", { className: "wf-text wf-text--bold" }, "Bold text.");
  _e1350.appendChild(_e1356);
  const _e1357 = WF.h("p", { className: "wf-text wf-text--muted" }, "Muted text.");
  _e1350.appendChild(_e1357);
  const _e1358 = WF.h("p", { className: "wf-text wf-text--primary" }, "Primary colored.");
  _e1350.appendChild(_e1358);
  const _e1359 = WF.h("p", { className: "wf-text wf-text--danger" }, "Danger colored.");
  _e1350.appendChild(_e1359);
  const _e1360 = WF.h("p", { className: "wf-text wf-text--small" }, "Small text.");
  _e1350.appendChild(_e1360);
  const _e1361 = WF.h("p", { className: "wf-text wf-text--uppercase" }, "Uppercase.");
  _e1350.appendChild(_e1361);
  const _e1362 = WF.h("p", { className: "wf-text wf-text--center" }, "Centered text.");
  _e1350.appendChild(_e1362);
  const _e1363 = WF.h("div", { className: "wf-spacer" });
  _e1350.appendChild(_e1363);
  const _e1364 = WF.h("blockquote", { className: "wf-blockquote" }, "The best way to predict the future is to create it.");
  _e1350.appendChild(_e1364);
  const _e1365 = WF.h("div", { className: "wf-spacer" });
  _e1350.appendChild(_e1365);
  const _e1366 = WF.h("code", { className: "wf-code" }, "const greeting = \"Hello, WebFluent!\";");
  _e1350.appendChild(_e1366);
  _e1349.appendChild(_e1350);
  _e1108.appendChild(_e1349);
  const _e1367 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1367);
  const _e1368 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1369 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { WF.navigate("/styling"); } }, "Styling Guide");
  _e1368.appendChild(_e1369);
  const _e1370 = WF.h("button", { className: "wf-btn", "on:click": (e) => { WF.navigate("/animation"); } }, "Animation System");
  _e1368.appendChild(_e1370);
  _e1108.appendChild(_e1368);
  const _e1371 = WF.h("div", { className: "wf-spacer" });
  _e1108.appendChild(_e1371);
  _root.appendChild(_e1108);
  return _root;
}

function Page_Accessibility(params) {
  const _root = document.createDocumentFragment();
  const _e1372 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1373 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1373);
  const _e1374 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Accessibility Linting");
  _e1372.appendChild(_e1374);
  const _e1375 = WF.h("p", { className: "wf-text wf-text--muted" }, "WebFluent checks your code for accessibility issues at compile time. Warnings are printed during build but never block compilation.");
  _e1372.appendChild(_e1375);
  const _e1376 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1376);
  const _e1377 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "How It Works");
  _e1372.appendChild(_e1377);
  const _e1378 = WF.h("p", { className: "wf-text" }, "The linter runs automatically after parsing, before code generation. It walks the AST and checks each component against 12 rules.");
  _e1372.appendChild(_e1378);
  const _e1379 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1379);
  const _e1380 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1381 = WF.h("div", { className: "wf-card__body" });
  const _e1382 = WF.h("code", { className: "wf-code wf-code--block" }, "$ wf build\nBuilding my-app...\n  Warning [A01]: Image missing \"alt\" attribute at src/pages/Home.wf:12:5\n    Add alt text: Image(src: \"...\", alt: \"Description of image\")\n  Warning [A03]: Input missing \"label\" attribute at src/pages/Form.wf:8:9\n    Add a label: Input(text, label: \"Username\")\n  3 pages, 2 components, 1 stores\n  Build complete with 2 accessibility warning(s).");
  _e1381.appendChild(_e1382);
  _e1380.appendChild(_e1381);
  _e1372.appendChild(_e1380);
  const _e1383 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1383);
  const _e1384 = WF.h("hr", { className: "wf-divider" });
  _e1372.appendChild(_e1384);
  const _e1385 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1385);
  const _e1386 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Lint Rules");
  _e1372.appendChild(_e1386);
  const _e1387 = WF.h("table", { className: "wf-table" });
  const _e1388 = WF.h("thead", {});
  const _e1389 = WF.h("td", {}, "Rule");
  _e1388.appendChild(_e1389);
  const _e1390 = WF.h("td", {}, "Component");
  _e1388.appendChild(_e1390);
  const _e1391 = WF.h("td", {}, "Check");
  _e1388.appendChild(_e1391);
  _e1387.appendChild(_e1388);
  const _e1392 = WF.h("tr", {});
  const _e1393 = WF.h("td", {}, "A01");
  _e1392.appendChild(_e1393);
  const _e1394 = WF.h("td", {}, "Image");
  _e1392.appendChild(_e1394);
  const _e1395 = WF.h("td", {}, "Must have alt attribute");
  _e1392.appendChild(_e1395);
  _e1387.appendChild(_e1392);
  const _e1396 = WF.h("tr", {});
  const _e1397 = WF.h("td", {}, "A02");
  _e1396.appendChild(_e1397);
  const _e1398 = WF.h("td", {}, "IconButton");
  _e1396.appendChild(_e1398);
  const _e1399 = WF.h("td", {}, "Must have label attribute (no visible text)");
  _e1396.appendChild(_e1399);
  _e1387.appendChild(_e1396);
  const _e1400 = WF.h("tr", {});
  const _e1401 = WF.h("td", {}, "A03");
  _e1400.appendChild(_e1401);
  const _e1402 = WF.h("td", {}, "Input");
  _e1400.appendChild(_e1402);
  const _e1403 = WF.h("td", {}, "Must have label or placeholder");
  _e1400.appendChild(_e1403);
  _e1387.appendChild(_e1400);
  const _e1404 = WF.h("tr", {});
  const _e1405 = WF.h("td", {}, "A04");
  _e1404.appendChild(_e1405);
  const _e1406 = WF.h("td", {}, "Checkbox, Radio, Switch, Slider");
  _e1404.appendChild(_e1406);
  const _e1407 = WF.h("td", {}, "Must have label attribute");
  _e1404.appendChild(_e1407);
  _e1387.appendChild(_e1404);
  const _e1408 = WF.h("tr", {});
  const _e1409 = WF.h("td", {}, "A05");
  _e1408.appendChild(_e1409);
  const _e1410 = WF.h("td", {}, "Button");
  _e1408.appendChild(_e1410);
  const _e1411 = WF.h("td", {}, "Must have text content");
  _e1408.appendChild(_e1411);
  _e1387.appendChild(_e1408);
  const _e1412 = WF.h("tr", {});
  const _e1413 = WF.h("td", {}, "A06");
  _e1412.appendChild(_e1413);
  const _e1414 = WF.h("td", {}, "Link");
  _e1412.appendChild(_e1414);
  const _e1415 = WF.h("td", {}, "Must have text content or children");
  _e1412.appendChild(_e1415);
  _e1387.appendChild(_e1412);
  const _e1416 = WF.h("tr", {});
  const _e1417 = WF.h("td", {}, "A07");
  _e1416.appendChild(_e1417);
  const _e1418 = WF.h("td", {}, "Heading");
  _e1416.appendChild(_e1418);
  const _e1419 = WF.h("td", {}, "Must not be empty");
  _e1416.appendChild(_e1419);
  _e1387.appendChild(_e1416);
  const _e1420 = WF.h("tr", {});
  const _e1421 = WF.h("td", {}, "A08");
  _e1420.appendChild(_e1421);
  const _e1422 = WF.h("td", {}, "Modal, Dialog");
  _e1420.appendChild(_e1422);
  const _e1423 = WF.h("td", {}, "Must have title attribute");
  _e1420.appendChild(_e1423);
  _e1387.appendChild(_e1420);
  const _e1424 = WF.h("tr", {});
  const _e1425 = WF.h("td", {}, "A09");
  _e1424.appendChild(_e1425);
  const _e1426 = WF.h("td", {}, "Video");
  _e1424.appendChild(_e1426);
  const _e1427 = WF.h("td", {}, "Must have controls attribute");
  _e1424.appendChild(_e1427);
  _e1387.appendChild(_e1424);
  const _e1428 = WF.h("tr", {});
  const _e1429 = WF.h("td", {}, "A10");
  _e1428.appendChild(_e1429);
  const _e1430 = WF.h("td", {}, "Table");
  _e1428.appendChild(_e1430);
  const _e1431 = WF.h("td", {}, "Must have Thead header row");
  _e1428.appendChild(_e1431);
  _e1387.appendChild(_e1428);
  const _e1432 = WF.h("tr", {});
  const _e1433 = WF.h("td", {}, "A11");
  _e1432.appendChild(_e1433);
  const _e1434 = WF.h("td", {}, "Heading");
  _e1432.appendChild(_e1434);
  const _e1435 = WF.h("td", {}, "Levels must not skip (h1 to h3)");
  _e1432.appendChild(_e1435);
  _e1387.appendChild(_e1432);
  const _e1436 = WF.h("tr", {});
  const _e1437 = WF.h("td", {}, "A12");
  _e1436.appendChild(_e1437);
  const _e1438 = WF.h("td", {}, "Page");
  _e1436.appendChild(_e1438);
  const _e1439 = WF.h("td", {}, "Must have exactly one h1");
  _e1436.appendChild(_e1439);
  _e1387.appendChild(_e1436);
  _e1372.appendChild(_e1387);
  const _e1440 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1440);
  const _e1441 = WF.h("hr", { className: "wf-divider" });
  _e1372.appendChild(_e1441);
  const _e1442 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1442);
  const _e1443 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Examples");
  _e1372.appendChild(_e1443);
  const _e1444 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1445 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1446 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1447 = WF.h("div", { className: "wf-card__body" });
  const _e1448 = WF.h("p", { className: "wf-text wf-text--danger wf-text--bold" }, "Bad (triggers warning)");
  _e1447.appendChild(_e1448);
  const _e1449 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\")\nIconButton(icon: \"close\")\nInput(text)\nCheckbox(bind: agreed)\nButton()");
  _e1447.appendChild(_e1449);
  _e1446.appendChild(_e1447);
  _e1445.appendChild(_e1446);
  _e1444.appendChild(_e1445);
  const _e1450 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1451 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1452 = WF.h("div", { className: "wf-card__body" });
  const _e1453 = WF.h("p", { className: "wf-text wf-text--success wf-text--bold" }, "Good (no warnings)");
  _e1452.appendChild(_e1453);
  const _e1454 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\", alt: \"Team photo\")\nIconButton(icon: \"close\", label: \"Close\")\nInput(text, label: \"Username\")\nCheckbox(bind: agreed, label: \"I agree\")\nButton(\"Save\")");
  _e1452.appendChild(_e1454);
  _e1451.appendChild(_e1452);
  _e1450.appendChild(_e1451);
  _e1444.appendChild(_e1450);
  _e1372.appendChild(_e1444);
  const _e1455 = WF.h("div", { className: "wf-spacer" });
  _e1372.appendChild(_e1455);
  _root.appendChild(_e1372);
  return _root;
}
...
(function() {
  ...
  _app.innerHTML = '';
  const _e1456 = Component_NavBar({});
  _app.appendChild(_e1456);
  ...
  const _e1457 = Component_SiteFooter({});
  _app.appendChild(_e1457);
})();
