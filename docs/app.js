...
function Component_DocSidebar() {
  ...
  _e28.appendChild(_e59);
  _frag.appendChild(_e28);
  const _e61 = WF.h("div", { className: "wf-sidebar__scrim", hidden: true });
  const _e62 = WF.h("button", { className: "wf-sidebar__toggle", type: "button", "aria-label": "Open navigation", "aria-expanded": "false", "aria-controls": "wf-sidebar-28" }, "\u2630");
  _frag.appendChild(_e61);
  _frag.appendChild(_e62);
  WF.offCanvas(_e28, _e62, _e61);
  return _frag;
}

function Page_Pdf(params) {
  const _root = document.createDocumentFragment();
  const _e63 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e64 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e64);
  const _e65 = WF.h("h1", { className: "wf-heading" }, "PDF Generation");
  _e63.appendChild(_e65);
  const _e66 = WF.h("p", { className: "wf-text wf-text--muted" }, "Generate PDF documents directly from .wf source files. No external dependencies — raw PDF 1.7 output.");
  _e63.appendChild(_e66);
  const _e67 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e67);
  const _e68 = WF.h("h2", { className: "wf-heading" }, "Enable PDF Output");
  ...
  const _e73 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"build\": {\n    \"output_type\": \"pdf\",\n    \"pdf\": {\n      \"page_size\": \"A4\",\n      \"margins\": { \"top\": 72, \"bottom\": 72, \"left\": 72, \"right\": 72 },\n      \"default_font\": \"Helvetica\",\n      \"default_font_size\": 12,\n      \"output_filename\": \"report.pdf\"\n    }\n  }\n}");
  ...
  _e63.appendChild(_e75);
  const _e76 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e76);
  const _e77 = WF.h("h2", { className: "wf-heading" }, "Quick Start");
  _e63.appendChild(_e77);
  const _e78 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e79 = WF.h("div", { className: "wf-card__body" });
  const _e80 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-report --template pdf\ncd my-report\nwf build");
  ...
  _e63.appendChild(_e83);
  const _e84 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e84);
  const _e85 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e85);
  const _e86 = WF.h("h2", { className: "wf-heading" }, "Document Structure");
  ...
  const _e102 = WF.h("tr", {});
  const _e103 = WF.h("td", {}, "Document");
  _e102.appendChild(_e103);
  const _e104 = WF.h("td", {}, "Root element. Sets page size via page_size arg.");
  _e102.appendChild(_e104);
  _e98.appendChild(_e102);
  const _e105 = WF.h("tr", {});
  const _e106 = WF.h("td", {}, "Header / Footer");
  _e105.appendChild(_e106);
  const _e107 = WF.h("td", {}, "Repeated on every page. Positioned in margins.");
  _e105.appendChild(_e107);
  _e98.appendChild(_e105);
  const _e108 = WF.h("tr", {});
  const _e109 = WF.h("td", {}, "Section");
  _e108.appendChild(_e109);
  const _e110 = WF.h("td", {}, "Groups content with spacing.");
  _e108.appendChild(_e110);
  _e98.appendChild(_e108);
  const _e111 = WF.h("tr", {});
  const _e112 = WF.h("td", {}, "Paragraph");
  _e111.appendChild(_e112);
  const _e113 = WF.h("td", {}, "Block of text with paragraph spacing.");
  _e111.appendChild(_e113);
  _e98.appendChild(_e111);
  const _e114 = WF.h("tr", {});
  const _e115 = WF.h("td", {}, "PageBreak");
  _e114.appendChild(_e115);
  const _e116 = WF.h("td", {}, "Forces a new page.");
  _e114.appendChild(_e116);
  _e98.appendChild(_e114);
  const _e117 = WF.h("tr", {});
  const _e118 = WF.h("td", {}, "Heading(text, h1..h6)");
  _e117.appendChild(_e118);
  const _e119 = WF.h("td", {}, "Bold heading. h1=28pt, h2=22pt, h3=18pt...");
  _e117.appendChild(_e119);
  _e98.appendChild(_e117);
  const _e120 = WF.h("tr", {});
  const _e121 = WF.h("td", {}, "Text(text)");
  _e120.appendChild(_e121);
  const _e122 = WF.h("td", {}, "Body text with word wrapping.");
  _e120.appendChild(_e122);
  _e98.appendChild(_e120);
  const _e123 = WF.h("tr", {});
  const _e124 = WF.h("td", {}, "Table / Thead / Tbody / Trow / Tcell");
  _e123.appendChild(_e124);
  const _e125 = WF.h("td", {}, "Gridded table with borders and header styling.");
  _e123.appendChild(_e125);
  _e98.appendChild(_e123);
  const _e126 = WF.h("tr", {});
  const _e127 = WF.h("td", {}, "List");
  _e126.appendChild(_e127);
  const _e128 = WF.h("td", {}, "Bulleted list. Add ordered modifier for numbered.");
  _e126.appendChild(_e128);
  _e98.appendChild(_e126);
  const _e129 = WF.h("tr", {});
  const _e130 = WF.h("td", {}, "Code(text, block)");
  _e129.appendChild(_e130);
  const _e131 = WF.h("td", {}, "Monospace code with gray background.");
  _e129.appendChild(_e131);
  _e98.appendChild(_e129);
  const _e132 = WF.h("tr", {});
  const _e133 = WF.h("td", {}, "Blockquote");
  _e132.appendChild(_e133);
  const _e134 = WF.h("td", {}, "Indented text with left bar.");
  _e132.appendChild(_e134);
  _e98.appendChild(_e132);
  const _e135 = WF.h("tr", {});
  const _e136 = WF.h("td", {}, "Divider");
  _e135.appendChild(_e136);
  const _e137 = WF.h("td", {}, "Horizontal line.");
  _e135.appendChild(_e137);
  _e98.appendChild(_e135);
  const _e138 = WF.h("tr", {});
  const _e139 = WF.h("td", {}, "Alert(text, variant)");
  _e138.appendChild(_e139);
  const _e140 = WF.h("td", {}, "Colored box with left accent bar.");
  _e138.appendChild(_e140);
  _e98.appendChild(_e138);
  const _e141 = WF.h("tr", {});
  const _e142 = WF.h("td", {}, "Badge / Tag");
  _e141.appendChild(_e142);
  const _e143 = WF.h("td", {}, "Colored pill with white text.");
  _e141.appendChild(_e143);
  _e98.appendChild(_e141);
  const _e144 = WF.h("tr", {});
  const _e145 = WF.h("td", {}, "Progress(value, max)");
  _e144.appendChild(_e145);
  const _e146 = WF.h("td", {}, "Horizontal bar.");
  _e144.appendChild(_e146);
  _e98.appendChild(_e144);
  const _e147 = WF.h("tr", {});
  const _e148 = WF.h("td", {}, "Card");
  _e147.appendChild(_e148);
  const _e149 = WF.h("td", {}, "Bordered box around children.");
  _e147.appendChild(_e149);
  _e98.appendChild(_e147);
  const _e150 = WF.h("tr", {});
  const _e151 = WF.h("td", {}, "Image(src)");
  _e150.appendChild(_e151);
  const _e152 = WF.h("td", {}, "Placeholder rectangle (JPEG planned).");
  _e150.appendChild(_e152);
  _e98.appendChild(_e150);
  const _e153 = WF.h("tr", {});
  const _e154 = WF.h("td", {}, "Spacer");
  _e153.appendChild(_e154);
  const _e155 = WF.h("td", {}, "Vertical space. Modifiers: sm, md, lg, xl.");
  _e153.appendChild(_e155);
  _e98.appendChild(_e153);
  _e63.appendChild(_e98);
  const _e156 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e156);
  const _e157 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e157);
  const _e158 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e158);
  const _e159 = WF.h("h2", { className: "wf-heading" }, "Rejected Components");
  ...
  const _e164 = WF.h("code", { className: "wf-code wf-code--block" }, "error[pdf]: 'Button' cannot be used in PDF output (Page Report)\n  — interactive elements are not supported in PDF\n\nerror[pdf]: 'Input' cannot be used in PDF output (Page Report)\n  — interactive elements are not supported in PDF");
  ...
  _e63.appendChild(_e167);
  const _e168 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e168);
  const _e169 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e169);
  const _e170 = WF.h("h2", { className: "wf-heading" }, "Page Sizes");
  ...
  const _e176 = WF.h("tr", {});
  const _e177 = WF.h("td", {}, "A4");
  _e176.appendChild(_e177);
  const _e178 = WF.h("td", {}, "595 x 842");
  _e176.appendChild(_e178);
  const _e179 = WF.h("td", {}, "210 x 297");
  _e176.appendChild(_e179);
  _e171.appendChild(_e176);
  const _e180 = WF.h("tr", {});
  const _e181 = WF.h("td", {}, "A3");
  _e180.appendChild(_e181);
  const _e182 = WF.h("td", {}, "842 x 1191");
  _e180.appendChild(_e182);
  const _e183 = WF.h("td", {}, "297 x 420");
  _e180.appendChild(_e183);
  _e171.appendChild(_e180);
  const _e184 = WF.h("tr", {});
  const _e185 = WF.h("td", {}, "A5");
  _e184.appendChild(_e185);
  const _e186 = WF.h("td", {}, "420 x 595");
  _e184.appendChild(_e186);
  const _e187 = WF.h("td", {}, "148 x 210");
  _e184.appendChild(_e187);
  _e171.appendChild(_e184);
  const _e188 = WF.h("tr", {});
  const _e189 = WF.h("td", {}, "Letter");
  _e188.appendChild(_e189);
  const _e190 = WF.h("td", {}, "612 x 792");
  _e188.appendChild(_e190);
  const _e191 = WF.h("td", {}, "216 x 279");
  _e188.appendChild(_e191);
  _e171.appendChild(_e188);
  const _e192 = WF.h("tr", {});
  const _e193 = WF.h("td", {}, "Legal");
  _e192.appendChild(_e193);
  const _e194 = WF.h("td", {}, "612 x 1008");
  _e192.appendChild(_e194);
  const _e195 = WF.h("td", {}, "216 x 356");
  _e192.appendChild(_e195);
  _e171.appendChild(_e192);
  _e63.appendChild(_e171);
  const _e196 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e196);
  const _e197 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e197);
  const _e198 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e198);
  const _e199 = WF.h("h2", { className: "wf-heading" }, "Fonts");
  ...
  const _e206 = WF.h("tr", {});
  const _e207 = WF.h("td", {}, "Helvetica");
  _e206.appendChild(_e207);
  const _e208 = WF.h("td", {}, "Regular, Bold, Oblique, BoldOblique");
  _e206.appendChild(_e208);
  _e202.appendChild(_e206);
  const _e209 = WF.h("tr", {});
  const _e210 = WF.h("td", {}, "Times");
  _e209.appendChild(_e210);
  const _e211 = WF.h("td", {}, "Roman, Bold, Italic, BoldItalic");
  _e209.appendChild(_e211);
  _e202.appendChild(_e209);
  const _e212 = WF.h("tr", {});
  const _e213 = WF.h("td", {}, "Courier");
  _e212.appendChild(_e213);
  const _e214 = WF.h("td", {}, "Regular, Bold, Oblique, BoldOblique");
  ...
  const _e220 = WF.h("code", { className: "wf-code wf-code--block" }, "Heading(\"Title\", h1) {\n    style {\n        font-family: \"Helvetica-Bold\"\n        color: \"#1a1a2e\"\n    }\n}");
  _e219.appendChild(_e220);
  _e218.appendChild(_e219);
  _e63.appendChild(_e218);
  const _e221 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e221);
  const _e222 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e222);
  const _e223 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e223);
  const _e224 = WF.h("h2", { className: "wf-heading" }, "Styling in PDF");
  ...
  const _e232 = WF.h("tr", {});
  const _e233 = WF.h("td", {}, "font-size");
  _e232.appendChild(_e233);
  const _e234 = WF.h("td", {}, "Number (points)");
  _e232.appendChild(_e234);
  const _e235 = WF.h("td", {}, "font-size: 14");
  _e232.appendChild(_e235);
  _e227.appendChild(_e232);
  const _e236 = WF.h("tr", {});
  const _e237 = WF.h("td", {}, "font-family");
  _e236.appendChild(_e237);
  const _e238 = WF.h("td", {}, "Base14 font name");
  _e236.appendChild(_e238);
  const _e239 = WF.h("td", {}, "font-family: \"Courier\"");
  _e236.appendChild(_e239);
  _e227.appendChild(_e236);
  const _e240 = WF.h("tr", {});
  const _e241 = WF.h("td", {}, "color");
  _e240.appendChild(_e241);
  const _e242 = WF.h("td", {}, "Hex color");
  _e240.appendChild(_e242);
  const _e243 = WF.h("td", {}, "color: \"#333333\"");
  _e240.appendChild(_e243);
  _e227.appendChild(_e240);
  const _e244 = WF.h("tr", {});
  const _e245 = WF.h("td", {}, "text-align");
  _e244.appendChild(_e245);
  const _e246 = WF.h("td", {}, "left, center, right");
  _e244.appendChild(_e246);
  const _e247 = WF.h("td", {}, "text-align: \"center\"");
  ...
  _e63.appendChild(_e250);
  const _e251 = WF.h("hr", { className: "wf-divider" });
  _e63.appendChild(_e251);
  const _e252 = WF.h("div", { className: "wf-spacer" });
  _e63.appendChild(_e252);
  const _e253 = WF.h("h2", { className: "wf-heading" }, "Auto Page Breaks");
...
function Page_Seo(params) {
  const _root = document.createDocumentFragment();
  const _e256 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e257 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e257);
  const _e258 = WF.h("h1", { className: "wf-heading" }, "Search & Sharing");
  _e256.appendChild(_e258);
  const _e259 = WF.h("p", { className: "wf-text wf-text--muted" }, "Everything a search engine reads and a chat app previews, generated from the page you already wrote.");
  _e256.appendChild(_e259);
  const _e260 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e260);
  const _e261 = WF.h("h2", { className: "wf-heading" }, "One setting turns it on");
  ...
  const _e266 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"meta\": {\n    \"site_url\": \"https://example.com\",\n    \"site_name\": \"Ledger\",\n    \"description\": \"Used by any page that sets none\",\n    \"image\": \"/card.png\"\n  }\n}");
  ...
  const _e269 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e269);
  const _e270 = WF.h("hr", { className: "wf-divider" });
  _e256.appendChild(_e270);
  const _e271 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e271);
  const _e272 = WF.h("h2", { className: "wf-heading" }, "Describing a page");
  ...
  const _e277 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Post (path: \"/blog/slow-roasting\",\n          title: \"Slow roasting, explained\",\n          description: \"Why we take eleven minutes over it.\",\n          type: \"article\",\n          image: \"/roast.png\") {\n    Container { ... }\n}");
  ...
  const _e284 = WF.h("tbody", {});
  const _e285 = WF.h("tr", {});
  const _e286 = WF.h("td", {}, "title");
  _e285.appendChild(_e286);
  const _e287 = WF.h("td", {}, "The tab title, the search-result heading and the card headline");
  _e285.appendChild(_e287);
  _e284.appendChild(_e285);
  const _e288 = WF.h("tr", {});
  const _e289 = WF.h("td", {}, "description");
  _e288.appendChild(_e289);
  const _e290 = WF.h("td", {}, "The snippet under a search result, and the preview text in a shared link. Around 160 characters before it is cut.");
  _e288.appendChild(_e290);
  _e284.appendChild(_e288);
  const _e291 = WF.h("tr", {});
  const _e292 = WF.h("td", {}, "image");
  _e291.appendChild(_e292);
  const _e293 = WF.h("td", {}, "The preview image. Site-relative or absolute; either way it is made absolute in the output.");
  _e291.appendChild(_e293);
  _e284.appendChild(_e291);
  const _e294 = WF.h("tr", {});
  const _e295 = WF.h("td", {}, "type");
  _e294.appendChild(_e295);
  const _e296 = WF.h("td", {}, "\"website\" by default, or \"article\" for a post — which also changes the structured data type.");
  _e294.appendChild(_e296);
  _e284.appendChild(_e294);
  const _e297 = WF.h("tr", {});
  const _e298 = WF.h("td", {}, "noindex");
  _e297.appendChild(_e298);
  const _e299 = WF.h("td", {}, "A bare flag. Keeps the page out of search results and out of the sitemap.");
  ...
  const _e303 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Draft (path: \"/draft\", title: \"Draft\", noindex) { ... }");
  _e302.appendChild(_e303);
  _e301.appendChild(_e302);
  _e256.appendChild(_e301);
  const _e304 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e304);
  const _e305 = WF.h("hr", { className: "wf-divider" });
  _e256.appendChild(_e305);
  const _e306 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e306);
  const _e307 = WF.h("h2", { className: "wf-heading" }, "What each page gets");
  ...
  const _e314 = WF.h("h3", { className: "wf-heading" }, "A canonical URL");
  ...
  const _e318 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e319 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e320 = WF.h("div", { className: "wf-card__body" });
  const _e321 = WF.h("h3", { className: "wf-heading" }, "A sharing card");
  ...
  const _e330 = WF.h("h3", { className: "wf-heading" }, "Structured data");
  ...
  const _e334 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e335 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e336 = WF.h("div", { className: "wf-card__body" });
  const _e337 = WF.h("h3", { className: "wf-heading" }, "Language alternates");
  ...
  _e326.appendChild(_e334);
  _e256.appendChild(_e326);
  const _e341 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e341);
  const _e342 = WF.h("hr", { className: "wf-divider" });
  _e256.appendChild(_e342);
  const _e343 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e343);
  const _e344 = WF.h("h2", { className: "wf-heading" }, "Sitemap and robots");
  ...
  const _e349 = WF.h("code", { className: "wf-code wf-code--block" }, "build/\n  sitemap.xml\n  robots.txt");
  ...
  const _e357 = WF.h("code", { className: "wf-code wf-code--block" }, "{ \"meta\": { \"sitemap\": false } }");
  _e356.appendChild(_e357);
  _e355.appendChild(_e356);
  _e256.appendChild(_e355);
  const _e358 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e358);
  const _e359 = WF.h("hr", { className: "wf-divider" });
  _e256.appendChild(_e359);
  const _e360 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e360);
  const _e361 = WF.h("h2", { className: "wf-heading" }, "What the compiler tells you");
  ...
  const _e369 = WF.h("tbody", {});
  const _e370 = WF.h("tr", {});
  const _e371 = WF.h("td", {}, "S01");
  _e370.appendChild(_e371);
  const _e372 = WF.h("td", {}, "A page with no title — nothing to show as the result link");
  _e370.appendChild(_e372);
  _e369.appendChild(_e370);
  const _e373 = WF.h("tr", {});
  const _e374 = WF.h("td", {}, "S02");
  _e373.appendChild(_e374);
  const _e375 = WF.h("td", {}, "A page with no description, so its snippet gets written for it");
  _e373.appendChild(_e375);
  _e369.appendChild(_e373);
  const _e376 = WF.h("tr", {});
  const _e377 = WF.h("td", {}, "S03");
  _e376.appendChild(_e377);
  const _e378 = WF.h("td", {}, "A description a search result will cut mid-sentence");
  _e376.appendChild(_e378);
  _e369.appendChild(_e376);
  const _e379 = WF.h("tr", {});
  const _e380 = WF.h("td", {}, "S04");
  _e379.appendChild(_e380);
  const _e381 = WF.h("td", {}, "Two pages claiming the same route");
  _e379.appendChild(_e381);
  _e369.appendChild(_e379);
  _e364.appendChild(_e369);
  _e256.appendChild(_e364);
  const _e382 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e382);
  const _e383 = WF.h("hr", { className: "wf-divider" });
  _e256.appendChild(_e383);
  const _e384 = WF.h("div", { className: "wf-spacer" });
  _e256.appendChild(_e384);
  const _e385 = WF.h("h2", { className: "wf-heading" }, "Static builds rank better");
  ...
  _e256.appendChild(_e391);
  _root.appendChild(_e256);
  return _root;
}

function Page_Ssg(params) {
  const _root = document.createDocumentFragment();
  const _e392 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e393 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e393);
  const _e394 = WF.h("h1", { className: "wf-heading" }, "Static Site Generation (SSG)");
  _e392.appendChild(_e394);
  const _e395 = WF.h("p", { className: "wf-text wf-text--muted" }, "Pre-render pages to HTML at build time for instant content visibility. JavaScript hydrates the page for interactivity.");
  _e392.appendChild(_e395);
  const _e396 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e396);
  const _e397 = WF.h("h2", { className: "wf-heading" }, "Enable SSG");
  ...
  const _e402 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"build\": {\n    \"ssg\": true\n  }\n}");
  _e401.appendChild(_e402);
  _e400.appendChild(_e401);
  _e392.appendChild(_e400);
  const _e403 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e403);
  const _e404 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e404);
  ...
  const _e411 = WF.h("h2", { className: "wf-heading" }, "1. Build");
  _e410.appendChild(_e411);
  const _e412 = WF.h("p", { className: "wf-text wf-text--muted" }, "The compiler walks the AST for each page and generates static HTML from the component tree.");
  _e410.appendChild(_e412);
  _e409.appendChild(_e410);
  _e408.appendChild(_e409);
  _e407.appendChild(_e408);
  const _e413 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e414 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e415 = WF.h("div", { className: "wf-card__body" });
  const _e416 = WF.h("h2", { className: "wf-heading" }, "2. Serve");
  _e415.appendChild(_e416);
  const _e417 = WF.h("p", { className: "wf-text wf-text--muted" }, "The browser loads pre-rendered HTML. Content is visible immediately — no blank white screen.");
  _e415.appendChild(_e417);
  _e414.appendChild(_e415);
  _e413.appendChild(_e414);
  _e407.appendChild(_e413);
  const _e418 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e419 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e420 = WF.h("div", { className: "wf-card__body" });
  const _e421 = WF.h("h2", { className: "wf-heading" }, "3. Hydrate");
  _e420.appendChild(_e421);
  const _e422 = WF.h("p", { className: "wf-text wf-text--muted" }, "JavaScript runs and hydrates the page: attaches events, initializes state, fills dynamic content.");
  _e420.appendChild(_e422);
  _e419.appendChild(_e420);
  _e418.appendChild(_e419);
  _e407.appendChild(_e418);
  _e392.appendChild(_e407);
  const _e423 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e423);
  const _e424 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e424);
  ...
  const _e431 = WF.h("p", { className: "wf-text wf-text--bold" }, "SPA (default)");
  _e430.appendChild(_e431);
  const _e432 = WF.h("code", { className: "wf-code wf-code--block" }, "build/\n├── index.html       # Empty shell\n├── app.js\n└── styles.css");
  _e430.appendChild(_e432);
  _e429.appendChild(_e430);
  _e428.appendChild(_e429);
  _e427.appendChild(_e428);
  const _e433 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e434 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e435 = WF.h("div", { className: "wf-card__body" });
  const _e436 = WF.h("p", { className: "wf-text wf-text--bold" }, "SSG mode");
  _e435.appendChild(_e436);
  const _e437 = WF.h("code", { className: "wf-code wf-code--block" }, "build/\n├── index.html       # Pre-rendered /\n├── about/\n│   └── index.html   # Pre-rendered /about\n├── blog/\n│   └── index.html   # Pre-rendered /blog\n├── app.js\n└── styles.css");
  _e435.appendChild(_e437);
  _e434.appendChild(_e435);
  _e433.appendChild(_e434);
  _e427.appendChild(_e433);
  _e392.appendChild(_e427);
  const _e438 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e438);
  const _e439 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e439);
  const _e440 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e440);
  const _e441 = WF.h("h2", { className: "wf-heading" }, "What Gets Pre-Rendered");
  ...
  const _e446 = WF.h("tr", {});
  const _e447 = WF.h("td", {}, "Static text, headings, components");
  _e446.appendChild(_e447);
  const _e448 = WF.h("td", {}, "Fully rendered to HTML");
  _e446.appendChild(_e448);
  _e442.appendChild(_e446);
  const _e449 = WF.h("tr", {});
  const _e450 = WF.h("td", {}, "Container, Row, Column, Card, etc.");
  _e449.appendChild(_e450);
  const _e451 = WF.h("td", {}, "Full HTML with classes");
  _e449.appendChild(_e451);
  _e442.appendChild(_e449);
  const _e452 = WF.h("tr", {});
  const _e453 = WF.h("td", {}, "Modifiers (primary, large, etc.)");
  _e452.appendChild(_e453);
  const _e454 = WF.h("td", {}, "CSS classes applied");
  _e452.appendChild(_e454);
  _e442.appendChild(_e452);
  const _e455 = WF.h("tr", {});
  const _e456 = WF.h("td", {}, "Animation modifiers (fadeIn, etc.)");
  _e455.appendChild(_e456);
  const _e457 = WF.h("td", {}, "Animation classes applied");
  _e455.appendChild(_e457);
  _e442.appendChild(_e455);
  const _e458 = WF.h("tr", {});
  const _e459 = WF.h("td", {}, "t() i18n calls");
  _e458.appendChild(_e459);
  const _e460 = WF.h("td", {}, "Default locale text rendered");
  _e458.appendChild(_e460);
  _e442.appendChild(_e458);
  const _e461 = WF.h("tr", {});
  const _e462 = WF.h("td", {}, "State-dependent text");
  _e461.appendChild(_e462);
  const _e463 = WF.h("td", {}, "Empty placeholder (filled by JS)");
  _e461.appendChild(_e463);
  _e442.appendChild(_e461);
  const _e464 = WF.h("tr", {});
  const _e465 = WF.h("td", {}, "if / for blocks");
  _e464.appendChild(_e465);
  const _e466 = WF.h("td", {}, "Comment placeholder (filled by JS)");
  _e464.appendChild(_e466);
  _e442.appendChild(_e464);
  const _e467 = WF.h("tr", {});
  const _e468 = WF.h("td", {}, "show blocks");
  _e467.appendChild(_e468);
  const _e469 = WF.h("td", {}, "Rendered but hidden (display:none)");
  _e467.appendChild(_e469);
  _e442.appendChild(_e467);
  const _e470 = WF.h("tr", {});
  const _e471 = WF.h("td", {}, "fetch blocks");
  _e470.appendChild(_e471);
  const _e472 = WF.h("td", {}, "Loading block if present, else placeholder");
  _e470.appendChild(_e472);
  _e442.appendChild(_e470);
  const _e473 = WF.h("tr", {});
  const _e474 = WF.h("td", {}, "Event handlers");
  _e473.appendChild(_e474);
  const _e475 = WF.h("td", {}, "Attached during hydration");
  _e473.appendChild(_e475);
  _e442.appendChild(_e473);
  _e392.appendChild(_e442);
  const _e476 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e476);
  const _e477 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e477);
  const _e478 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e478);
  const _e479 = WF.h("h2", { className: "wf-heading" }, "Dynamic Routes");
  ...
  const _e483 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e483);
  const _e484 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e484);
  const _e485 = WF.h("h2", { className: "wf-heading" }, "Lists are painted, not deferred");
  ...
  const _e490 = WF.h("code", { className: "wf-code wf-code--block" }, "Store PostStore {\n    state posts = [\n        { title: \"Slow roasting\", tag: \"coffee\" },\n        { title: \"Closed Mondays\", tag: \"shop\" }\n    ]\n}\n\nList {\n    for post in PostStore.posts {\n        Card { Heading(post.title, h2) Badge(post.tag) }\n    }\n}");
  ...
  _e392.appendChild(_e493);
  const _e494 = WF.h("hr", { className: "wf-divider" });
  _e392.appendChild(_e494);
  const _e495 = WF.h("div", { className: "wf-spacer" });
  _e392.appendChild(_e495);
  const _e496 = WF.h("h2", { className: "wf-heading" }, "Sitemap and robots");
...
function Page_Styling(params) {
  const _root = document.createDocumentFragment();
  const _e501 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e502 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e502);
  const _e503 = WF.h("h1", { className: "wf-heading" }, "Design System & Styling");
  _e501.appendChild(_e503);
  const _e504 = WF.h("p", { className: "wf-text wf-text--muted" }, "Token-based design system. Every component uses design tokens for colors, spacing, typography. Change the entire look with a config update.");
  _e501.appendChild(_e504);
  const _e505 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e505);
  const _e506 = WF.h("h2", { className: "wf-heading" }, "Variant Modifiers");
  ...
  const _e511 = WF.h("p", { className: "wf-text wf-text--bold" }, "Size Modifiers");
  ...
  const _e516 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large" }, "Large");
  _e513.appendChild(_e516);
  ...
  const _e520 = WF.h("p", { className: "wf-text wf-text--bold" }, "Color Modifiers");
  ...
  const _e525 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e522.appendChild(_e525);
  const _e526 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e522.appendChild(_e526);
  const _e527 = WF.h("button", { className: "wf-btn wf-btn--warning" }, "Warning");
  _e522.appendChild(_e527);
  ...
  const _e533 = WF.h("span", { className: "wf-badge wf-badge--danger" }, "Danger");
  _e530.appendChild(_e533);
  const _e534 = WF.h("span", { className: "wf-badge wf-badge--warning" }, "Warning");
  _e530.appendChild(_e534);
  ...
  const _e538 = WF.h("p", { className: "wf-text wf-text--bold" }, "Shape and Elevation");
  ...
  const _e543 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--full" }, "Full Width");
  ...
  const _e558 = WF.h("p", { className: "wf-text wf-text--bold" }, "Text Modifiers");
  _e557.appendChild(_e558);
  _e556.appendChild(_e557);
  const _e559 = WF.h("div", { className: "wf-card__body" });
  const _e560 = WF.h("p", { className: "wf-text wf-text--bold" }, "Bold text.");
  _e559.appendChild(_e560);
  const _e561 = WF.h("p", { className: "wf-text wf-text--italic" }, "Italic text.");
  _e559.appendChild(_e561);
  const _e562 = WF.h("p", { className: "wf-text wf-text--uppercase" }, "Uppercase text.");
  _e559.appendChild(_e562);
  const _e563 = WF.h("p", { className: "wf-text wf-text--muted" }, "Muted text.");
  _e559.appendChild(_e563);
  const _e564 = WF.h("p", { className: "wf-text wf-text--primary" }, "Primary colored text.");
  _e559.appendChild(_e564);
  const _e565 = WF.h("p", { className: "wf-text wf-text--small" }, "Small text.");
  _e559.appendChild(_e565);
  const _e566 = WF.h("p", { className: "wf-text wf-text--large" }, "Large text.");
  _e559.appendChild(_e566);
  _e556.appendChild(_e559);
  _e501.appendChild(_e556);
  const _e567 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e567);
  const _e568 = WF.h("hr", { className: "wf-divider" });
  _e501.appendChild(_e568);
  const _e569 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e569);
  const _e570 = WF.h("h2", { className: "wf-heading" }, "Design Tokens");
  ...
  const _e577 = WF.h("p", { className: "wf-text wf-text--bold" }, "Colors");
  ...
  const _e583 = WF.h("tr", {});
  const _e584 = WF.h("td", {}, "color-primary");
  _e583.appendChild(_e584);
  const _e585 = WF.h("td", {}, "#3B82F6");
  _e583.appendChild(_e585);
  _e579.appendChild(_e583);
  const _e586 = WF.h("tr", {});
  const _e587 = WF.h("td", {}, "color-success");
  _e586.appendChild(_e587);
  const _e588 = WF.h("td", {}, "#22C55E");
  _e586.appendChild(_e588);
  _e579.appendChild(_e586);
  const _e589 = WF.h("tr", {});
  const _e590 = WF.h("td", {}, "color-danger");
  _e589.appendChild(_e590);
  const _e591 = WF.h("td", {}, "#EF4444");
  _e589.appendChild(_e591);
  _e579.appendChild(_e589);
  const _e592 = WF.h("tr", {});
  const _e593 = WF.h("td", {}, "color-warning");
  _e592.appendChild(_e593);
  const _e594 = WF.h("td", {}, "#F59E0B");
  _e592.appendChild(_e594);
  _e579.appendChild(_e592);
  const _e595 = WF.h("tr", {});
  const _e596 = WF.h("td", {}, "color-text");
  _e595.appendChild(_e596);
  const _e597 = WF.h("td", {}, "#0F172A");
  _e595.appendChild(_e597);
  _e579.appendChild(_e595);
  const _e598 = WF.h("tr", {});
  const _e599 = WF.h("td", {}, "color-border");
  _e598.appendChild(_e599);
  const _e600 = WF.h("td", {}, "#E2E8F0");
  _e598.appendChild(_e600);
  _e579.appendChild(_e598);
  _e578.appendChild(_e579);
  _e575.appendChild(_e578);
  _e574.appendChild(_e575);
  _e573.appendChild(_e574);
  const _e601 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e602 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e603 = WF.h("div", { className: "wf-card__header" });
  const _e604 = WF.h("p", { className: "wf-text wf-text--bold" }, "Spacing and Radius");
  ...
  const _e610 = WF.h("tr", {});
  const _e611 = WF.h("td", {}, "spacing-xs");
  _e610.appendChild(_e611);
  const _e612 = WF.h("td", {}, "0.25rem");
  _e610.appendChild(_e612);
  _e606.appendChild(_e610);
  const _e613 = WF.h("tr", {});
  const _e614 = WF.h("td", {}, "spacing-sm");
  _e613.appendChild(_e614);
  const _e615 = WF.h("td", {}, "0.5rem");
  _e613.appendChild(_e615);
  _e606.appendChild(_e613);
  const _e616 = WF.h("tr", {});
  const _e617 = WF.h("td", {}, "spacing-md");
  _e616.appendChild(_e617);
  const _e618 = WF.h("td", {}, "1rem");
  _e616.appendChild(_e618);
  _e606.appendChild(_e616);
  const _e619 = WF.h("tr", {});
  const _e620 = WF.h("td", {}, "spacing-lg");
  _e619.appendChild(_e620);
  const _e621 = WF.h("td", {}, "1.5rem");
  _e619.appendChild(_e621);
  _e606.appendChild(_e619);
  const _e622 = WF.h("tr", {});
  const _e623 = WF.h("td", {}, "radius-md");
  _e622.appendChild(_e623);
  const _e624 = WF.h("td", {}, "0.5rem");
  _e622.appendChild(_e624);
  _e606.appendChild(_e622);
  const _e625 = WF.h("tr", {});
  const _e626 = WF.h("td", {}, "radius-full");
  _e625.appendChild(_e626);
  const _e627 = WF.h("td", {}, "9999px");
  _e625.appendChild(_e627);
  _e606.appendChild(_e625);
  _e605.appendChild(_e606);
  _e602.appendChild(_e605);
  _e601.appendChild(_e602);
  _e573.appendChild(_e601);
  _e501.appendChild(_e573);
  const _e628 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e628);
  const _e629 = WF.h("hr", { className: "wf-divider" });
  _e501.appendChild(_e629);
  const _e630 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e630);
  const _e631 = WF.h("h2", { className: "wf-heading" }, "Themes");
  ...
  _e501.appendChild(_e639);
  const _e640 = WF.h("h3", { className: "wf-heading" }, "Example themes");
  ...
  _e644.style.background = "#ffffff";
  _e644.style.border = "1px solid #E2E8F0";
  _e644.style.borderRadius = "0.75rem";
  ...
  _e660.style.background = "#0F172A";
  _e660.style.color = "#E2E8F0";
  _e660.style.border = "1px solid #334155";
  _e660.style.borderRadius = "0.75rem";
  ...
  _e676.style.background = "#ffffff";
  _e676.style.border = "2px solid #000000";
  _e676.style.borderRadius = "0";
  ...
  _e691.style.background = "#ffffff";
  _e691.style.border = "3px solid #000000";
  _e691.style.borderRadius = "0";
  _e691.style.boxShadow = "4px 4px 0 #000000";
  _e691.style.fontFamily = "monospace";
  _e643.appendChild(_e691);
  _e501.appendChild(_e643);
  const _e706 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e706);
  const _e707 = WF.h("hr", { className: "wf-divider" });
  _e501.appendChild(_e707);
  const _e708 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e708);
  const _e709 = WF.h("h2", { className: "wf-heading" }, "Custom Tokens");
  ...
  const _e714 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"theme\": {\n    \"tokens\": {\n      \"color-primary\": \"#8B5CF6\"\n    }\n  }\n}");
  _e713.appendChild(_e714);
  _e712.appendChild(_e713);
  _e501.appendChild(_e712);
  const _e715 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e715);
  const _e716 = WF.h("hr", { className: "wf-divider" });
  _e501.appendChild(_e716);
  const _e717 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e717);
  const _e718 = WF.h("h2", { className: "wf-heading" }, "Style Blocks");
  ...
  const _e723 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Custom\") {\n    style {\n        background: \"#8B5CF6\"\n        padding: xl\n        radius: lg\n    }\n}");
  ...
  const _e730 = WF.h("code", { className: "wf-code wf-code--block" }, "// Responds to the viewport by itself.\nHeading(\"Invoicing\", h1)\n\n// Fixed at every width, because you said so.\nHeading(\"Invoicing\", h1) {\n    style { font-size: \"3.25rem\" }\n}");
  _e729.appendChild(_e730);
  _e728.appendChild(_e729);
  _e501.appendChild(_e728);
  const _e731 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e731);
  const _e732 = WF.h("hr", { className: "wf-divider" });
  _e501.appendChild(_e732);
  const _e733 = WF.h("div", { className: "wf-spacer" });
  _e501.appendChild(_e733);
  const _e734 = WF.h("h2", { className: "wf-heading" }, "Bringing your own design");
  ...
  const _e739 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"theme\": {\n    \"builtin\": \"structural\"\n  }\n}");
  ...
  _root.appendChild(_e501);
  return _root;
}

function Page_Guide(params) {
  const _root = document.createDocumentFragment();
  const _e742 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e743 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e743);
  const _e744 = WF.h("h1", { className: "wf-heading" }, "Language Guide");
  _e742.appendChild(_e744);
  const _e745 = WF.h("p", { className: "wf-text wf-text--muted" }, "Learn the core concepts of WebFluent.");
  _e742.appendChild(_e745);
  const _e746 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e746);
  const _e747 = WF.h("h2", { className: "wf-heading" }, "Pages");
  ...
  const _e752 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Home (path: \"/\", title: \"Home\") {\n    Container {\n        Heading(\"Welcome\", h1)\n        Text(\"This is the home page.\")\n    }\n}");
  ...
  const _e760 = WF.h("tr", {});
  const _e761 = WF.h("td", {}, "path");
  _e760.appendChild(_e761);
  const _e762 = WF.h("td", {}, "String");
  _e760.appendChild(_e762);
  const _e763 = WF.h("td", {}, "URL route for this page (required)");
  _e760.appendChild(_e763);
  _e755.appendChild(_e760);
  const _e764 = WF.h("tr", {});
  const _e765 = WF.h("td", {}, "title");
  _e764.appendChild(_e765);
  const _e766 = WF.h("td", {}, "String");
  _e764.appendChild(_e766);
  const _e767 = WF.h("td", {}, "Tab title, and the heading of a search result");
  _e764.appendChild(_e767);
  _e755.appendChild(_e764);
  const _e768 = WF.h("tr", {});
  const _e769 = WF.h("td", {}, "description");
  _e768.appendChild(_e769);
  const _e770 = WF.h("td", {}, "String");
  _e768.appendChild(_e770);
  const _e771 = WF.h("td", {}, "The snippet a search result and a link preview show");
  _e768.appendChild(_e771);
  _e755.appendChild(_e768);
  const _e772 = WF.h("tr", {});
  const _e773 = WF.h("td", {}, "image");
  _e772.appendChild(_e773);
  const _e774 = WF.h("td", {}, "String");
  _e772.appendChild(_e774);
  const _e775 = WF.h("td", {}, "Link-preview image, site-relative or absolute");
  _e772.appendChild(_e775);
  _e755.appendChild(_e772);
  const _e776 = WF.h("tr", {});
  const _e777 = WF.h("td", {}, "type");
  _e776.appendChild(_e777);
  const _e778 = WF.h("td", {}, "String");
  _e776.appendChild(_e778);
  const _e779 = WF.h("td", {}, "\"website\" (default) or \"article\"");
  _e776.appendChild(_e779);
  _e755.appendChild(_e776);
  const _e780 = WF.h("tr", {});
  const _e781 = WF.h("td", {}, "noindex");
  _e780.appendChild(_e781);
  const _e782 = WF.h("td", {}, "Flag");
  _e780.appendChild(_e782);
  const _e783 = WF.h("td", {}, "Bare word; keeps the page out of search and the sitemap");
  _e780.appendChild(_e783);
  _e755.appendChild(_e780);
  const _e784 = WF.h("tr", {});
  const _e785 = WF.h("td", {}, "guard");
  _e784.appendChild(_e785);
  const _e786 = WF.h("td", {}, "Expression");
  _e784.appendChild(_e786);
  const _e787 = WF.h("td", {}, "Navigation guard — redirects if false");
  _e784.appendChild(_e787);
  _e755.appendChild(_e784);
  const _e788 = WF.h("tr", {});
  const _e789 = WF.h("td", {}, "redirect");
  _e788.appendChild(_e789);
  const _e790 = WF.h("td", {}, "String");
  _e788.appendChild(_e790);
  const _e791 = WF.h("td", {}, "Redirect target when guard fails");
  _e788.appendChild(_e791);
  _e755.appendChild(_e788);
  _e742.appendChild(_e755);
  const _e792 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e792);
  const _e793 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e793);
  const _e794 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e794);
  const _e795 = WF.h("h2", { className: "wf-heading" }, "Components");
  ...
  const _e800 = WF.h("code", { className: "wf-code wf-code--block" }, "Component UserCard (name: String, role: String, active: Bool = true) {\n    Card(elevated) {\n        Row(align: center, gap: md) {\n            Avatar(initials: \"U\", primary)\n            Stack {\n                Text(name, bold)\n                Text(role, muted)\n            }\n            if active {\n                Badge(\"Active\", success)\n            }\n        }\n    }\n}\n\n// Usage\nUserCard(name: \"Monzer\", role: \"Developer\")");
  ...
  const _e803 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e803);
  const _e804 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e804);
  const _e805 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e805);
  const _e806 = WF.h("h2", { className: "wf-heading" }, "State and Reactivity");
  ...
  const _e811 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Counter (path: \"/counter\") {\n    state count = 0\n\n    Container {\n        Text(\"Count: {count}\")\n        Button(\"+1\", primary) { count = count + 1 }\n        Button(\"-1\") { count = count - 1 }\n    }\n}");
  ...
  const _e814 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e815 = WF.h("div", { className: "wf-card__body" });
  const _e816 = WF.h("code", { className: "wf-code wf-code--block" }, "state items = [{name: \"A\", price: 3}, {name: \"B\", price: 2}]\nderived total = items.map(i => i.price).sum()\nderived isEmpty = items.length == 0");
  _e815.appendChild(_e816);
  _e814.appendChild(_e815);
  _e742.appendChild(_e814);
  const _e817 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e817);
  const _e818 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e818);
  const _e819 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e819);
  const _e820 = WF.h("h2", { className: "wf-heading" }, "Events");
  ...
  _e742.appendChild(_e828);
  const _e829 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e829);
  const _e830 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e830);
  const _e831 = WF.h("h2", { className: "wf-heading" }, "Control Flow");
  _e742.appendChild(_e831);
  const _e832 = WF.h("p", { className: "wf-text wf-text--bold" }, "Conditionals:");
  _e742.appendChild(_e832);
  const _e833 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e834 = WF.h("div", { className: "wf-card__body" });
  const _e835 = WF.h("code", { className: "wf-code wf-code--block" }, "if isLoggedIn {\n    Text(\"Welcome back!\")\n} else if isGuest {\n    Text(\"Hello, guest\")\n} else {\n    Button(\"Log In\") { navigate(\"/login\") }\n}");
  ...
  const _e838 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e839 = WF.h("div", { className: "wf-card__body" });
  const _e840 = WF.h("code", { className: "wf-code wf-code--block" }, "for user in users {\n    UserCard(name: user.name, role: user.role)\n}\n\n// With index\nfor item, index in items {\n    Text(\"{index + 1}. {item}\")\n}");
  ...
  const _e843 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e844 = WF.h("div", { className: "wf-card__body" });
  const _e845 = WF.h("code", { className: "wf-code wf-code--block" }, "show isExpanded {\n    Card { Text(\"Expanded content\") }\n}");
  _e844.appendChild(_e845);
  _e843.appendChild(_e844);
  _e742.appendChild(_e843);
  const _e846 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e846);
  const _e847 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e847);
  const _e848 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e848);
  const _e849 = WF.h("h2", { className: "wf-heading" }, "Stores");
  ...
  const _e872 = WF.h("code", { className: "wf-code wf-code--block" }, "fetch users from \"/api/users\" {\n    loading {\n        Spinner()\n    }\n    error (err) {\n        Alert(\"Failed to load users\", danger)\n    }\n    success {\n        for user in users {\n            UserCard(name: user.name, role: user.role)\n        }\n    }\n}\n\n// With options\nfetch result from \"/api/submit\" (method: \"POST\", body: { name: name, email: email }) {\n    success {\n        Alert(\"Saved!\", success)\n    }\n}");
  _e871.appendChild(_e872);
  _e870.appendChild(_e871);
  _e742.appendChild(_e870);
  const _e873 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e873);
  const _e874 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e874);
  const _e875 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e875);
  const _e876 = WF.h("h2", { className: "wf-heading" }, "Return Values");
  ...
  const _e881 = WF.h("code", { className: "wf-code wf-code--block" }, "Store AuthStore {\n    state accessToken = \"\"\n\n    action getHeaders() {\n        h = {}\n        h[\"Authorization\"] = \"Bearer \" + accessToken\n        return h\n    }\n}");
  _e880.appendChild(_e881);
  _e879.appendChild(_e880);
  _e742.appendChild(_e879);
  const _e882 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e882);
  const _e883 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e883);
  const _e884 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e884);
  const _e885 = WF.h("h2", { className: "wf-heading" }, "Browser Globals");
  ...
  const _e890 = WF.h("code", { className: "wf-code wf-code--block" }, "// Storage\nlocalStorage.setItem(\"token\", tok)\nsessionStorage.getItem(\"key\")\n\n// Window & Document\nwindow.open(\"https://example.com\")\n\n// JSON\ndata = JSON.parse(responseText)\ntext = JSON.stringify(obj)\n\n// Console\nconsole.log(\"debug info\")\n\n// Timers\nsetTimeout(callback, 1000)");
  ...
  const _e893 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e893);
  const _e894 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e894);
  const _e895 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e895);
  const _e896 = WF.h("h2", { className: "wf-heading" }, "Map Literals");
  ...
  const _e901 = WF.h("code", { className: "wf-code wf-code--block" }, "// Quoted keys for headers\nheaders: { \"Content-Type\": \"application/json\", \"X-Api-Key\": apiKey }\n\n// Reserved words as keys\nbody: { action: \"create\", token: sessionToken, state: \"active\" }");
  _e900.appendChild(_e901);
  _e899.appendChild(_e900);
  _e742.appendChild(_e899);
  const _e902 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e902);
  const _e903 = WF.h("hr", { className: "wf-divider" });
  _e742.appendChild(_e903);
  const _e904 = WF.h("div", { className: "wf-spacer" });
  _e742.appendChild(_e904);
  const _e905 = WF.h("h2", { className: "wf-heading" }, "Operators");
  ...
  const _e914 = WF.h("td", {}, "Equal");
  _e912.appendChild(_e914);
  _e908.appendChild(_e912);
  const _e915 = WF.h("tr", {});
  const _e916 = WF.h("td", {}, "!=");
  _e915.appendChild(_e916);
  const _e917 = WF.h("td", {}, "Not equal");
  _e915.appendChild(_e917);
  _e908.appendChild(_e915);
  const _e918 = WF.h("tr", {});
  const _e919 = WF.h("td", {}, "!==");
  _e918.appendChild(_e919);
  const _e920 = WF.h("td", {}, "Strict not equal (alias for !=)");
  _e918.appendChild(_e920);
  _e908.appendChild(_e918);
  const _e921 = WF.h("tr", {});
  const _e922 = WF.h("td", {}, "< > <= >=");
  _e921.appendChild(_e922);
  const _e923 = WF.h("td", {}, "Comparison");
  _e921.appendChild(_e923);
  _e908.appendChild(_e921);
  const _e924 = WF.h("tr", {});
  const _e925 = WF.h("td", {}, "&& ||");
  _e924.appendChild(_e925);
  const _e926 = WF.h("td", {}, "Logical AND / OR");
  _e924.appendChild(_e926);
  _e908.appendChild(_e924);
  const _e927 = WF.h("tr", {});
  const _e928 = WF.h("td", {}, "!");
  _e927.appendChild(_e928);
  const _e929 = WF.h("td", {}, "Logical NOT");
  _e927.appendChild(_e929);
  _e908.appendChild(_e927);
  const _e930 = WF.h("tr", {});
  const _e931 = WF.h("td", {}, "+ - * / %");
  _e930.appendChild(_e931);
  const _e932 = WF.h("td", {}, "Arithmetic");
  _e930.appendChild(_e932);
  _e908.appendChild(_e930);
...
function Page_NotFound(params) {
  ...
  const _e943 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, "The page you are looking for does not exist or has been moved.");
...
function Page_Components(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e948 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e949 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e949);
  const _e950 = WF.h("h1", { className: "wf-heading" }, "Components Reference");
  _e948.appendChild(_e950);
  const _e951 = WF.h("p", { className: "wf-text wf-text--muted" }, "50+ built-in components. Below are live interactive examples you can play with.");
  _e948.appendChild(_e951);
  const _e952 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e952);
  const _e953 = WF.h("h2", { className: "wf-heading" }, "Buttons");
  ...
  const _e961 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e958.appendChild(_e961);
  const _e962 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e958.appendChild(_e962);
  const _e963 = WF.h("button", { className: "wf-btn wf-btn--warning" }, "Warning");
  ...
  const _e969 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large" }, "Large");
  _e966.appendChild(_e969);
  const _e970 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--rounded" }, "Rounded");
  _e966.appendChild(_e970);
  const _e971 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--full" }, "Full Width");
  _e966.appendChild(_e971);
  ...
  const _e986 = WF.h("p", { className: "wf-text wf-text--bold" }, "Default Card");
  _e985.appendChild(_e986);
  _e984.appendChild(_e985);
  const _e987 = WF.h("div", { className: "wf-card__body" });
  const _e988 = WF.h("p", { className: "wf-text wf-text--muted" }, "Basic card with header and body.");
  _e987.appendChild(_e988);
  _e984.appendChild(_e987);
  const _e989 = WF.h("div", { className: "wf-card__footer" });
  const _e990 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--small" }, "Action");
  console.log("clicked");
  _e989.appendChild(_e990);
  _e984.appendChild(_e989);
  _e983.appendChild(_e984);
  _e982.appendChild(_e983);
  const _e991 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e992 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e993 = WF.h("div", { className: "wf-card__header" });
  const _e994 = WF.h("p", { className: "wf-text wf-text--bold" }, "Elevated");
  _e993.appendChild(_e994);
  _e992.appendChild(_e993);
  const _e995 = WF.h("div", { className: "wf-card__body" });
  const _e996 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with shadow elevation.");
  _e995.appendChild(_e996);
  _e992.appendChild(_e995);
  _e991.appendChild(_e992);
  _e982.appendChild(_e991);
  const _e997 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e998 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e999 = WF.h("div", { className: "wf-card__header" });
  const _e1000 = WF.h("p", { className: "wf-text wf-text--bold" }, "Outlined");
  _e999.appendChild(_e1000);
  _e998.appendChild(_e999);
  const _e1001 = WF.h("div", { className: "wf-card__body" });
  const _e1002 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with border only.");
  _e1001.appendChild(_e1002);
  _e998.appendChild(_e1001);
  _e997.appendChild(_e998);
  _e982.appendChild(_e997);
  _e948.appendChild(_e982);
  const _e1003 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1003);
  const _e1004 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1004);
  const _e1005 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1005);
  const _e1006 = WF.h("h2", { className: "wf-heading" }, "Form Controls");
  ...
  WF.condRender(_e1011,
    () => (_inputVal() !== ""),
    () => {
      const _e1013 = document.createDocumentFragment();
      const _e1014 = WF.h("p", { className: "wf-text wf-text--primary wf-text--bold" }, () => `You typed: ${_inputVal()}`);
  ...
  _e1011.appendChild(_e1020);
  const _e1021 = WF.h("hr", { className: "wf-divider" });
  _e1011.appendChild(_e1021);
  const _e1022 = WF.h("label", { className: "wf-checkbox" });
  const _e1023 = WF.h("input", { type: "checkbox", checked: () => _checkVal(), "on:change": () => _checkVal.set(!_checkVal()) });
  _e1022.appendChild(_e1023);
  _e1022.appendChild(WF.text("I agree to the terms"));
  _e1011.appendChild(_e1022);
  const _e1024 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Checked: ${_checkVal()}`);
  ...
  _e1027.appendChild(WF.text("Option A"));
  _e1026.appendChild(_e1027);
  const _e1029 = WF.h("label", { className: "wf-radio" });
  const _e1030 = WF.h("input", { type: "radio", checked: () => _radioVal() === "b", "on:change": () => _radioVal.set("b") });
  _e1029.appendChild(_e1030);
  _e1029.appendChild(WF.text("Option B"));
  _e1026.appendChild(_e1029);
  const _e1031 = WF.h("label", { className: "wf-radio" });
  const _e1032 = WF.h("input", { type: "radio", checked: () => _radioVal() === "c", "on:change": () => _radioVal.set("c") });
  _e1031.appendChild(_e1032);
  _e1031.appendChild(WF.text("Option C"));
  _e1026.appendChild(_e1031);
  _e1011.appendChild(_e1026);
  const _e1033 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_radioVal()}`);
  _e1011.appendChild(_e1033);
  const _e1034 = WF.h("hr", { className: "wf-divider" });
  _e1011.appendChild(_e1034);
  const _e1035 = WF.h("label", { className: "wf-switch" });
  const _e1036 = WF.h("input", { type: "checkbox", role: "switch",                  checked: () => _switchVal(), "aria-checked": () => _switchVal() ? "true" : "false",                  "on:change": () => _switchVal.set(!_switchVal()) });
  _e1035.appendChild(_e1036);
  const _e1037 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1035.appendChild(_e1037);
  _e1035.appendChild(WF.text("Dark Mode"));
  _e1011.appendChild(_e1035);
  const _e1038 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Enabled: ${_switchVal()}`);
  _e1011.appendChild(_e1038);
  const _e1039 = WF.h("hr", { className: "wf-divider" });
  _e1011.appendChild(_e1039);
  ...
  _e1011.appendChild(_e1040);
  const _e1044 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Value: ${_sliderVal()}`);
  _e1011.appendChild(_e1044);
  const _e1045 = WF.h("hr", { className: "wf-divider" });
  _e1011.appendChild(_e1045);
  const _e1047 = WF.h("div", { className: "wf-datepicker" });
  const _e1048 = WF.h("label", { className: "wf-form-label" }, "Pick a Date");
  _e1047.appendChild(_e1048);
  const _e1049 = WF.h("input", { type: "date", className: "wf-input", value: () => _dateVal(), "on:change": (e) => _dateVal.set(e.target.value) });
  _e1047.appendChild(_e1049);
  const _e1046 = _e1047;
  _e1011.appendChild(_e1046);
  const _e1050 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_dateVal()}`);
  _e1011.appendChild(_e1050);
  const _e1051 = WF.h("hr", { className: "wf-divider" });
  _e1011.appendChild(_e1051);
  const _e1053 = WF.h("div", { className: "wf-file-upload" });
  const _e1054 = WF.h("label", { className: "wf-form-label" }, "Upload Image");
  _e1053.appendChild(_e1054);
  const _e1055 = WF.h("input", { type: "file", className: "wf-input", accept: "image/*" });
  _e1053.appendChild(_e1055);
  const _e1052 = _e1053;
  _e1011.appendChild(_e1052);
  ...
  _e1009.appendChild(_e1010);
  _e948.appendChild(_e1009);
  const _e1060 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1060);
  const _e1061 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1061);
  const _e1062 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1062);
  const _e1063 = WF.h("h2", { className: "wf-heading" }, "Feedback");
  ...
  const _e1071 = WF.h("div", { className: "wf-alert wf-alert--danger", role: "alert" }, "This is a danger alert.");
  _e1068.appendChild(_e1071);
  const _e1072 = WF.h("div", { className: "wf-alert wf-alert--info", role: "status" }, "This is an info alert.");
  ...
  _e1067.appendChild(_e1078);
  const _e1079 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(true); } }, "Open Modal");
  _e1067.appendChild(_e1079);
  _e1066.appendChild(_e1067);
  _e948.appendChild(_e1066);
  const _e1080 = WF.h("dialog", { className: "wf-modal", "aria-labelledby": "wf-dlg-1080" });
  const _e1081 = WF.h("div", { className: "wf-modal__content" });
  const _e1082 = WF.h("div", { className: "wf-modal__header" }, WF.h("h3", { id: "wf-dlg-1080" }, "Example Modal"));
  _e1081.appendChild(_e1082);
  ...
  _e1081.appendChild(_e1083);
  const _e1087 = WF.h("div", { className: "wf-modal__footer" });
  const _e1088 = WF.h("button", { className: "wf-btn", "on:click": (e) => { _activeModal.set(false); } }, "Close");
  _e1087.appendChild(_e1088);
  const _e1089 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(false); } }, "Confirm");
  _e1087.appendChild(_e1089);
  _e1081.appendChild(_e1087);
  _e1080.appendChild(_e1081);
  WF.bindDialog(_e1080, _activeModal);
  _e948.appendChild(_e1080);
  const _e1090 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1090);
  const _e1091 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1091);
  const _e1092 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1092);
  const _e1093 = WF.h("h2", { className: "wf-heading" }, "Data Display");
  ...
  const _e1104 = WF.h("td", {}, "Monzer Omer");
  _e1103.appendChild(_e1104);
  const _e1105 = WF.h("td", {}, "Creator");
  _e1103.appendChild(_e1105);
  const _e1106 = WF.h("td", {}, "Active");
  _e1103.appendChild(_e1106);
  _e1098.appendChild(_e1103);
  const _e1107 = WF.h("tr", {});
  const _e1108 = WF.h("td", {}, "Sara Ali");
  _e1107.appendChild(_e1108);
  const _e1109 = WF.h("td", {}, "Designer");
  _e1107.appendChild(_e1109);
  const _e1110 = WF.h("td", {}, "Active");
  _e1107.appendChild(_e1110);
  _e1098.appendChild(_e1107);
  const _e1111 = WF.h("tr", {});
  const _e1112 = WF.h("td", {}, "Omar Hassan");
  _e1111.appendChild(_e1112);
  const _e1113 = WF.h("td", {}, "Developer");
  _e1111.appendChild(_e1113);
  const _e1114 = WF.h("td", {}, "Away");
  _e1111.appendChild(_e1114);
  _e1098.appendChild(_e1111);
  ...
  _e1116.appendChild(_e1118);
  const _e1119 = WF.h("div", { className: "wf-avatar" }, "OH");
  _e1116.appendChild(_e1119);
  const _e1120 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "Admin");
  _e1116.appendChild(_e1120);
  const _e1121 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Online");
  _e1116.appendChild(_e1121);
  const _e1122 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e1116.appendChild(_e1122);
  const _e1123 = WF.h("span", { className: "wf-tag" }, "Rust");
  _e1116.appendChild(_e1123);
  const _e1124 = WF.h("span", { className: "wf-tag" }, "Open Source");
  _e1116.appendChild(_e1124);
  _e1097.appendChild(_e1116);
  _e1096.appendChild(_e1097);
  _e948.appendChild(_e1096);
  const _e1125 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1125);
  const _e1126 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1126);
  const _e1127 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1127);
  const _e1128 = WF.h("h2", { className: "wf-heading" }, "Layout");
  ...
  const _e1141 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 2");
  _e1140.appendChild(_e1141);
  _e1139.appendChild(_e1140);
  _e1135.appendChild(_e1139);
  const _e1142 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1143 = WF.h("div", { className: "wf-card__body" });
  const _e1144 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 3");
  _e1143.appendChild(_e1144);
  _e1142.appendChild(_e1143);
  _e1135.appendChild(_e1142);
  ...
  const _e1152 = WF.h("p", { className: "wf-text wf-text--center" }, "Left Half");
  _e1151.appendChild(_e1152);
  _e1150.appendChild(_e1151);
  _e1149.appendChild(_e1150);
  _e1148.appendChild(_e1149);
  const _e1153 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1154 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1155 = WF.h("div", { className: "wf-card__body" });
  const _e1156 = WF.h("p", { className: "wf-text wf-text--center" }, "Right Half");
  _e1155.appendChild(_e1156);
  _e1154.appendChild(_e1155);
  _e1153.appendChild(_e1154);
  _e1148.appendChild(_e1153);
  _e1132.appendChild(_e1148);
  ...
  const _e1164 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1165 = WF.h("div", { className: "wf-card__body" });
  const _e1166 = WF.h("p", { className: "wf-text" }, "Item 2");
  _e1165.appendChild(_e1166);
  _e1164.appendChild(_e1165);
  _e1160.appendChild(_e1164);
  const _e1167 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1168 = WF.h("div", { className: "wf-card__body" });
  const _e1169 = WF.h("p", { className: "wf-text" }, "Item 3");
  _e1168.appendChild(_e1169);
  _e1167.appendChild(_e1168);
  _e1160.appendChild(_e1167);
  _e1132.appendChild(_e1160);
  _e1131.appendChild(_e1132);
  _e948.appendChild(_e1131);
  const _e1170 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1170);
  const _e1171 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1171);
  const _e1172 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1172);
  const _e1173 = WF.h("h2", { className: "wf-heading" }, "Icons & Icon Buttons");
  ...
  _e1238.appendChild(_e1254);
  _e1180.appendChild(_e1238);
  _e1177.appendChild(_e1180);
  ...
  const _e1263 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--primary", "data-icon": "plus", "aria-label": "Add", title: "Add" }, WF.h("span", { className: "wf-icon", "data-icon": "plus" }));
  _e1260.appendChild(_e1263);
  const _e1264 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--large", "data-icon": "search", "aria-label": "Search", title: "Search" }, WF.h("span", { className: "wf-icon", "data-icon": "search" }));
  _e1260.appendChild(_e1264);
  const _e1265 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--small", "data-icon": "close", "aria-label": "Close", title: "Close" }, WF.h("span", { className: "wf-icon", "data-icon": "close" }));
  _e1260.appendChild(_e1265);
  ...
  const _e1269 = WF.h("code", { className: "wf-code wf-code--block" }, "Icon(\"home\")\nIcon(\"search\", large, primary)\nIconButton(icon: \"edit\", label: \"Edit\")\nIconButton(icon: \"trash\", label: \"Delete\", danger)");
  _e1268.appendChild(_e1269);
  _e1267.appendChild(_e1268);
  _e948.appendChild(_e1267);
  const _e1270 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1270);
  const _e1271 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1271);
  const _e1272 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1272);
  const _e1273 = WF.h("h2", { className: "wf-heading" }, "Tooltips");
  ...
  const _e1281 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip", id: "wf-tip-1279" }, "This is a primary button");
  _e1279.appendChild(_e1281);
  _e1278.appendChild(_e1279);
  const _e1282 = WF.h("div", { className: "wf-tooltip", "aria-describedby": "wf-tip-1282" });
  const _e1283 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Delete");
  _e1282.appendChild(_e1283);
  const _e1284 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip", id: "wf-tip-1282" }, "Deletes the item permanently");
  _e1282.appendChild(_e1284);
  _e1278.appendChild(_e1282);
  const _e1285 = WF.h("div", { className: "wf-tooltip", "aria-describedby": "wf-tip-1285" });
  const _e1286 = WF.h("div", { className: "wf-avatar wf-avatar--primary" }, "MO");
  _e1285.appendChild(_e1286);
  const _e1287 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip", id: "wf-tip-1285" }, "User profile picture");
  _e1285.appendChild(_e1287);
  _e1278.appendChild(_e1285);
  ...
  const _e1291 = WF.h("code", { className: "wf-code wf-code--block" }, "Tooltip(text: \"Help text\") {\n    Button(\"Hover me\", primary)\n}");
  _e1290.appendChild(_e1291);
  _e1289.appendChild(_e1290);
  _e948.appendChild(_e1289);
  const _e1292 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1292);
  const _e1293 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1293);
  const _e1294 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1294);
  const _e1295 = WF.h("h2", { className: "wf-heading" }, "Sidebar");
  ...
  _e1301.appendChild(_e1306);
  const _e1308 = WF.h("div", { className: "wf-sidebar__item" });
  _e1308.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "user" }));
  const _e1309 = WF.h("p", { className: "wf-text" }, "Profile");
  _e1308.appendChild(_e1309);
  _e1301.appendChild(_e1308);
  _e1301.appendChild(WF.h("div", { className: "wf-sidebar__divider" }));
  const _e1310 = WF.h("div", { className: "wf-sidebar__item" });
  _e1310.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "logout" }));
  const _e1311 = WF.h("p", { className: "wf-text" }, "Logout");
  _e1310.appendChild(_e1311);
  _e1301.appendChild(_e1310);
  _e1300.appendChild(_e1301);
  const _e1312 = WF.h("div", { className: "wf-sidebar__scrim", hidden: true });
  const _e1313 = WF.h("button", { className: "wf-sidebar__toggle", type: "button", "aria-label": "Open navigation", "aria-expanded": "false", "aria-controls": "wf-sidebar-1301" }, "\u2630");
  _e1300.appendChild(_e1312);
  _e1300.appendChild(_e1313);
  WF.offCanvas(_e1301, _e1313, _e1312);
  const _e1314 = WF.h("div", { className: "wf-stack" });
  const _e1315 = WF.h("p", { className: "wf-text wf-text--muted" }, "The sidebar renders with proper structure:");
  _e1314.appendChild(_e1315);
  const _e1316 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Header for the title");
  _e1314.appendChild(_e1316);
  const _e1317 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Item with to: and icon: props");
  _e1314.appendChild(_e1317);
  const _e1318 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Divider for separation");
  _e1314.appendChild(_e1318);
  _e1300.appendChild(_e1314);
  ...
  const _e1322 = WF.h("code", { className: "wf-code wf-code--block" }, "Sidebar {\n    Sidebar.Header { Text(\"My App\", heading) }\n    Sidebar.Item(to: \"/\", icon: \"home\") { Text(\"Dashboard\") }\n    Sidebar.Item(icon: \"settings\") { Text(\"Settings\") }\n    Sidebar.Divider()\n    Sidebar.Item(icon: \"logout\") { Text(\"Logout\") }\n}");
  _e1321.appendChild(_e1322);
  _e1320.appendChild(_e1321);
  _e948.appendChild(_e1320);
  const _e1323 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1323);
  const _e1324 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1324);
  const _e1325 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1325);
  const _e1326 = WF.h("h2", { className: "wf-heading" }, "Breadcrumb");
  ...
  const _e1331 = WF.h("nav", { className: "wf-breadcrumb", "aria-label": "breadcrumb" });
  const _e1332 = WF.h("a", { className: "wf-breadcrumb__item", href: WF._basePath + "/" });
  const _e1333 = WF.h("p", { className: "wf-text" }, "Home");
  _e1332.appendChild(_e1333);
  _e1331.appendChild(_e1332);
  const _e1334 = WF.h("a", { className: "wf-breadcrumb__item", href: WF._basePath + "/components" });
  const _e1335 = WF.h("p", { className: "wf-text" }, "Components");
  _e1334.appendChild(_e1335);
  _e1331.appendChild(_e1334);
  const _e1336 = WF.h("span", { className: "wf-breadcrumb__item" });
  const _e1337 = WF.h("p", { className: "wf-text" }, "Breadcrumb");
  _e1336.appendChild(_e1337);
  _e1331.appendChild(_e1336);
  ...
  const _e1341 = WF.h("code", { className: "wf-code wf-code--block" }, "Breadcrumb {\n    Breadcrumb.Item(to: \"/\") { Text(\"Home\") }\n    Breadcrumb.Item(to: \"/docs\") { Text(\"Docs\") }\n    Breadcrumb.Item { Text(\"Current Page\") }\n}");
  _e1340.appendChild(_e1341);
  _e1339.appendChild(_e1340);
  _e948.appendChild(_e1339);
  const _e1342 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1342);
  const _e1343 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1343);
  const _e1344 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1344);
  const _e1345 = WF.h("h2", { className: "wf-heading" }, "Skeleton Loading");
  ...
  const _e1352 = WF.h("div", { className: "wf-skeleton" });
  _e1352.style.height = "16px";
  _e1352.style.width = "60%";
  _e1350.appendChild(_e1352);
  const _e1353 = WF.h("div", { className: "wf-skeleton" });
  ...
  const _e1359 = WF.h("div", { className: "wf-skeleton" });
  _e1359.style.height = "12px";
  _e1359.style.width = "80px";
  ...
  const _e1363 = WF.h("code", { className: "wf-code wf-code--block" }, "Skeleton(height: \"16px\", width: \"80%\")\nSkeleton(circle, size: \"48px\")");
  _e1362.appendChild(_e1363);
  _e1361.appendChild(_e1362);
  _e948.appendChild(_e1361);
  const _e1364 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1364);
  const _e1365 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1365);
  const _e1366 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1366);
  const _e1367 = WF.h("h2", { className: "wf-heading" }, "Dropdown & Menu");
  ...
  const _e1376 = WF.h("div", { className: "wf-dropdown__items", id: "wf-menu-1373", role: "menu" });
  const _e1377 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1378 = WF.h("p", { className: "wf-text" }, "Edit");
  _e1377.appendChild(_e1378);
  _e1376.appendChild(_e1377);
  const _e1379 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1380 = WF.h("p", { className: "wf-text" }, "Duplicate");
  _e1379.appendChild(_e1380);
  _e1376.appendChild(_e1379);
  const _e1381 = WF.h("div", { className: "wf-dropdown__divider" });
  _e1376.appendChild(_e1381);
  const _e1382 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1383 = WF.h("p", { className: "wf-text" }, "Delete");
  _e1382.appendChild(_e1383);
  _e1376.appendChild(_e1382);
  _e1373.appendChild(_e1376);
  WF.bindPopup(_e1373, _e1375, _e1374);
  _e1372.appendChild(_e1373);
  const _e1385 = WF.signal(false);
  const _e1384 = WF.h("div", { className: () => _e1385() ? "wf-menu open" : "wf-menu" });
  const _e1386 = WF.h("button", { className: "wf-btn", type: "button",              "aria-haspopup": "true", "aria-controls": "wf-menu-1384",              "aria-expanded": () => _e1385() ? "true" : "false",              "on:click": () => _e1385.set(!_e1385()) }, "Options");
  _e1384.appendChild(_e1386);
  const _e1387 = WF.h("div", { className: "wf-menu__items", id: "wf-menu-1384", role: "menu" });
  const _e1388 = WF.h("li", { className: "wf-menu__item" });
  const _e1389 = WF.h("p", { className: "wf-text" }, "Profile");
  _e1388.appendChild(_e1389);
  _e1387.appendChild(_e1388);
  const _e1390 = WF.h("li", { className: "wf-menu__item" });
  const _e1391 = WF.h("p", { className: "wf-text" }, "Settings");
  _e1390.appendChild(_e1391);
  _e1387.appendChild(_e1390);
  const _e1392 = WF.h("div", { className: "wf-menu__divider" });
  _e1387.appendChild(_e1392);
  const _e1393 = WF.h("li", { className: "wf-menu__item" });
  const _e1394 = WF.h("p", { className: "wf-text" }, "Logout");
  _e1393.appendChild(_e1394);
  _e1387.appendChild(_e1393);
  _e1384.appendChild(_e1387);
  WF.bindPopup(_e1384, _e1386, _e1385);
  _e1372.appendChild(_e1384);
  ...
  const _e1398 = WF.h("code", { className: "wf-code wf-code--block" }, "Dropdown(label: \"Actions\") {\n    Dropdown.Item { Text(\"Edit\") }\n    Dropdown.Divider()\n    Dropdown.Item { Text(\"Delete\") }\n}");
  _e1397.appendChild(_e1398);
  _e1396.appendChild(_e1397);
  _e948.appendChild(_e1396);
  const _e1399 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1399);
  const _e1400 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1400);
  const _e1401 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1401);
  const _e1402 = WF.h("h2", { className: "wf-heading" }, "Navigation");
  ...
  const _e1407 = WF.h("div", { className: "wf-tabs" });
  const _e1408 = WF.h("div", { className: "wf-tabs__nav", role: "tablist" });
  const _e1409 = WF.signal(0);
  const _e1410 = WF.h("button", { className: () => _e1409() === 0 ? "wf-tabs__tab active" : "wf-tabs__tab",                  role: "tab", type: "button", id: "wf-tab-1407-0",                  "aria-controls": "wf-tabpanel-1407-0",                  "aria-selected": () => _e1409() === 0 ? "true" : "false",                  tabindex: () => _e1409() === 0 ? 0 : -1,                  "on:click": () => _e1409.set(0) }, "Profile");
  _e1408.appendChild(_e1410);
  const _e1411 = WF.h("button", { className: () => _e1409() === 1 ? "wf-tabs__tab active" : "wf-tabs__tab",                  role: "tab", type: "button", id: "wf-tab-1407-1",                  "aria-controls": "wf-tabpanel-1407-1",                  "aria-selected": () => _e1409() === 1 ? "true" : "false",                  tabindex: () => _e1409() === 1 ? 0 : -1,                  "on:click": () => _e1409.set(1) }, "Settings");
  _e1408.appendChild(_e1411);
  const _e1412 = WF.h("button", { className: () => _e1409() === 2 ? "wf-tabs__tab active" : "wf-tabs__tab",                  role: "tab", type: "button", id: "wf-tab-1407-2",                  "aria-controls": "wf-tabpanel-1407-2",                  "aria-selected": () => _e1409() === 2 ? "true" : "false",                  tabindex: () => _e1409() === 2 ? 0 : -1,                  "on:click": () => _e1409.set(2) }, "About");
  ...
  const _e1418 = WF.h("p", { className: "wf-text wf-text--bold" }, "Monzer Omer");
  _e1417.appendChild(_e1418);
  const _e1419 = WF.h("p", { className: "wf-text wf-text--muted" }, "Creator of WebFluent");
  _e1417.appendChild(_e1419);
  _e1415.appendChild(_e1417);
  ...
  const _e1424 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  ...
  const _e1433 = WF.h("p", { className: "wf-text wf-text--muted" }, "It compiles to HTML, CSS, and JavaScript.");
  _e1430.appendChild(_e1433);
  WF.effect(() => { _e1430.style.display = _e1409() === 2 ? 'block' : 'none'; });
  _e1407.appendChild(_e1430);
  WF.tablist(_e1408, _e1409);
  _e1406.appendChild(_e1407);
  _e1405.appendChild(_e1406);
  _e948.appendChild(_e1405);
  const _e1434 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1434);
  const _e1435 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1435);
  ...
  const _e1441 = WF.h("h2", { className: "wf-heading" }, "Heading h2");
  _e1440.appendChild(_e1441);
  const _e1442 = WF.h("h2", { className: "wf-heading" }, "Heading h2");
  ...
  const _e1446 = WF.h("p", { className: "wf-text wf-text--bold" }, "Bold text.");
  _e1440.appendChild(_e1446);
  const _e1447 = WF.h("p", { className: "wf-text wf-text--muted" }, "Muted text.");
  _e1440.appendChild(_e1447);
  const _e1448 = WF.h("p", { className: "wf-text wf-text--primary" }, "Primary colored.");
  _e1440.appendChild(_e1448);
  const _e1449 = WF.h("p", { className: "wf-text wf-text--danger" }, "Danger colored.");
  _e1440.appendChild(_e1449);
  const _e1450 = WF.h("p", { className: "wf-text wf-text--small" }, "Small text.");
  _e1440.appendChild(_e1450);
  const _e1451 = WF.h("p", { className: "wf-text wf-text--uppercase" }, "Uppercase.");
  ...
  const _e1463 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1463);
  const _e1464 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1464);
  const _e1465 = WF.h("h2", { className: "wf-heading" }, "What you get for free");
  ...
  const _e1472 = WF.h("h3", { className: "wf-heading" }, "Modal and Dialog");
  ...
  _e1469.appendChild(_e1470);
  _e1468.appendChild(_e1469);
  const _e1478 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1479 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1480 = WF.h("div", { className: "wf-card__body" });
  const _e1481 = WF.h("h3", { className: "wf-heading" }, "Tabs");
  ...
  const _e1490 = WF.h("h3", { className: "wf-heading" }, "Sidebar");
  _e1489.appendChild(_e1490);
  const _e1491 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Below 768px it slides in from the edge with its own toggle, a scrim you can tap past, and Escape to close — rather than disappearing, which is what it used to do.");
  _e1489.appendChild(_e1491);
  _e1488.appendChild(_e1489);
  _e1487.appendChild(_e1488);
  _e1486.appendChild(_e1487);
  const _e1492 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1493 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1494 = WF.h("div", { className: "wf-card__body" });
  const _e1495 = WF.h("h3", { className: "wf-heading" }, "Alert, Toast and Dropdown");
  _e1494.appendChild(_e1495);
  const _e1496 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Alerts and toasts announce themselves — assertively for a failure, politely for a confirmation. A dropdown reports whether it is open and returns focus to its trigger when it closes.");
  _e1494.appendChild(_e1496);
  _e1493.appendChild(_e1494);
  _e1492.appendChild(_e1493);
  _e1486.appendChild(_e1492);
  _e948.appendChild(_e1486);
  const _e1497 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1497);
  const _e1498 = WF.h("hr", { className: "wf-divider" });
  _e948.appendChild(_e1498);
  const _e1499 = WF.h("div", { className: "wf-spacer" });
  _e948.appendChild(_e1499);
  const _e1500 = WF.h("h2", { className: "wf-heading" }, "Image");
  ...
  const _e1507 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/hero.png\", alt: \"A roastery at dawn\",\n      width: 1200, height: 630)\n\n// Above the fold? Load it straight away.\nImage(src: \"/logo.png\", alt: \"Ledger\", loading: \"eager\")");
  _e1506.appendChild(_e1507);
  _e1505.appendChild(_e1506);
  _e948.appendChild(_e1505);
  _root.appendChild(_e948);
  return _root;
}

function Page_Cli(params) {
  const _root = document.createDocumentFragment();
  const _e1508 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1509 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1509);
  const _e1510 = WF.h("h1", { className: "wf-heading" }, "CLI Reference");
  _e1508.appendChild(_e1510);
  const _e1511 = WF.h("p", { className: "wf-text wf-text--muted" }, "The WebFluent command-line interface.");
  _e1508.appendChild(_e1511);
  const _e1512 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1512);
  const _e1513 = WF.h("h2", { className: "wf-heading" }, "wf init");
  ...
  const _e1518 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init <name> [--template spa|static|pdf]");
  ...
  const _e1525 = WF.h("td", {}, "name");
  _e1524.appendChild(_e1525);
  const _e1526 = WF.h("td", {}, "Project name (creates a directory)");
  _e1524.appendChild(_e1526);
  _e1520.appendChild(_e1524);
  const _e1527 = WF.h("tr", {});
  const _e1528 = WF.h("td", {}, "--template, -t");
  _e1527.appendChild(_e1528);
  const _e1529 = WF.h("td", {}, "Template: spa (default), static, or pdf");
  ...
  const _e1532 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1532);
  const _e1533 = WF.h("hr", { className: "wf-divider" });
  _e1508.appendChild(_e1533);
  const _e1534 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1534);
  const _e1535 = WF.h("h2", { className: "wf-heading" }, "wf build");
  ...
  const _e1540 = WF.h("code", { className: "wf-code wf-code--block" }, "wf build [--dir DIR]");
  ...
  const _e1547 = WF.h("td", {}, "--dir, -d");
  _e1546.appendChild(_e1547);
  const _e1548 = WF.h("td", {}, "Project directory (default: current directory)");
  ...
  _e1553.appendChild(_e1555);
  const _e1556 = WF.h("p", { className: "wf-text" }, "PDF mode (output_type: pdf): a single .pdf file");
  _e1553.appendChild(_e1556);
  _e1508.appendChild(_e1553);
  const _e1557 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1557);
  const _e1558 = WF.h("hr", { className: "wf-divider" });
  _e1508.appendChild(_e1558);
  const _e1559 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1559);
  const _e1560 = WF.h("h2", { className: "wf-heading" }, "wf serve");
  ...
  const _e1565 = WF.h("code", { className: "wf-code wf-code--block" }, "wf serve [--dir DIR]");
  ...
  _e1508.appendChild(_e1568);
  const _e1569 = WF.h("hr", { className: "wf-divider" });
  _e1508.appendChild(_e1569);
  const _e1570 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1570);
  const _e1571 = WF.h("h2", { className: "wf-heading" }, "wf generate");
  ...
  const _e1576 = WF.h("code", { className: "wf-code wf-code--block" }, "wf generate <kind> <name> [--dir DIR]");
  ...
  const _e1584 = WF.h("td", {}, "page");
  _e1583.appendChild(_e1584);
  const _e1585 = WF.h("td", {}, "src/pages/Name.wf");
  _e1583.appendChild(_e1585);
  const _e1586 = WF.h("td", {}, "wf generate page About");
  _e1583.appendChild(_e1586);
  _e1578.appendChild(_e1583);
  const _e1587 = WF.h("tr", {});
  const _e1588 = WF.h("td", {}, "component");
  _e1587.appendChild(_e1588);
  const _e1589 = WF.h("td", {}, "src/components/Name.wf");
  _e1587.appendChild(_e1589);
  const _e1590 = WF.h("td", {}, "wf generate component Header");
  _e1587.appendChild(_e1590);
  _e1578.appendChild(_e1587);
  const _e1591 = WF.h("tr", {});
  const _e1592 = WF.h("td", {}, "store");
  _e1591.appendChild(_e1592);
  const _e1593 = WF.h("td", {}, "src/stores/name.wf");
  _e1591.appendChild(_e1593);
  const _e1594 = WF.h("td", {}, "wf generate store CartStore");
  _e1591.appendChild(_e1594);
  _e1578.appendChild(_e1591);
  _e1508.appendChild(_e1578);
  const _e1595 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1595);
  const _e1596 = WF.h("hr", { className: "wf-divider" });
  _e1508.appendChild(_e1596);
  const _e1597 = WF.h("div", { className: "wf-spacer" });
  _e1508.appendChild(_e1597);
  const _e1598 = WF.h("h2", { className: "wf-heading" }, "Configuration");
...
function Page_I18n(params) {
  const _root = document.createDocumentFragment();
  const _e1605 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1606 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1606);
  const _e1607 = WF.h("h1", { className: "wf-heading" }, "Internationalization (i18n)");
  _e1605.appendChild(_e1607);
  const _e1608 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built-in multi-language support with reactive locale switching and automatic RTL.");
  _e1605.appendChild(_e1608);
  const _e1609 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1609);
  const _e1610 = WF.h("h2", { className: "wf-heading" }, "Setup");
  ...
  const _e1615 = WF.h("code", { className: "wf-code wf-code--block" }, "// src/translations/en.json\n{\n    \"greeting\": \"Hello, {name}!\",\n    \"nav.home\": \"Home\",\n    \"nav.about\": \"About\"\n}\n\n// src/translations/ar.json\n{\n    \"greeting\": \"!أهلاً، {name}\",\n    \"nav.home\": \"الرئيسية\",\n    \"nav.about\": \"حول\"\n}");
  ...
  const _e1618 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1619 = WF.h("div", { className: "wf-card__body" });
  const _e1620 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"i18n\": {\n    \"defaultLocale\": \"en\",\n    \"locales\": [\"en\", \"ar\"],\n    \"dir\": \"src/translations\"\n  }\n}");
  _e1619.appendChild(_e1620);
  _e1618.appendChild(_e1619);
  _e1605.appendChild(_e1618);
  const _e1621 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1621);
  const _e1622 = WF.h("hr", { className: "wf-divider" });
  _e1605.appendChild(_e1622);
  const _e1623 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1623);
  const _e1624 = WF.h("h2", { className: "wf-heading" }, "The t() Function");
  ...
  const _e1629 = WF.h("code", { className: "wf-code wf-code--block" }, "// Simple key lookup\nText(t(\"nav.home\"))\n\n// With interpolation\nText(t(\"greeting\", name: user.name))\n\n// In any component\nButton(t(\"actions.save\"), primary)\nHeading(t(\"page.title\"), h1)");
  _e1628.appendChild(_e1629);
  _e1627.appendChild(_e1628);
  _e1605.appendChild(_e1627);
  const _e1630 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1630);
  const _e1631 = WF.h("hr", { className: "wf-divider" });
  _e1605.appendChild(_e1631);
  const _e1632 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1632);
  const _e1633 = WF.h("h2", { className: "wf-heading" }, "Locale Switching");
  ...
  const _e1638 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"English\") { setLocale(\"en\") }\nButton(\"العربية\") { setLocale(\"ar\") }\nButton(\"Espanol\") { setLocale(\"es\") }\n\n// Access current locale\nText(\"Current: {locale}\")\nText(\"Direction: {dir}\")");
  _e1637.appendChild(_e1638);
  _e1636.appendChild(_e1637);
  _e1605.appendChild(_e1636);
  const _e1639 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1639);
  const _e1640 = WF.h("hr", { className: "wf-divider" });
  _e1605.appendChild(_e1640);
  const _e1641 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1641);
  const _e1642 = WF.h("h2", { className: "wf-heading" }, "RTL Support");
  ...
  const _e1650 = WF.h("td", {}, "ar (Arabic)");
  _e1649.appendChild(_e1650);
  const _e1651 = WF.h("td", {}, "RTL");
  _e1649.appendChild(_e1651);
  _e1645.appendChild(_e1649);
  const _e1652 = WF.h("tr", {});
  const _e1653 = WF.h("td", {}, "he (Hebrew)");
  _e1652.appendChild(_e1653);
  const _e1654 = WF.h("td", {}, "RTL");
  _e1652.appendChild(_e1654);
  _e1645.appendChild(_e1652);
  const _e1655 = WF.h("tr", {});
  const _e1656 = WF.h("td", {}, "fa (Farsi)");
  _e1655.appendChild(_e1656);
  const _e1657 = WF.h("td", {}, "RTL");
  _e1655.appendChild(_e1657);
  _e1645.appendChild(_e1655);
  const _e1658 = WF.h("tr", {});
  const _e1659 = WF.h("td", {}, "ur (Urdu)");
  _e1658.appendChild(_e1659);
  const _e1660 = WF.h("td", {}, "RTL");
  _e1658.appendChild(_e1660);
  _e1645.appendChild(_e1658);
  const _e1661 = WF.h("tr", {});
  const _e1662 = WF.h("td", {}, "All others");
  _e1661.appendChild(_e1662);
  const _e1663 = WF.h("td", {}, "LTR");
  ...
  const _e1666 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1666);
  const _e1667 = WF.h("hr", { className: "wf-divider" });
  _e1605.appendChild(_e1667);
  const _e1668 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1668);
  const _e1669 = WF.h("h2", { className: "wf-heading" }, "Fallback Behavior");
  ...
  _e1605.appendChild(_e1671);
  const _e1674 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1674);
  const _e1675 = WF.h("hr", { className: "wf-divider" });
  _e1605.appendChild(_e1675);
  const _e1676 = WF.h("div", { className: "wf-spacer" });
  _e1605.appendChild(_e1676);
  const _e1677 = WF.h("h2", { className: "wf-heading" }, "SSG + i18n");
...
function Page_TemplateEngine(params) {
  const _root = document.createDocumentFragment();
  const _e1680 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1681 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1681);
  const _e1682 = WF.h("h1", { className: "wf-heading" }, () => WF.i18n.t("tpl.title"));
  _e1680.appendChild(_e1682);
  const _e1683 = WF.h("p", { className: "wf-text wf-text--muted" }, () => WF.i18n.t("tpl.subtitle"));
  _e1680.appendChild(_e1683);
  const _e1684 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1684);
  const _e1685 = WF.h("div", { className: "wf-alert wf-alert--info", role: "status" }, "WebFluent can be used as a server-side template engine from Rust and Node.js to render .wf templates into HTML or PDF with JSON data.");
  _e1680.appendChild(_e1685);
  const _e1686 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1686);
  const _e1687 = WF.h("h2", { className: "wf-heading" }, "CLI Usage");
  ...
  const _e1699 = WF.h("td", {}, "template");
  _e1698.appendChild(_e1699);
  const _e1700 = WF.h("td", {}, "Path to the .wf template file");
  _e1698.appendChild(_e1700);
  _e1694.appendChild(_e1698);
  const _e1701 = WF.h("tr", {});
  const _e1702 = WF.h("td", {}, "--data");
  _e1701.appendChild(_e1702);
  const _e1703 = WF.h("td", {}, "Path to JSON data file (reads stdin if omitted)");
  _e1701.appendChild(_e1703);
  _e1694.appendChild(_e1701);
  const _e1704 = WF.h("tr", {});
  const _e1705 = WF.h("td", {}, "--format, -f");
  _e1704.appendChild(_e1705);
  const _e1706 = WF.h("td", {}, "Output format: html, fragment, or pdf");
  _e1704.appendChild(_e1706);
  _e1694.appendChild(_e1704);
  const _e1707 = WF.h("tr", {});
  const _e1708 = WF.h("td", {}, "--output, -o");
  _e1707.appendChild(_e1708);
  const _e1709 = WF.h("td", {}, "Output file path (stdout if omitted)");
  _e1707.appendChild(_e1709);
  _e1694.appendChild(_e1707);
  const _e1710 = WF.h("tr", {});
  const _e1711 = WF.h("td", {}, "--theme");
  _e1710.appendChild(_e1711);
  const _e1712 = WF.h("td", {}, "Which Theme declared in the template to use. Only needed when it declares more than one.");
  _e1710.appendChild(_e1712);
  _e1694.appendChild(_e1710);
  _e1680.appendChild(_e1694);
  const _e1713 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1713);
  const _e1714 = WF.h("hr", { className: "wf-divider" });
  _e1680.appendChild(_e1714);
  const _e1715 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1715);
  const _e1716 = WF.h("h2", { className: "wf-heading" }, "Template Syntax");
  ...
  _e1721.appendChild(_e1722);
  const _e1723 = WF.h("p", { className: "wf-text wf-text--bold" }, "invoice.wf");
  _e1721.appendChild(_e1723);
  _e1720.appendChild(_e1721);
  const _e1724 = WF.h("div", { className: "wf-card__body" });
  const _e1725 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Invoice (path: \"/\", title: \"Invoice\") {\n    Container {\n        Heading(\"Invoice #{number}\", h1)\n        Text(\"Customer: {customer.name}\")\n\n        Table {\n            Thead { Trow { Tcell(\"Item\") Tcell(\"Price\") } }\n            for item in items {\n                Trow {\n                    Tcell(item.name)\n                    Tcell(\"${item.price}\")\n                }\n            }\n        }\n\n        if paid {\n            Badge(\"PAID\", success)\n        } else {\n            Badge(\"UNPAID\", danger)\n        }\n    }\n}");
  _e1724.appendChild(_e1725);
  _e1720.appendChild(_e1724);
  _e1719.appendChild(_e1720);
  const _e1726 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1727 = WF.h("div", { className: "wf-card__header" });
  const _e1728 = WF.h("span", { className: "wf-badge wf-badge--info" }, "Data");
  _e1727.appendChild(_e1728);
  const _e1729 = WF.h("p", { className: "wf-text wf-text--bold" }, "data.json");
  _e1727.appendChild(_e1729);
  _e1726.appendChild(_e1727);
  const _e1730 = WF.h("div", { className: "wf-card__body" });
  const _e1731 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"number\": \"INV-001\",\n  \"customer\": { \"name\": \"Acme Corp\" },\n  \"items\": [\n    { \"name\": \"Widget\", \"price\": 9.99 },\n    { \"name\": \"Gadget\", \"price\": 24.99 }\n  ],\n  \"paid\": true\n}");
  _e1730.appendChild(_e1731);
  _e1726.appendChild(_e1730);
  _e1719.appendChild(_e1726);
  _e1680.appendChild(_e1719);
  const _e1732 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1732);
  const _e1733 = WF.h("hr", { className: "wf-divider" });
  _e1680.appendChild(_e1733);
  const _e1734 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1734);
  const _e1735 = WF.h("h2", { className: "wf-heading" }, "Rust API");
  ...
  const _e1740 = WF.h("p", { className: "wf-text wf-text--bold wf-text--muted" }, "Cargo.toml");
  _e1739.appendChild(_e1740);
  _e1738.appendChild(_e1739);
  const _e1741 = WF.h("div", { className: "wf-card__body" });
  const _e1742 = WF.h("code", { className: "wf-code wf-code--block" }, "[dependencies]\nwebfluent = \"0.2\"");
  ...
  const _e1746 = WF.h("p", { className: "wf-text wf-text--bold wf-text--muted" }, "main.rs");
  _e1745.appendChild(_e1746);
  _e1744.appendChild(_e1745);
  const _e1747 = WF.h("div", { className: "wf-card__body" });
  const _e1748 = WF.h("code", { className: "wf-code wf-code--block" }, "use webfluent::Template;\nuse serde_json::json;\n\nfn main() -> webfluent::Result<()> {\n    let tpl = Template::from_file(\"templates/invoice.wf\")?;\n\n    // HTML document (with embedded CSS)\n    let html = tpl.render_html(&json!({\n        \"number\": \"INV-001\",\n        \"customer\": { \"name\": \"Acme Corp\" },\n        \"items\": [{ \"name\": \"Widget\", \"price\": 9.99 }],\n        \"paid\": true\n    }))?;\n\n    // HTML fragment (no wrapper)\n    let fragment = tpl.render_html_fragment(&data)?;\n\n    // PDF bytes\n    let pdf_bytes = tpl.render_pdf(&data)?;\n    std::fs::write(\"invoice.pdf\", pdf_bytes)?;\n\n    // A template that declares `Theme Brand { ... }` uses it automatically.\n    // with_theme picks one when the template declares several; with_tokens\n    // layers machine-supplied values on top.\n    let branded = Template::from_file(\"invoice.wf\")?\n        .with_tokens(&[(\"color-primary\", \"#8B5CF6\")]);\n    let html = branded.render_html(&data)?;\n\n    // Or take the two halves apart, to serve the CSS from its own URL under a\n    // strict Content-Security-Policy.\n    let (css, body) = branded.render_html_parts(&data)?;\n\n    Ok(())\n}");
  _e1747.appendChild(_e1748);
  _e1744.appendChild(_e1747);
  _e1680.appendChild(_e1744);
  const _e1749 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1749);
  const _e1750 = WF.h("hr", { className: "wf-divider" });
  _e1680.appendChild(_e1750);
  const _e1751 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1751);
  const _e1752 = WF.h("h2", { className: "wf-heading" }, "Node.js API");
  ...
  const _e1757 = WF.h("p", { className: "wf-text wf-text--bold wf-text--muted" }, "Install");
  _e1756.appendChild(_e1757);
  _e1755.appendChild(_e1756);
  const _e1758 = WF.h("div", { className: "wf-card__body" });
  const _e1759 = WF.h("code", { className: "wf-code wf-code--block" }, "npm install @aspect/webfluent");
  ...
  const _e1769 = WF.h("p", { className: "wf-text wf-text--bold wf-text--muted" }, "Express.js Example");
  _e1768.appendChild(_e1769);
  _e1767.appendChild(_e1768);
  const _e1770 = WF.h("div", { className: "wf-card__body" });
  const _e1771 = WF.h("code", { className: "wf-code wf-code--block" }, "const express = require('express');\nconst { Template } = require('@aspect/webfluent');\n\nconst app = express();\n\napp.get('/invoice/:id', async (req, res) => {\n    const invoice = await db.getInvoice(req.params.id);\n    const tpl = Template.fromFile('templates/invoice.wf');\n    res.send(tpl.renderHtml(invoice));\n});\n\napp.get('/invoice/:id/pdf', async (req, res) => {\n    const invoice = await db.getInvoice(req.params.id);\n    const tpl = Template.fromFile('templates/invoice.wf');\n    res.type('application/pdf').send(tpl.renderPdf(invoice));\n});");
  _e1770.appendChild(_e1771);
  _e1767.appendChild(_e1770);
  _e1680.appendChild(_e1767);
  const _e1772 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1772);
  const _e1773 = WF.h("hr", { className: "wf-divider" });
  _e1680.appendChild(_e1773);
  const _e1774 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1774);
  const _e1775 = WF.h("h2", { className: "wf-heading" }, "Supported Features");
  ...
  _e1783.appendChild(_e1811);
  _e1782.appendChild(_e1783);
  _e1779.appendChild(_e1782);
  _e1778.appendChild(_e1779);
  const _e1814 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1815 = WF.h("div", { className: "wf-card__header" });
  const _e1816 = WF.h("h3", { className: "wf-heading" }, "Not Supported");
  ...
  _e1837.appendChild(_e1839);
  _e1818.appendChild(_e1837);
  _e1817.appendChild(_e1818);
  _e1814.appendChild(_e1817);
  _e1778.appendChild(_e1814);
  _e1680.appendChild(_e1778);
  const _e1840 = WF.h("div", { className: "wf-spacer" });
  _e1680.appendChild(_e1840);
  const _e1841 = WF.h("hr", { className: "wf-divider" });
  _e1680.appendChild(_e1841);
  const _e1842 = WF.h("div", { className: "wf-spacer" });
  ...
  _e1847.appendChild(_e1848);
  const _e1849 = WF.h("p", { className: "wf-text wf-text--muted" }, "Generate HTML pages on the server with data from your database or API.");
  _e1847.appendChild(_e1849);
  _e1846.appendChild(_e1847);
  _e1845.appendChild(_e1846);
  const _e1850 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1851 = WF.h("div", { className: "wf-card__body" });
  const _e1852 = WF.h("h3", { className: "wf-heading" }, "PDF Reports");
  _e1851.appendChild(_e1852);
  const _e1853 = WF.h("p", { className: "wf-text wf-text--muted" }, "Create invoices, receipts, and reports as PDF files from structured data.");
  _e1851.appendChild(_e1853);
  _e1850.appendChild(_e1851);
  _e1845.appendChild(_e1850);
  const _e1854 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1855 = WF.h("div", { className: "wf-card__body" });
  const _e1856 = WF.h("h3", { className: "wf-heading" }, "Email Templates");
  _e1855.appendChild(_e1856);
  const _e1857 = WF.h("p", { className: "wf-text wf-text--muted" }, "Render HTML emails with WebFluent components and your design system.");
  _e1855.appendChild(_e1857);
...
function Page_Accessibility(params) {
  const _root = document.createDocumentFragment();
  const _e1859 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1860 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1860);
  const _e1861 = WF.h("h1", { className: "wf-heading" }, "Accessibility Linting");
  _e1859.appendChild(_e1861);
  const _e1862 = WF.h("p", { className: "wf-text wf-text--muted" }, "WebFluent checks your code for accessibility issues at compile time. Warnings are printed during build but never block compilation.");
  _e1859.appendChild(_e1862);
  const _e1863 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1863);
  const _e1864 = WF.h("h2", { className: "wf-heading" }, "How It Works");
  ...
  const _e1869 = WF.h("code", { className: "wf-code wf-code--block" }, "$ wf build\nBuilding my-app...\n  Warning [A01]: Image missing \"alt\" attribute at src/pages/Home.wf:12:5\n    Add alt text: Image(src: \"...\", alt: \"Description of image\")\n  Warning [A03]: Input missing \"label\" attribute at src/pages/Form.wf:8:9\n    Add a label: Input(text, label: \"Username\")\n  3 pages, 2 components, 1 stores\n  Build complete with 2 accessibility warning(s).");
  _e1868.appendChild(_e1869);
  _e1867.appendChild(_e1868);
  _e1859.appendChild(_e1867);
  const _e1870 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1870);
  const _e1871 = WF.h("hr", { className: "wf-divider" });
  _e1859.appendChild(_e1871);
  const _e1872 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1872);
  const _e1873 = WF.h("h2", { className: "wf-heading" }, "Lint Rules");
  ...
  const _e1880 = WF.h("td", {}, "A01");
  _e1879.appendChild(_e1880);
  const _e1881 = WF.h("td", {}, "Image");
  _e1879.appendChild(_e1881);
  const _e1882 = WF.h("td", {}, "Must have alt attribute");
  _e1879.appendChild(_e1882);
  _e1874.appendChild(_e1879);
  const _e1883 = WF.h("tr", {});
  const _e1884 = WF.h("td", {}, "A02");
  _e1883.appendChild(_e1884);
  const _e1885 = WF.h("td", {}, "IconButton");
  _e1883.appendChild(_e1885);
  const _e1886 = WF.h("td", {}, "Must have label attribute (no visible text)");
  _e1883.appendChild(_e1886);
  _e1874.appendChild(_e1883);
  const _e1887 = WF.h("tr", {});
  const _e1888 = WF.h("td", {}, "A03");
  _e1887.appendChild(_e1888);
  const _e1889 = WF.h("td", {}, "Input");
  _e1887.appendChild(_e1889);
  const _e1890 = WF.h("td", {}, "Must have label or placeholder");
  _e1887.appendChild(_e1890);
  _e1874.appendChild(_e1887);
  const _e1891 = WF.h("tr", {});
  const _e1892 = WF.h("td", {}, "A04");
  _e1891.appendChild(_e1892);
  const _e1893 = WF.h("td", {}, "Checkbox, Radio, Switch, Slider");
  _e1891.appendChild(_e1893);
  const _e1894 = WF.h("td", {}, "Must have label attribute");
  _e1891.appendChild(_e1894);
  _e1874.appendChild(_e1891);
  const _e1895 = WF.h("tr", {});
  const _e1896 = WF.h("td", {}, "A05");
  _e1895.appendChild(_e1896);
  const _e1897 = WF.h("td", {}, "Button");
  _e1895.appendChild(_e1897);
  const _e1898 = WF.h("td", {}, "Must have text content");
  _e1895.appendChild(_e1898);
  _e1874.appendChild(_e1895);
  const _e1899 = WF.h("tr", {});
  const _e1900 = WF.h("td", {}, "A06");
  _e1899.appendChild(_e1900);
  const _e1901 = WF.h("td", {}, "Link");
  _e1899.appendChild(_e1901);
  const _e1902 = WF.h("td", {}, "Must have text content or children");
  _e1899.appendChild(_e1902);
  _e1874.appendChild(_e1899);
  const _e1903 = WF.h("tr", {});
  const _e1904 = WF.h("td", {}, "A07");
  _e1903.appendChild(_e1904);
  const _e1905 = WF.h("td", {}, "Heading");
  _e1903.appendChild(_e1905);
  const _e1906 = WF.h("td", {}, "Must not be empty");
  _e1903.appendChild(_e1906);
  _e1874.appendChild(_e1903);
  const _e1907 = WF.h("tr", {});
  const _e1908 = WF.h("td", {}, "A08");
  _e1907.appendChild(_e1908);
  const _e1909 = WF.h("td", {}, "Modal, Dialog");
  _e1907.appendChild(_e1909);
  const _e1910 = WF.h("td", {}, "Must have title attribute");
  _e1907.appendChild(_e1910);
  _e1874.appendChild(_e1907);
  const _e1911 = WF.h("tr", {});
  const _e1912 = WF.h("td", {}, "A09");
  _e1911.appendChild(_e1912);
  const _e1913 = WF.h("td", {}, "Video");
  _e1911.appendChild(_e1913);
  const _e1914 = WF.h("td", {}, "Must have controls attribute");
  _e1911.appendChild(_e1914);
  _e1874.appendChild(_e1911);
  const _e1915 = WF.h("tr", {});
  const _e1916 = WF.h("td", {}, "A10");
  _e1915.appendChild(_e1916);
  const _e1917 = WF.h("td", {}, "Table");
  _e1915.appendChild(_e1917);
  const _e1918 = WF.h("td", {}, "Must have Thead header row");
  _e1915.appendChild(_e1918);
  _e1874.appendChild(_e1915);
  const _e1919 = WF.h("tr", {});
  const _e1920 = WF.h("td", {}, "A11");
  _e1919.appendChild(_e1920);
  const _e1921 = WF.h("td", {}, "Heading");
  _e1919.appendChild(_e1921);
  const _e1922 = WF.h("td", {}, "Levels must not skip (h1 to h3)");
  _e1919.appendChild(_e1922);
  _e1874.appendChild(_e1919);
  const _e1923 = WF.h("tr", {});
  const _e1924 = WF.h("td", {}, "A12");
  _e1923.appendChild(_e1924);
  const _e1925 = WF.h("td", {}, "Page");
  _e1923.appendChild(_e1925);
  const _e1926 = WF.h("td", {}, "Must have exactly one h1 (not for Presentation or Document)");
  _e1923.appendChild(_e1926);
  _e1874.appendChild(_e1923);
  const _e1927 = WF.h("tr", {});
  const _e1928 = WF.h("td", {}, "A13");
  _e1927.appendChild(_e1928);
  const _e1929 = WF.h("td", {}, "Theme");
  _e1927.appendChild(_e1929);
  const _e1930 = WF.h("td", {}, "Colour pairings must clear the WCAG AA contrast ratio");
  _e1927.appendChild(_e1930);
  _e1874.appendChild(_e1927);
  const _e1931 = WF.h("tr", {});
  const _e1932 = WF.h("td", {}, "S01");
  _e1931.appendChild(_e1932);
  const _e1933 = WF.h("td", {}, "Page");
  _e1931.appendChild(_e1933);
  const _e1934 = WF.h("td", {}, "Must have a title");
  _e1931.appendChild(_e1934);
  _e1874.appendChild(_e1931);
  const _e1935 = WF.h("tr", {});
  const _e1936 = WF.h("td", {}, "S02");
  _e1935.appendChild(_e1936);
  const _e1937 = WF.h("td", {}, "Page");
  _e1935.appendChild(_e1937);
  const _e1938 = WF.h("td", {}, "Should have a description, or its search snippet gets written for it");
  _e1935.appendChild(_e1938);
  _e1874.appendChild(_e1935);
  const _e1939 = WF.h("tr", {});
  const _e1940 = WF.h("td", {}, "S03");
  _e1939.appendChild(_e1940);
  const _e1941 = WF.h("td", {}, "Page");
  _e1939.appendChild(_e1941);
  const _e1942 = WF.h("td", {}, "A description over ~160 characters is truncated in results");
  _e1939.appendChild(_e1942);
  _e1874.appendChild(_e1939);
  const _e1943 = WF.h("tr", {});
  const _e1944 = WF.h("td", {}, "S04");
  _e1943.appendChild(_e1944);
  const _e1945 = WF.h("td", {}, "Page");
  _e1943.appendChild(_e1945);
  const _e1946 = WF.h("td", {}, "Two pages must not claim one route");
  _e1943.appendChild(_e1946);
  _e1874.appendChild(_e1943);
  const _e1947 = WF.h("tr", {});
  const _e1948 = WF.h("td", {}, "V01");
  _e1947.appendChild(_e1948);
  const _e1949 = WF.h("td", {}, "Any");
  _e1947.appendChild(_e1949);
  const _e1950 = WF.h("td", {}, "A bare word that resolves to nothing");
  _e1947.appendChild(_e1950);
  _e1874.appendChild(_e1947);
  const _e1951 = WF.h("tr", {});
  const _e1952 = WF.h("td", {}, "V02");
  _e1951.appendChild(_e1952);
  const _e1953 = WF.h("td", {}, "Any");
  _e1951.appendChild(_e1953);
  const _e1954 = WF.h("td", {}, "A real modifier whose class no stylesheet defines");
  _e1951.appendChild(_e1954);
  _e1874.appendChild(_e1951);
  _e1859.appendChild(_e1874);
  const _e1955 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1955);
  const _e1956 = WF.h("hr", { className: "wf-divider" });
  _e1859.appendChild(_e1956);
  ...
  const _e1963 = WF.h("p", { className: "wf-text wf-text--danger wf-text--bold" }, "Bad (triggers warning)");
  _e1962.appendChild(_e1963);
  const _e1964 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\")\nIconButton(icon: \"close\")\nInput(text)\nCheckbox(bind: agreed)\nButton()");
  _e1962.appendChild(_e1964);
  _e1961.appendChild(_e1962);
  _e1960.appendChild(_e1961);
  _e1959.appendChild(_e1960);
  const _e1965 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1966 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1967 = WF.h("div", { className: "wf-card__body" });
  const _e1968 = WF.h("p", { className: "wf-text wf-text--success wf-text--bold" }, "Good (no warnings)");
  _e1967.appendChild(_e1968);
  const _e1969 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\", alt: \"Team photo\")\nIconButton(icon: \"close\", label: \"Close\")\nInput(text, label: \"Username\")\nCheckbox(bind: agreed, label: \"I agree\")\nButton(\"Save\")");
  _e1967.appendChild(_e1969);
  _e1966.appendChild(_e1967);
  ...
  const _e1972 = WF.h("hr", { className: "wf-divider" });
  _e1859.appendChild(_e1972);
  const _e1973 = WF.h("div", { className: "wf-spacer" });
  _e1859.appendChild(_e1973);
  const _e1974 = WF.h("h2", { className: "wf-heading" }, "What the engine does without being asked");
  ...
  const _e1981 = WF.h("h3", { className: "wf-heading" }, "Structure");
  _e1980.appendChild(_e1981);
  const _e1982 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Every page has a main landmark and a skip link ahead of the navigation. Heading modifiers produce real heading elements, so the document outline matches what is on screen.");
  _e1980.appendChild(_e1982);
  _e1979.appendChild(_e1980);
  _e1978.appendChild(_e1979);
  _e1977.appendChild(_e1978);
  const _e1983 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1984 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1985 = WF.h("div", { className: "wf-card__body" });
  const _e1986 = WF.h("h3", { className: "wf-heading" }, "Keyboard");
  _e1985.appendChild(_e1986);
  const _e1987 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Tabs, menus and dialogs handle the keys their pattern requires. Focus is always visible, never removed, and always returned when a panel closes.");
  _e1985.appendChild(_e1987);
  _e1984.appendChild(_e1985);
  _e1983.appendChild(_e1984);
  _e1977.appendChild(_e1983);
  const _e1988 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1989 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1990 = WF.h("div", { className: "wf-card__body" });
  const _e1991 = WF.h("h3", { className: "wf-heading" }, "Announcements");
  _e1990.appendChild(_e1991);
  const _e1992 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Alerts and toasts are live regions, so a screen reader hears them when they appear. Fetches say when they are loading and when they have finished.");
  _e1990.appendChild(_e1992);
  ...
  const _e1998 = WF.h("h3", { className: "wf-heading" }, "Motion and targets");
  _e1997.appendChild(_e1998);
  const _e1999 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Animations respect a reduced-motion preference. Every pointer target meets the 24 by 24 minimum, so a control is reachable with a thumb and not only a mouse.");
  _e1997.appendChild(_e1999);
  _e1996.appendChild(_e1997);
  _e1995.appendChild(_e1996);
  _e1994.appendChild(_e1995);
  const _e2000 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e2001 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e2002 = WF.h("div", { className: "wf-card__body" });
  const _e2003 = WF.h("h3", { className: "wf-heading" }, "Contrast, at compile time");
  _e2002.appendChild(_e2003);
  const _e2004 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Because a Theme is source the compiler reads, it can check colour pairings before you have written a page with them — something a tool working from CSS cannot do.");
  _e2002.appendChild(_e2004);
  _e2001.appendChild(_e2002);
  _e2000.appendChild(_e2001);
  _e1994.appendChild(_e2000);
  _e1859.appendChild(_e1994);
  _root.appendChild(_e1859);
  return _root;
}
...
function Page_Home(params) {
  ...
  const _e2010 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center wf-animate-fadeIn" }, () => WF.i18n.t("hero.sub2"));
  ...
  const _e2021 = WF.h("div", { className: "wf-spacer" });
  _e2005.appendChild(_e2021);
  const _e2022 = WF.h("h2", { className: "wf-heading wf-text--center" }, () => WF.i18n.t("demo.title"));
  _e2005.appendChild(_e2022);
  const _e2023 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("demo.subtitle"));
  ...
  _e2026.appendChild(_e2029);
  _e2025.appendChild(_e2026);
  const _e2036 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e2037 = WF.h("div", { className: "wf-card__header" });
  const _e2038 = WF.h("h2", { className: "wf-heading" }, () => WF.i18n.t("demo.binding"));
  ...
  WF.condRender(_e2039,
    () => (_taskInput() !== ""),
    () => {
      const _e2042 = document.createDocumentFragment();
      const _e2043 = WF.h("div", { className: "wf-alert wf-alert--info", role: "status" }, () => `You typed: ${_taskInput()}`);
  ...
  const _e2044 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.binding.hint"));
  _e2039.appendChild(_e2044);
  _e2036.appendChild(_e2039);
  _e2025.appendChild(_e2036);
  const _e2045 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e2046 = WF.h("div", { className: "wf-card__header" });
  const _e2047 = WF.h("h2", { className: "wf-heading" }, () => WF.i18n.t("demo.conditional"));
  _e2046.appendChild(_e2047);
  _e2045.appendChild(_e2046);
  const _e2048 = WF.h("div", { className: "wf-card__body" });
  const _e2049 = WF.h("label", { className: "wf-switch" });
  const _e2050 = WF.h("input", { type: "checkbox", role: "switch",                  checked: () => _showDemo(), "aria-checked": () => _showDemo() ? "true" : "false",                  "on:change": () => _showDemo.set(!_showDemo()) });
  _e2049.appendChild(_e2050);
  const _e2051 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  ...
  WF.condRender(_e2048,
    () => _showDemo(),
    () => {
      const _e2053 = document.createDocumentFragment();
      const _e2054 = WF.h("div", { className: "wf-card wf-card--outlined" });
      ...
      _e2054.appendChild(_e2055);
      _e2053.appendChild(_e2054);
      return _e2053;
    },
    null,
    { enter: "slideUp", exit: "fadeOut" }
  );
  _e2045.appendChild(_e2048);
  _e2025.appendChild(_e2045);
  const _e2059 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e2060 = WF.h("div", { className: "wf-card__header" });
  const _e2061 = WF.h("h2", { className: "wf-heading" }, () => WF.i18n.t("demo.components"));
  ...
  _e2068.appendChild(_e2070);
  const _e2071 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Active");
  _e2068.appendChild(_e2071);
  const _e2072 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e2068.appendChild(_e2072);
  _e2063.appendChild(_e2068);
  const _e2073 = WF.h("progress", { className: "wf-progress", value: 72, max: 100 });
  _e2063.appendChild(_e2073);
  const _e2074 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.components.hint"));
  _e2063.appendChild(_e2074);
  _e2062.appendChild(_e2063);
  ...
  const _e2077 = WF.h("div", { className: "wf-spacer" });
  _e2005.appendChild(_e2077);
  const _e2078 = WF.h("h2", { className: "wf-heading wf-text--center" }, () => WF.i18n.t("why.title"));
  _e2005.appendChild(_e2078);
  const _e2079 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("why.subtitle"));
  ...
  const _e2097 = WF.h("p", { className: "wf-text wf-text--muted" }, () => WF.i18n.t("cta.subtitle"));
  _e2095.appendChild(_e2097);
  _e2094.appendChild(_e2095);
  const _e2098 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { WF.navigate("/getting-started"); } }, () => WF.i18n.t("hero.cta"));
  _e2094.appendChild(_e2098);
...
function Page_GettingStarted(params) {
  const _root = document.createDocumentFragment();
  const _e2100 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e2101 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2101);
  const _e2102 = WF.h("h1", { className: "wf-heading" }, "Getting Started");
  _e2100.appendChild(_e2102);
  const _e2103 = WF.h("p", { className: "wf-text wf-text--muted" }, "Get up and running with WebFluent in under a minute.");
  _e2100.appendChild(_e2103);
  const _e2104 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2104);
  const _e2105 = WF.h("h2", { className: "wf-heading" }, "Install");
  ...
  const _e2110 = WF.h("code", { className: "wf-code wf-code--block" }, "git clone https://github.com/user/webfluent.git\ncd webfluent\ncargo build --release");
  ...
  const _e2113 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2113);
  const _e2114 = WF.h("hr", { className: "wf-divider" });
  _e2100.appendChild(_e2114);
  const _e2115 = WF.h("div", { className: "wf-spacer" });
  ...
  const _e2124 = WF.h("p", { className: "wf-text wf-text--muted" }, "Dashboard with routing, stores, forms, modals, animations.");
  _e2120.appendChild(_e2124);
  const _e2125 = WF.h("div", { className: "wf-spacer" });
  _e2120.appendChild(_e2125);
  const _e2126 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-app -t spa");
  _e2120.appendChild(_e2126);
  _e2119.appendChild(_e2120);
  _e2118.appendChild(_e2119);
  const _e2127 = WF.h("div", { className: "wf-card wf-card--elevated" });
  ...
  const _e2132 = WF.h("p", { className: "wf-text wf-text--muted" }, "Marketing site with SSG, i18n, blog, contact form.");
  _e2128.appendChild(_e2132);
  const _e2133 = WF.h("div", { className: "wf-spacer" });
  _e2128.appendChild(_e2133);
  const _e2134 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-site -t static");
  _e2128.appendChild(_e2134);
  _e2127.appendChild(_e2128);
  _e2118.appendChild(_e2127);
  const _e2135 = WF.h("div", { className: "wf-card wf-card--elevated" });
  ...
  const _e2140 = WF.h("p", { className: "wf-text wf-text--muted" }, "Reports, invoices, docs. Tables, code blocks, auto page breaks.");
  _e2136.appendChild(_e2140);
  const _e2141 = WF.h("div", { className: "wf-spacer" });
  _e2136.appendChild(_e2141);
  const _e2142 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-report -t pdf");
  _e2136.appendChild(_e2142);
  _e2135.appendChild(_e2136);
  _e2118.appendChild(_e2135);
  _e2100.appendChild(_e2118);
  const _e2143 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2143);
  const _e2144 = WF.h("hr", { className: "wf-divider" });
  _e2100.appendChild(_e2144);
  const _e2145 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2145);
  const _e2146 = WF.h("h2", { className: "wf-heading" }, "Build and Serve");
  _e2100.appendChild(_e2146);
  const _e2147 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e2148 = WF.h("div", { className: "wf-card__body" });
  const _e2149 = WF.h("code", { className: "wf-code wf-code--block" }, "cd my-app\nwf build\nwf serve");
  ...
  const _e2152 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2152);
  const _e2153 = WF.h("hr", { className: "wf-divider" });
  _e2100.appendChild(_e2153);
  const _e2154 = WF.h("div", { className: "wf-spacer" });
  _e2100.appendChild(_e2154);
  const _e2155 = WF.h("h2", { className: "wf-heading" }, "Project Structure");
  _e2100.appendChild(_e2155);
  const _e2156 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e2157 = WF.h("div", { className: "wf-card__body" });
  const _e2158 = WF.h("code", { className: "wf-code wf-code--block" }, "my-app/\n+-- webfluent.app.json       # Config\n+-- src/\n|   +-- App.wf               # Root (router, layout)\n|   +-- pages/\n|   +-- components/\n|   +-- stores/\n|   +-- translations/\n+-- public/\n+-- build/");
  _e2157.appendChild(_e2158);
  _e2156.appendChild(_e2157);
...
function Page_Animation(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e2164 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e2165 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2165);
  const _e2166 = WF.h("h1", { className: "wf-heading" }, "Animation System");
  _e2164.appendChild(_e2166);
  const _e2167 = WF.h("p", { className: "wf-text wf-text--muted" }, "Declarative animations built into the language. No CSS keyframes to write.");
  _e2164.appendChild(_e2167);
  const _e2168 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2168);
  const _e2169 = WF.h("h2", { className: "wf-heading" }, "Mount Animations");
  ...
  const _e2212 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn) { ... }\nHeading(\"Title\", h1, slideUp)\nButton(\"Click\", primary, bounce)");
  _e2211.appendChild(_e2212);
  _e2210.appendChild(_e2211);
  _e2164.appendChild(_e2210);
  const _e2213 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2213);
  const _e2214 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2214);
  const _e2215 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2215);
  const _e2216 = WF.h("h2", { className: "wf-heading" }, "Live: Conditional Animation");
  ...
  _e2219.appendChild(_e2220);
  const _e2221 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  ...
  WF.condRender(_e2164,
    () => _showCard(),
    () => {
      const _e2223 = document.createDocumentFragment();
      const _e2224 = WF.h("div", { className: "wf-card wf-card--elevated" });
      ...
      const _e2229 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Controlled by: if showCard, animate(scaleIn, fadeOut)");
      _e2225.appendChild(_e2229);
      _e2224.appendChild(_e2225);
      _e2223.appendChild(_e2224);
      return _e2223;
    },
    null,
  ...
  const _e2233 = WF.h("code", { className: "wf-code wf-code--block" }, "if showCard, animate(scaleIn, fadeOut) {\n    Card(elevated) {\n        Text(\"Animated content\")\n    }\n}");
  _e2232.appendChild(_e2233);
  _e2231.appendChild(_e2232);
  _e2164.appendChild(_e2231);
  const _e2234 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2234);
  const _e2235 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2235);
  const _e2236 = WF.h("div", { className: "wf-spacer" });
  ...
  const _e2243 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "150ms");
  _e2241.appendChild(_e2243);
  ...
  const _e2248 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "300ms");
  _e2246.appendChild(_e2248);
  ...
  const _e2253 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "500ms");
  _e2251.appendChild(_e2253);
  ...
  _e2164.appendChild(_e2255);
  const _e2256 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2256);
  const _e2257 = WF.h("div", { className: "wf-spacer" });
  ...
  const _e2266 = WF.h("td", {}, "fadeIn / fadeOut");
  _e2265.appendChild(_e2266);
  const _e2267 = WF.h("td", {}, "Opacity fade");
  _e2265.appendChild(_e2267);
  const _e2268 = WF.h("td", {}, "Card(elevated, fadeIn)");
  _e2265.appendChild(_e2268);
  _e2260.appendChild(_e2265);
  const _e2269 = WF.h("tr", {});
  const _e2270 = WF.h("td", {}, "slideUp / slideDown");
  _e2269.appendChild(_e2270);
  const _e2271 = WF.h("td", {}, "Vertical slide + fade");
  _e2269.appendChild(_e2271);
  const _e2272 = WF.h("td", {}, "Heading(\"Hi\", h1, slideUp)");
  _e2269.appendChild(_e2272);
  _e2260.appendChild(_e2269);
  const _e2273 = WF.h("tr", {});
  const _e2274 = WF.h("td", {}, "slideLeft / slideRight");
  _e2273.appendChild(_e2274);
  const _e2275 = WF.h("td", {}, "Horizontal slide + fade");
  _e2273.appendChild(_e2275);
  const _e2276 = WF.h("td", {}, "Text(\"Hello\", slideLeft)");
  _e2273.appendChild(_e2276);
  _e2260.appendChild(_e2273);
  const _e2277 = WF.h("tr", {});
  const _e2278 = WF.h("td", {}, "scaleIn / scaleOut");
  _e2277.appendChild(_e2278);
  const _e2279 = WF.h("td", {}, "Scale from/to 90%");
  _e2277.appendChild(_e2279);
  const _e2280 = WF.h("td", {}, "Badge(\"New\", scaleIn)");
  _e2277.appendChild(_e2280);
  _e2260.appendChild(_e2277);
  const _e2281 = WF.h("tr", {});
  const _e2282 = WF.h("td", {}, "bounce");
  _e2281.appendChild(_e2282);
  const _e2283 = WF.h("td", {}, "Bouncy entrance");
  _e2281.appendChild(_e2283);
  const _e2284 = WF.h("td", {}, "Button(\"Go\", bounce)");
  _e2281.appendChild(_e2284);
  _e2260.appendChild(_e2281);
  const _e2285 = WF.h("tr", {});
  const _e2286 = WF.h("td", {}, "shake");
  _e2285.appendChild(_e2286);
  const _e2287 = WF.h("td", {}, "Horizontal shake");
  _e2285.appendChild(_e2287);
  const _e2288 = WF.h("td", {}, "Alert(\"Error!\", shake)");
  _e2285.appendChild(_e2288);
  _e2260.appendChild(_e2285);
  const _e2289 = WF.h("tr", {});
  const _e2290 = WF.h("td", {}, "pulse");
  _e2289.appendChild(_e2290);
  const _e2291 = WF.h("td", {}, "Scale pulse (infinite)");
  _e2289.appendChild(_e2291);
  const _e2292 = WF.h("td", {}, "Badge(\"Live\", pulse)");
  _e2289.appendChild(_e2292);
  _e2260.appendChild(_e2289);
  const _e2293 = WF.h("tr", {});
  const _e2294 = WF.h("td", {}, "spin");
  _e2293.appendChild(_e2294);
  const _e2295 = WF.h("td", {}, "360-degree rotation");
  _e2293.appendChild(_e2295);
  const _e2296 = WF.h("td", {}, "Spinner(spin)");
  _e2293.appendChild(_e2296);
  _e2260.appendChild(_e2293);
  _e2164.appendChild(_e2260);
  const _e2297 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2297);
  const _e2298 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2298);
  const _e2299 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2299);
  const _e2300 = WF.h("h2", { className: "wf-heading" }, "Conditional Animations");
  ...
  const _e2305 = WF.h("code", { className: "wf-code wf-code--block" }, "if visible, animate(slideUp, fadeOut) {\n    Card { Text(\"Appears with slideUp, exits with fadeOut\") }\n}\n\nif expanded, animate(scaleIn, scaleOut) {\n    Text(\"Scales in and out\")\n}");
  _e2304.appendChild(_e2305);
  _e2303.appendChild(_e2304);
  _e2164.appendChild(_e2303);
  const _e2306 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2306);
  const _e2307 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2307);
  const _e2308 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2308);
  const _e2309 = WF.h("h2", { className: "wf-heading" }, "List Stagger");
  ...
  const _e2314 = WF.h("code", { className: "wf-code wf-code--block" }, "for item in items, animate(slideUp, fadeOut, stagger: \"50ms\") {\n    Card { Text(item.name) }\n}");
  _e2313.appendChild(_e2314);
  _e2312.appendChild(_e2313);
  _e2164.appendChild(_e2312);
  const _e2315 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2315);
  const _e2316 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2316);
  const _e2317 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2317);
  const _e2318 = WF.h("h2", { className: "wf-heading" }, "Transition Blocks");
  ...
  const _e2323 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Hover me\") {\n    transition {\n        background 200ms ease\n        transform 150ms spring\n    }\n}");
  ...
  const _e2326 = WF.h("hr", { className: "wf-divider" });
  _e2164.appendChild(_e2326);
  const _e2327 = WF.h("div", { className: "wf-spacer" });
  _e2164.appendChild(_e2327);
  const _e2328 = WF.h("h2", { className: "wf-heading" }, "Reduced motion");
  ...
  const _e2333 = WF.h("code", { className: "wf-code wf-code--block" }, "@media (prefers-reduced-motion: reduce) {\n  *, *::before, *::after {\n    animation-duration: 0.01ms !important;\n    animation-iteration-count: 1 !important;\n    transition-duration: 0.01ms !important;\n  }\n}");
...
(function() {
  ...
  _app.innerHTML = '';
  const _e2336 = Component_NavBar({});
  _app.appendChild(_e2336);
  const _e2337 = WF.h("div", { className: "wf-row" });
  _app.appendChild(_e2337);
  const _e2338 = Component_DocSidebar({});
  _e2337.appendChild(_e2338);
  const _routerEl = document.createElement('main');
  _routerEl.id = 'wf-main';
  _routerEl.style.flex = '1';
  _e2337.appendChild(_routerEl);
