...
function Page_Guide(params) {
  ...
  const _e862 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { WF.navigate("/components"); } }, "Components Reference");
  _e861.appendChild(_e862);
  const _e863 = WF.h("button", { className: "wf-btn", "on:click": (e) => { WF.navigate("/styling"); } }, "Styling Guide");
...
function Page_Animation(params) {
  ...
  const _e867 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Animation System");
  _e865.appendChild(_e867);
  const _e868 = WF.h("p", { className: "wf-text wf-text--muted" }, "Declarative animations built into the language. No CSS keyframes to write.");
  _e865.appendChild(_e868);
  const _e869 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e869);
  const _e870 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Mount Animations");
  _e865.appendChild(_e870);
  const _e871 = WF.h("p", { className: "wf-text" }, "Add an animation modifier to any component. It plays when the element appears. Hover each card to replay.");
  _e865.appendChild(_e871);
  const _e872 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e872);
  const _e873 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e874 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn"); } });
  const _e875 = WF.h("div", { className: "wf-card__body" });
  const _e876 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "fadeIn");
  _e875.appendChild(_e876);
  const _e877 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Fades from transparent");
  _e875.appendChild(_e877);
  _e874.appendChild(_e875);
  _e873.appendChild(_e874);
  const _e878 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideUp", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideUp"); } });
  const _e879 = WF.h("div", { className: "wf-card__body" });
  const _e880 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slideUp");
  _e879.appendChild(_e880);
  const _e881 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Slides from below");
  _e879.appendChild(_e881);
  _e878.appendChild(_e879);
  _e873.appendChild(_e878);
  const _e882 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-scaleIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "scaleIn"); } });
  const _e883 = WF.h("div", { className: "wf-card__body" });
  const _e884 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "scaleIn");
  _e883.appendChild(_e884);
  const _e885 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Scales from 90%");
  _e883.appendChild(_e885);
  _e882.appendChild(_e883);
  _e873.appendChild(_e882);
  const _e886 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideDown", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideDown"); } });
  const _e887 = WF.h("div", { className: "wf-card__body" });
  const _e888 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slideDown");
  _e887.appendChild(_e888);
  const _e889 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Slides from above");
  _e887.appendChild(_e889);
  _e886.appendChild(_e887);
  _e873.appendChild(_e886);
  const _e890 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideLeft", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideLeft"); } });
  const _e891 = WF.h("div", { className: "wf-card__body" });
  const _e892 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slideLeft");
  _e891.appendChild(_e892);
  const _e893 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Slides from right");
  _e891.appendChild(_e893);
  _e890.appendChild(_e891);
  _e873.appendChild(_e890);
  const _e894 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-bounce", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "bounce"); } });
  const _e895 = WF.h("div", { className: "wf-card__body" });
  const _e896 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "bounce");
  _e895.appendChild(_e896);
  const _e897 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Bouncy entrance");
  _e895.appendChild(_e897);
  _e894.appendChild(_e895);
  _e873.appendChild(_e894);
  const _e898 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-shake", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "shake"); } });
  const _e899 = WF.h("div", { className: "wf-card__body" });
  const _e900 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "shake");
  _e899.appendChild(_e900);
  const _e901 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Horizontal shake");
  _e899.appendChild(_e901);
  _e898.appendChild(_e899);
  _e873.appendChild(_e898);
  const _e902 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-pulse", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "pulse"); } });
  const _e903 = WF.h("div", { className: "wf-card__body" });
  const _e904 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "pulse");
  _e903.appendChild(_e904);
  const _e905 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Gentle scale pulse");
  _e903.appendChild(_e905);
  _e902.appendChild(_e903);
  _e873.appendChild(_e902);
  const _e906 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-slideRight", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "slideRight"); } });
  const _e907 = WF.h("div", { className: "wf-card__body" });
  const _e908 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slideRight");
  _e907.appendChild(_e908);
  const _e909 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted wf-text--small" }, "Slides from left");
  _e907.appendChild(_e909);
  _e906.appendChild(_e907);
  _e873.appendChild(_e906);
  _e865.appendChild(_e873);
  const _e910 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e910);
  const _e911 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e912 = WF.h("div", { className: "wf-card__body" });
  const _e913 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn) { ... }\nHeading(\"Title\", h1, slideUp)\nButton(\"Click\", primary, bounce)");
  _e912.appendChild(_e913);
  _e911.appendChild(_e912);
  _e865.appendChild(_e911);
  ...
  const _e917 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Live: Conditional Animation");
  _e865.appendChild(_e917);
  const _e918 = WF.h("p", { className: "wf-text" }, "Toggle the switch to see enter/exit animations on the card below.");
  _e865.appendChild(_e918);
  const _e919 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e919);
  const _e920 = WF.h("label", { className: "wf-switch" });
  const _e921 = WF.h("input", { type: "checkbox", checked: () => _showCard(), "on:change": () => _showCard.set(!_showCard()) });
  _e920.appendChild(_e921);
  const _e922 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e920.appendChild(_e922);
  _e920.appendChild(WF.text("Show animated card"));
  ...
  WF.condRender(_e865,
    () => _showCard(),
    () => {
      const _e924 = document.createDocumentFragment();
      const _e925 = WF.h("div", { className: "wf-card wf-card--elevated" });
      const _e926 = WF.h("div", { className: "wf-card__body" });
      const _e927 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Animated!");
      _e926.appendChild(_e927);
      const _e928 = WF.h("div", { className: "wf-spacer" });
      _e926.appendChild(_e928);
      const _e929 = WF.h("p", { className: "wf-text" }, "This card scales in and fades out.");
      _e926.appendChild(_e929);
      const _e930 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "Controlled by: if showCard, animate(scaleIn, fadeOut)");
  ...
  const _e932 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e933 = WF.h("div", { className: "wf-card__body" });
  const _e934 = WF.h("code", { className: "wf-code wf-code--block" }, "if showCard, animate(scaleIn, fadeOut) {\n    Card(elevated) {\n        Text(\"Animated content\")\n    }\n}");
  _e933.appendChild(_e934);
  _e932.appendChild(_e933);
  _e865.appendChild(_e932);
  const _e935 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e935);
  const _e936 = WF.h("hr", { className: "wf-divider" });
  _e865.appendChild(_e936);
  const _e937 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e937);
  const _e938 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Speed Variants");
  _e865.appendChild(_e938);
  const _e939 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e939);
  const _e940 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e941 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn", "150ms"); } });
  const _e942 = WF.h("div", { className: "wf-card__body" });
  const _e943 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "fast");
  _e942.appendChild(_e943);
  const _e944 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "150ms");
  _e942.appendChild(_e944);
  const _e945 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn, fast)");
  _e942.appendChild(_e945);
  _e941.appendChild(_e942);
  _e940.appendChild(_e941);
  const _e946 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn"); } });
  const _e947 = WF.h("div", { className: "wf-card__body" });
  const _e948 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "default");
  _e947.appendChild(_e948);
  const _e949 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "300ms");
  _e947.appendChild(_e949);
  const _e950 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn)");
  _e947.appendChild(_e950);
  _e946.appendChild(_e947);
  _e940.appendChild(_e946);
  const _e951 = WF.h("div", { className: "wf-card wf-card--outlined wf-animate-fadeIn", "on:mouseenter": (event) => { WF.replayAnimation(event.currentTarget, "fadeIn", "500ms"); } });
  const _e952 = WF.h("div", { className: "wf-card__body" });
  const _e953 = WF.h("p", { className: "wf-text wf-text--center wf-text--bold" }, "slow");
  _e952.appendChild(_e953);
  const _e954 = WF.h("p", { className: "wf-text wf-text--center wf-text--muted" }, "500ms");
  _e952.appendChild(_e954);
  const _e955 = WF.h("code", { className: "wf-code wf-code--block" }, "Card(elevated, fadeIn, slow)");
  _e952.appendChild(_e955);
  _e951.appendChild(_e952);
  _e940.appendChild(_e951);
  _e865.appendChild(_e940);
  const _e956 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e956);
  const _e957 = WF.h("hr", { className: "wf-divider" });
  _e865.appendChild(_e957);
  const _e958 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e958);
  const _e959 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "All 12 Animations");
  _e865.appendChild(_e959);
  const _e960 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e960);
  const _e961 = WF.h("table", { className: "wf-table" });
  const _e962 = WF.h("thead", {});
  const _e963 = WF.h("td", {}, "Name");
  _e962.appendChild(_e963);
  const _e964 = WF.h("td", {}, "Effect");
  _e962.appendChild(_e964);
  const _e965 = WF.h("td", {}, "Usage");
  _e962.appendChild(_e965);
  _e961.appendChild(_e962);
  const _e966 = WF.h("tr", {});
  const _e967 = WF.h("td", {}, "fadeIn / fadeOut");
  _e966.appendChild(_e967);
  const _e968 = WF.h("td", {}, "Opacity fade");
  _e966.appendChild(_e968);
  const _e969 = WF.h("td", {}, "Card(elevated, fadeIn)");
  _e966.appendChild(_e969);
  _e961.appendChild(_e966);
  const _e970 = WF.h("tr", {});
  const _e971 = WF.h("td", {}, "slideUp / slideDown");
  _e970.appendChild(_e971);
  const _e972 = WF.h("td", {}, "Vertical slide + fade");
  _e970.appendChild(_e972);
  const _e973 = WF.h("td", {}, "Heading(\"Hi\", h1, slideUp)");
  _e970.appendChild(_e973);
  _e961.appendChild(_e970);
  const _e974 = WF.h("tr", {});
  const _e975 = WF.h("td", {}, "slideLeft / slideRight");
  _e974.appendChild(_e975);
  const _e976 = WF.h("td", {}, "Horizontal slide + fade");
  _e974.appendChild(_e976);
  const _e977 = WF.h("td", {}, "Text(\"Hello\", slideLeft)");
  _e974.appendChild(_e977);
  _e961.appendChild(_e974);
  const _e978 = WF.h("tr", {});
  const _e979 = WF.h("td", {}, "scaleIn / scaleOut");
  _e978.appendChild(_e979);
  const _e980 = WF.h("td", {}, "Scale from/to 90%");
  _e978.appendChild(_e980);
  const _e981 = WF.h("td", {}, "Badge(\"New\", scaleIn)");
  _e978.appendChild(_e981);
  _e961.appendChild(_e978);
  const _e982 = WF.h("tr", {});
  const _e983 = WF.h("td", {}, "bounce");
  _e982.appendChild(_e983);
  const _e984 = WF.h("td", {}, "Bouncy entrance");
  _e982.appendChild(_e984);
  const _e985 = WF.h("td", {}, "Button(\"Go\", bounce)");
  _e982.appendChild(_e985);
  _e961.appendChild(_e982);
  const _e986 = WF.h("tr", {});
  const _e987 = WF.h("td", {}, "shake");
  _e986.appendChild(_e987);
  const _e988 = WF.h("td", {}, "Horizontal shake");
  _e986.appendChild(_e988);
  const _e989 = WF.h("td", {}, "Alert(\"Error!\", shake)");
  _e986.appendChild(_e989);
  _e961.appendChild(_e986);
  const _e990 = WF.h("tr", {});
  const _e991 = WF.h("td", {}, "pulse");
  _e990.appendChild(_e991);
  const _e992 = WF.h("td", {}, "Scale pulse (infinite)");
  _e990.appendChild(_e992);
  const _e993 = WF.h("td", {}, "Badge(\"Live\", pulse)");
  _e990.appendChild(_e993);
  _e961.appendChild(_e990);
  const _e994 = WF.h("tr", {});
  const _e995 = WF.h("td", {}, "spin");
  _e994.appendChild(_e995);
  const _e996 = WF.h("td", {}, "360-degree rotation");
  _e994.appendChild(_e996);
  const _e997 = WF.h("td", {}, "Spinner(spin)");
  _e994.appendChild(_e997);
  _e961.appendChild(_e994);
  _e865.appendChild(_e961);
  const _e998 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e998);
  const _e999 = WF.h("hr", { className: "wf-divider" });
  _e865.appendChild(_e999);
  const _e1000 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1000);
  const _e1001 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Conditional Animations");
  _e865.appendChild(_e1001);
  const _e1002 = WF.h("p", { className: "wf-text" }, "Attach enter and exit animations to if blocks.");
  _e865.appendChild(_e1002);
  const _e1003 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1003);
  const _e1004 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1005 = WF.h("div", { className: "wf-card__body" });
  const _e1006 = WF.h("code", { className: "wf-code wf-code--block" }, "if visible, animate(slideUp, fadeOut) {\n    Card { Text(\"Appears with slideUp, exits with fadeOut\") }\n}\n\nif expanded, animate(scaleIn, scaleOut) {\n    Text(\"Scales in and out\")\n}");
  _e1005.appendChild(_e1006);
  _e1004.appendChild(_e1005);
  _e865.appendChild(_e1004);
  const _e1007 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1007);
  const _e1008 = WF.h("hr", { className: "wf-divider" });
  _e865.appendChild(_e1008);
  const _e1009 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1009);
  const _e1010 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "List Stagger");
  _e865.appendChild(_e1010);
  const _e1011 = WF.h("p", { className: "wf-text" }, "Animate list items with staggered delays.");
  _e865.appendChild(_e1011);
  const _e1012 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1012);
  const _e1013 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1014 = WF.h("div", { className: "wf-card__body" });
  const _e1015 = WF.h("code", { className: "wf-code wf-code--block" }, "for item in items, animate(slideUp, fadeOut, stagger: \"50ms\") {\n    Card { Text(item.name) }\n}");
  _e1014.appendChild(_e1015);
  _e1013.appendChild(_e1014);
  _e865.appendChild(_e1013);
  const _e1016 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1016);
  const _e1017 = WF.h("hr", { className: "wf-divider" });
  _e865.appendChild(_e1017);
  const _e1018 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1018);
  const _e1019 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Transition Blocks");
  _e865.appendChild(_e1019);
  const _e1020 = WF.h("p", { className: "wf-text" }, "Smooth CSS transitions on property changes.");
  _e865.appendChild(_e1020);
  const _e1021 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1021);
  const _e1022 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1023 = WF.h("div", { className: "wf-card__body" });
  const _e1024 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Hover me\") {\n    transition {\n        background 200ms ease\n        transform 150ms spring\n    }\n}");
  _e1023.appendChild(_e1024);
  _e1022.appendChild(_e1023);
  _e865.appendChild(_e1022);
  const _e1025 = WF.h("div", { className: "wf-spacer" });
  _e865.appendChild(_e1025);
...
function Page_I18n(params) {
  const _root = document.createDocumentFragment();
  const _e1026 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1027 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1027);
  const _e1028 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Internationalization (i18n)");
  _e1026.appendChild(_e1028);
  const _e1029 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built-in multi-language support with reactive locale switching and automatic RTL.");
  _e1026.appendChild(_e1029);
  const _e1030 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1030);
  const _e1031 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Setup");
  _e1026.appendChild(_e1031);
  const _e1032 = WF.h("p", { className: "wf-text" }, "Create a JSON file per locale in your translations directory.");
  _e1026.appendChild(_e1032);
  const _e1033 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1033);
  const _e1034 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1035 = WF.h("div", { className: "wf-card__body" });
  const _e1036 = WF.h("code", { className: "wf-code wf-code--block" }, "// src/translations/en.json\n{\n    \"greeting\": \"Hello, {name}!\",\n    \"nav.home\": \"Home\",\n    \"nav.about\": \"About\"\n}\n\n// src/translations/ar.json\n{\n    \"greeting\": \"!أهلاً، {name}\",\n    \"nav.home\": \"الرئيسية\",\n    \"nav.about\": \"حول\"\n}");
  _e1035.appendChild(_e1036);
  _e1034.appendChild(_e1035);
  _e1026.appendChild(_e1034);
  const _e1037 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1037);
  const _e1038 = WF.h("p", { className: "wf-text wf-text--bold" }, "Add i18n config to webfluent.app.json:");
  _e1026.appendChild(_e1038);
  const _e1039 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1040 = WF.h("div", { className: "wf-card__body" });
  const _e1041 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"i18n\": {\n    \"defaultLocale\": \"en\",\n    \"locales\": [\"en\", \"ar\"],\n    \"dir\": \"src/translations\"\n  }\n}");
  _e1040.appendChild(_e1041);
  _e1039.appendChild(_e1040);
  _e1026.appendChild(_e1039);
  const _e1042 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1042);
  const _e1043 = WF.h("hr", { className: "wf-divider" });
  _e1026.appendChild(_e1043);
  const _e1044 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1044);
  const _e1045 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "The t() Function");
  _e1026.appendChild(_e1045);
  const _e1046 = WF.h("p", { className: "wf-text" }, "Use t() to look up translated text. It is reactive — all t() calls update when the locale changes.");
  _e1026.appendChild(_e1046);
  const _e1047 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1047);
  const _e1048 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1049 = WF.h("div", { className: "wf-card__body" });
  const _e1050 = WF.h("code", { className: "wf-code wf-code--block" }, "// Simple key lookup\nText(t(\"nav.home\"))\n\n// With interpolation\nText(t(\"greeting\", name: user.name))\n\n// In any component\nButton(t(\"actions.save\"), primary)\nHeading(t(\"page.title\"), h1)");
  _e1049.appendChild(_e1050);
  _e1048.appendChild(_e1049);
  _e1026.appendChild(_e1048);
  const _e1051 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1051);
  const _e1052 = WF.h("hr", { className: "wf-divider" });
  _e1026.appendChild(_e1052);
  const _e1053 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1053);
  const _e1054 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Locale Switching");
  _e1026.appendChild(_e1054);
  const _e1055 = WF.h("p", { className: "wf-text" }, "Switch the locale at runtime with setLocale(). All translated text updates instantly.");
  _e1026.appendChild(_e1055);
  const _e1056 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1056);
  const _e1057 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1058 = WF.h("div", { className: "wf-card__body" });
  const _e1059 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"English\") { setLocale(\"en\") }\nButton(\"العربية\") { setLocale(\"ar\") }\nButton(\"Espanol\") { setLocale(\"es\") }\n\n// Access current locale\nText(\"Current: {locale}\")\nText(\"Direction: {dir}\")");
  _e1058.appendChild(_e1059);
  _e1057.appendChild(_e1058);
  _e1026.appendChild(_e1057);
  const _e1060 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1060);
  const _e1061 = WF.h("hr", { className: "wf-divider" });
  _e1026.appendChild(_e1061);
  const _e1062 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1062);
  const _e1063 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "RTL Support");
  _e1026.appendChild(_e1063);
  const _e1064 = WF.h("p", { className: "wf-text" }, "WebFluent automatically detects RTL locales and updates the document direction.");
  _e1026.appendChild(_e1064);
  const _e1065 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1065);
  const _e1066 = WF.h("table", { className: "wf-table" });
  const _e1067 = WF.h("thead", {});
  const _e1068 = WF.h("td", {}, "Locale");
  _e1067.appendChild(_e1068);
  const _e1069 = WF.h("td", {}, "Direction");
  _e1067.appendChild(_e1069);
  _e1066.appendChild(_e1067);
  const _e1070 = WF.h("tr", {});
  const _e1071 = WF.h("td", {}, "ar (Arabic)");
  _e1070.appendChild(_e1071);
  const _e1072 = WF.h("td", {}, "RTL");
  _e1070.appendChild(_e1072);
  _e1066.appendChild(_e1070);
  const _e1073 = WF.h("tr", {});
  const _e1074 = WF.h("td", {}, "he (Hebrew)");
  _e1073.appendChild(_e1074);
  const _e1075 = WF.h("td", {}, "RTL");
  _e1073.appendChild(_e1075);
  _e1066.appendChild(_e1073);
  const _e1076 = WF.h("tr", {});
  const _e1077 = WF.h("td", {}, "fa (Farsi)");
  _e1076.appendChild(_e1077);
  const _e1078 = WF.h("td", {}, "RTL");
  _e1076.appendChild(_e1078);
  _e1066.appendChild(_e1076);
  const _e1079 = WF.h("tr", {});
  const _e1080 = WF.h("td", {}, "ur (Urdu)");
  _e1079.appendChild(_e1080);
  const _e1081 = WF.h("td", {}, "RTL");
  _e1079.appendChild(_e1081);
  _e1066.appendChild(_e1079);
  const _e1082 = WF.h("tr", {});
  const _e1083 = WF.h("td", {}, "All others");
  _e1082.appendChild(_e1083);
  const _e1084 = WF.h("td", {}, "LTR");
  _e1082.appendChild(_e1084);
  _e1066.appendChild(_e1082);
  _e1026.appendChild(_e1066);
  const _e1085 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1085);
  const _e1086 = WF.h("p", { className: "wf-text wf-text--muted" }, "When setLocale(\"ar\") is called, the HTML element gets dir=\"rtl\" and lang=\"ar\" automatically.");
  _e1026.appendChild(_e1086);
  const _e1087 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1087);
  const _e1088 = WF.h("hr", { className: "wf-divider" });
  _e1026.appendChild(_e1088);
  const _e1089 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1089);
  const _e1090 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Fallback Behavior");
  _e1026.appendChild(_e1090);
  const _e1091 = WF.h("p", { className: "wf-text" }, "If a key is missing in the current locale:");
  _e1026.appendChild(_e1091);
  const _e1092 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1093 = WF.h("p", { className: "wf-text" }, "1. Falls back to the defaultLocale translation");
  _e1092.appendChild(_e1093);
  const _e1094 = WF.h("p", { className: "wf-text" }, "2. If still missing, returns the key itself (e.g., \"nav.home\")");
  _e1092.appendChild(_e1094);
  _e1026.appendChild(_e1092);
  const _e1095 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1095);
  const _e1096 = WF.h("hr", { className: "wf-divider" });
  _e1026.appendChild(_e1096);
  const _e1097 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1097);
  const _e1098 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "SSG + i18n");
  _e1026.appendChild(_e1098);
  const _e1099 = WF.h("p", { className: "wf-text wf-text--muted" }, "When both SSG and i18n are enabled, pages are pre-rendered with the default locale text. After JavaScript loads, locale switching works normally.");
  _e1026.appendChild(_e1099);
  const _e1100 = WF.h("div", { className: "wf-spacer" });
  _e1026.appendChild(_e1100);
  _root.appendChild(_e1026);
  return _root;
}

function Page_GettingStarted(params) {
  const _root = document.createDocumentFragment();
  const _e1101 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1102 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1102);
  const _e1103 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Getting Started");
  _e1101.appendChild(_e1103);
  const _e1104 = WF.h("p", { className: "wf-text wf-text--muted" }, "Get up and running with WebFluent in under a minute.");
  _e1101.appendChild(_e1104);
  const _e1105 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1105);
  const _e1106 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Install");
  _e1101.appendChild(_e1106);
  const _e1107 = WF.h("p", { className: "wf-text" }, "Build from source (requires Rust):");
  _e1101.appendChild(_e1107);
  const _e1108 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1108);
  const _e1109 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1110 = WF.h("div", { className: "wf-card__body" });
  const _e1111 = WF.h("code", { className: "wf-code wf-code--block" }, "git clone https://github.com/user/webfluent.git\ncd webfluent\ncargo build --release");
  _e1110.appendChild(_e1111);
  _e1109.appendChild(_e1110);
  _e1101.appendChild(_e1109);
  const _e1112 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1112);
  const _e1113 = WF.h("p", { className: "wf-text wf-text--muted" }, "The binary is at target/release/wf. Add it to your PATH.");
  _e1101.appendChild(_e1113);
  const _e1114 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1114);
  const _e1115 = WF.h("hr", { className: "wf-divider" });
  _e1101.appendChild(_e1115);
  const _e1116 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1116);
  const _e1117 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Create a Project");
  _e1101.appendChild(_e1117);
  const _e1118 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1118);
  const _e1119 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e1120 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1121 = WF.h("div", { className: "wf-card__body" });
  const _e1122 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "SPA");
  _e1121.appendChild(_e1122);
  const _e1123 = WF.h("div", { className: "wf-spacer" });
  _e1121.appendChild(_e1123);
  const _e1124 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Interactive App");
  _e1121.appendChild(_e1124);
  const _e1125 = WF.h("p", { className: "wf-text wf-text--muted" }, "Dashboard with routing, stores, forms, modals, animations.");
  _e1121.appendChild(_e1125);
  const _e1126 = WF.h("div", { className: "wf-spacer" });
  _e1121.appendChild(_e1126);
  const _e1127 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-app -t spa");
  ...
  const _e1130 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Static");
  _e1129.appendChild(_e1130);
  const _e1131 = WF.h("div", { className: "wf-spacer" });
  _e1129.appendChild(_e1131);
  const _e1132 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Static Site");
  _e1129.appendChild(_e1132);
  const _e1133 = WF.h("p", { className: "wf-text wf-text--muted" }, "Marketing site with SSG, i18n, blog, contact form.");
  _e1129.appendChild(_e1133);
  const _e1134 = WF.h("div", { className: "wf-spacer" });
  _e1129.appendChild(_e1134);
  const _e1135 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-site -t static");
  _e1129.appendChild(_e1135);
  _e1128.appendChild(_e1129);
  _e1119.appendChild(_e1128);
  const _e1136 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1137 = WF.h("div", { className: "wf-card__body" });
  const _e1138 = WF.h("span", { className: "wf-badge wf-badge--info" }, "PDF");
  _e1137.appendChild(_e1138);
  const _e1139 = WF.h("div", { className: "wf-spacer" });
  _e1137.appendChild(_e1139);
  const _e1140 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "PDF Document");
  _e1137.appendChild(_e1140);
  const _e1141 = WF.h("p", { className: "wf-text wf-text--muted" }, "Reports, invoices, docs. Tables, code blocks, auto page breaks.");
  _e1137.appendChild(_e1141);
  const _e1142 = WF.h("div", { className: "wf-spacer" });
  _e1137.appendChild(_e1142);
  const _e1143 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init my-report -t pdf");
  _e1137.appendChild(_e1143);
  _e1136.appendChild(_e1137);
  _e1119.appendChild(_e1136);
  _e1101.appendChild(_e1119);
  const _e1144 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1144);
  const _e1145 = WF.h("hr", { className: "wf-divider" });
  _e1101.appendChild(_e1145);
  const _e1146 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1146);
  const _e1147 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Build and Serve");
  _e1101.appendChild(_e1147);
  const _e1148 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1149 = WF.h("div", { className: "wf-card__body" });
  const _e1150 = WF.h("code", { className: "wf-code wf-code--block" }, "cd my-app\nwf build\nwf serve");
  _e1149.appendChild(_e1150);
  _e1148.appendChild(_e1149);
  _e1101.appendChild(_e1148);
  const _e1151 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1151);
  const _e1152 = WF.h("p", { className: "wf-text wf-text--muted" }, "Open http://localhost:3000 in your browser.");
  _e1101.appendChild(_e1152);
  const _e1153 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1153);
  const _e1154 = WF.h("hr", { className: "wf-divider" });
  _e1101.appendChild(_e1154);
  const _e1155 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1155);
  const _e1156 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Project Structure");
  _e1101.appendChild(_e1156);
  const _e1157 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1158 = WF.h("div", { className: "wf-card__body" });
  const _e1159 = WF.h("code", { className: "wf-code wf-code--block" }, "my-app/\n+-- webfluent.app.json       # Config\n+-- src/\n|   +-- App.wf               # Root (router, layout)\n|   +-- pages/\n|   +-- components/\n|   +-- stores/\n|   +-- translations/\n+-- public/\n+-- build/");
  _e1158.appendChild(_e1159);
  _e1157.appendChild(_e1158);
  _e1101.appendChild(_e1157);
  const _e1160 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1160);
  const _e1161 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1162 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { WF.navigate("/guide"); } }, "Read the Guide");
  _e1161.appendChild(_e1162);
  const _e1163 = WF.h("button", { className: "wf-btn", "on:click": (e) => { WF.navigate("/components"); } }, "Browse Components");
  _e1161.appendChild(_e1163);
  _e1101.appendChild(_e1161);
  const _e1164 = WF.h("div", { className: "wf-spacer" });
  _e1101.appendChild(_e1164);
  _root.appendChild(_e1101);
  return _root;
}

function Page_Cli(params) {
  const _root = document.createDocumentFragment();
  const _e1165 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1166 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1166);
  const _e1167 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "CLI Reference");
  _e1165.appendChild(_e1167);
  const _e1168 = WF.h("p", { className: "wf-text wf-text--muted" }, "The WebFluent command-line interface.");
  _e1165.appendChild(_e1168);
  const _e1169 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1169);
  const _e1170 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf init");
  _e1165.appendChild(_e1170);
  const _e1171 = WF.h("p", { className: "wf-text" }, "Create a new WebFluent project.");
  _e1165.appendChild(_e1171);
  const _e1172 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1172);
  const _e1173 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1174 = WF.h("div", { className: "wf-card__body" });
  const _e1175 = WF.h("code", { className: "wf-code wf-code--block" }, "wf init <name> [--template spa|static|pdf]");
  _e1174.appendChild(_e1175);
  _e1173.appendChild(_e1174);
  _e1165.appendChild(_e1173);
  const _e1176 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1176);
  const _e1177 = WF.h("table", { className: "wf-table" });
  const _e1178 = WF.h("thead", {});
  const _e1179 = WF.h("td", {}, "Argument");
  _e1178.appendChild(_e1179);
  const _e1180 = WF.h("td", {}, "Description");
  _e1178.appendChild(_e1180);
  _e1177.appendChild(_e1178);
  const _e1181 = WF.h("tr", {});
  const _e1182 = WF.h("td", {}, "name");
  _e1181.appendChild(_e1182);
  const _e1183 = WF.h("td", {}, "Project name (creates a directory)");
  _e1181.appendChild(_e1183);
  _e1177.appendChild(_e1181);
  const _e1184 = WF.h("tr", {});
  const _e1185 = WF.h("td", {}, "--template, -t");
  _e1184.appendChild(_e1185);
  const _e1186 = WF.h("td", {}, "Template: spa (default), static, or pdf");
  _e1184.appendChild(_e1186);
  _e1177.appendChild(_e1184);
  _e1165.appendChild(_e1177);
  const _e1187 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1187);
  const _e1188 = WF.h("p", { className: "wf-text wf-text--muted" }, "SPA: interactive app with routing and state. Static: SSG site with i18n. PDF: document generation with tables, headings, and auto page breaks.");
  _e1165.appendChild(_e1188);
  const _e1189 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1189);
  const _e1190 = WF.h("hr", { className: "wf-divider" });
  _e1165.appendChild(_e1190);
  const _e1191 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1191);
  const _e1192 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf build");
  _e1165.appendChild(_e1192);
  const _e1193 = WF.h("p", { className: "wf-text" }, "Compile .wf files to HTML, CSS, and JavaScript.");
  _e1165.appendChild(_e1193);
  const _e1194 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1194);
  const _e1195 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1196 = WF.h("div", { className: "wf-card__body" });
  const _e1197 = WF.h("code", { className: "wf-code wf-code--block" }, "wf build [--dir DIR]");
  _e1196.appendChild(_e1197);
  _e1195.appendChild(_e1196);
  _e1165.appendChild(_e1195);
  const _e1198 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1198);
  const _e1199 = WF.h("table", { className: "wf-table" });
  const _e1200 = WF.h("thead", {});
  const _e1201 = WF.h("td", {}, "Option");
  _e1200.appendChild(_e1201);
  const _e1202 = WF.h("td", {}, "Description");
  _e1200.appendChild(_e1202);
  _e1199.appendChild(_e1200);
  const _e1203 = WF.h("tr", {});
  const _e1204 = WF.h("td", {}, "--dir, -d");
  _e1203.appendChild(_e1204);
  const _e1205 = WF.h("td", {}, "Project directory (default: current directory)");
  _e1203.appendChild(_e1205);
  _e1199.appendChild(_e1203);
  _e1165.appendChild(_e1199);
  const _e1206 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1206);
  const _e1207 = WF.h("p", { className: "wf-text wf-text--muted" }, "The build pipeline: Lex all .wf files, parse to AST, run accessibility linter, generate HTML + CSS + JS, write to output directory.");
  _e1165.appendChild(_e1207);
  const _e1208 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1208);
  const _e1209 = WF.h("p", { className: "wf-text" }, "Output depends on config:");
  _e1165.appendChild(_e1209);
  const _e1210 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1211 = WF.h("p", { className: "wf-text" }, "SPA mode (default): single index.html + app.js + styles.css");
  _e1210.appendChild(_e1211);
  const _e1212 = WF.h("p", { className: "wf-text" }, "SSG mode (ssg: true): one HTML per page + app.js + styles.css");
  _e1210.appendChild(_e1212);
  const _e1213 = WF.h("p", { className: "wf-text" }, "PDF mode (output_type: pdf): a single .pdf file");
  _e1210.appendChild(_e1213);
  _e1165.appendChild(_e1210);
  const _e1214 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1214);
  const _e1215 = WF.h("hr", { className: "wf-divider" });
  _e1165.appendChild(_e1215);
  const _e1216 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1216);
  const _e1217 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf serve");
  _e1165.appendChild(_e1217);
  const _e1218 = WF.h("p", { className: "wf-text" }, "Start a development server that serves the built output.");
  _e1165.appendChild(_e1218);
  const _e1219 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1219);
  const _e1220 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1221 = WF.h("div", { className: "wf-card__body" });
  const _e1222 = WF.h("code", { className: "wf-code wf-code--block" }, "wf serve [--dir DIR]");
  _e1221.appendChild(_e1222);
  _e1220.appendChild(_e1221);
  _e1165.appendChild(_e1220);
  const _e1223 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1223);
  const _e1224 = WF.h("p", { className: "wf-text wf-text--muted" }, "Serves files from the build directory. SPA fallback: all routes serve index.html so client-side routing works. Port is configured in webfluent.app.json (default: 3000).");
  _e1165.appendChild(_e1224);
  const _e1225 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1225);
  const _e1226 = WF.h("hr", { className: "wf-divider" });
  _e1165.appendChild(_e1226);
  const _e1227 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1227);
  const _e1228 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "wf generate");
  _e1165.appendChild(_e1228);
  const _e1229 = WF.h("p", { className: "wf-text" }, "Scaffold a new page, component, or store.");
  _e1165.appendChild(_e1229);
  const _e1230 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1230);
  const _e1231 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1232 = WF.h("div", { className: "wf-card__body" });
  const _e1233 = WF.h("code", { className: "wf-code wf-code--block" }, "wf generate <kind> <name> [--dir DIR]");
  _e1232.appendChild(_e1233);
  _e1231.appendChild(_e1232);
  _e1165.appendChild(_e1231);
  const _e1234 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1234);
  const _e1235 = WF.h("table", { className: "wf-table" });
  const _e1236 = WF.h("thead", {});
  const _e1237 = WF.h("td", {}, "Kind");
  _e1236.appendChild(_e1237);
  const _e1238 = WF.h("td", {}, "Creates");
  _e1236.appendChild(_e1238);
  const _e1239 = WF.h("td", {}, "Example");
  _e1236.appendChild(_e1239);
  _e1235.appendChild(_e1236);
  const _e1240 = WF.h("tr", {});
  const _e1241 = WF.h("td", {}, "page");
  _e1240.appendChild(_e1241);
  const _e1242 = WF.h("td", {}, "src/pages/Name.wf");
  _e1240.appendChild(_e1242);
  const _e1243 = WF.h("td", {}, "wf generate page About");
  _e1240.appendChild(_e1243);
  _e1235.appendChild(_e1240);
  const _e1244 = WF.h("tr", {});
  const _e1245 = WF.h("td", {}, "component");
  _e1244.appendChild(_e1245);
  const _e1246 = WF.h("td", {}, "src/components/Name.wf");
  _e1244.appendChild(_e1246);
  const _e1247 = WF.h("td", {}, "wf generate component Header");
  _e1244.appendChild(_e1247);
  _e1235.appendChild(_e1244);
  const _e1248 = WF.h("tr", {});
  const _e1249 = WF.h("td", {}, "store");
  _e1248.appendChild(_e1249);
  const _e1250 = WF.h("td", {}, "src/stores/name.wf");
  _e1248.appendChild(_e1250);
  const _e1251 = WF.h("td", {}, "wf generate store CartStore");
  _e1248.appendChild(_e1251);
  _e1235.appendChild(_e1248);
  _e1165.appendChild(_e1235);
  const _e1252 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1252);
  const _e1253 = WF.h("hr", { className: "wf-divider" });
  _e1165.appendChild(_e1253);
  const _e1254 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1254);
  const _e1255 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Configuration");
  _e1165.appendChild(_e1255);
  const _e1256 = WF.h("p", { className: "wf-text" }, "All config is in webfluent.app.json at the project root.");
  _e1165.appendChild(_e1256);
  const _e1257 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1257);
  const _e1258 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1259 = WF.h("div", { className: "wf-card__body" });
  const _e1260 = WF.h("code", { className: "wf-code wf-code--block" }, "{\n  \"name\": \"My App\",\n  \"version\": \"1.0.0\",\n  \"author\": \"Your Name\",\n  \"theme\": {\n    \"name\": \"default\",\n    \"mode\": \"light\",\n    \"tokens\": { \"color-primary\": \"#6366F1\" }\n  },\n  \"build\": {\n    \"output\": \"./build\",\n    \"minify\": true,\n    \"ssg\": false,\n    \"output_type\": \"spa\",\n    \"pdf\": {\n      \"page_size\": \"A4\",\n      \"default_font\": \"Helvetica\",\n      \"output_filename\": \"report.pdf\"\n    }\n  },\n  \"dev\": { \"port\": 3000 },\n  \"meta\": {\n    \"title\": \"My App\",\n    \"description\": \"Built with WebFluent\",\n    \"lang\": \"en\"\n  },\n  \"i18n\": {\n    \"defaultLocale\": \"en\",\n    \"locales\": [\"en\", \"ar\"],\n    \"dir\": \"src/translations\"\n  }\n}");
  _e1259.appendChild(_e1260);
  _e1258.appendChild(_e1259);
  _e1165.appendChild(_e1258);
  const _e1261 = WF.h("div", { className: "wf-spacer" });
  _e1165.appendChild(_e1261);
  _root.appendChild(_e1165);
  return _root;
}
...
function Page_Home(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e1262 = WF.h("div", { className: "wf-container" });
  const _e1263 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1263);
  const _e1264 = WF.h("h2", { className: "wf-heading wf-heading--h1 wf-text--center wf-animate-slideUp" }, () => WF.i18n.t("hero.title"));
  _e1262.appendChild(_e1264);
  const _e1265 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1265);
  const _e1266 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center wf-animate-fadeIn" }, () => WF.i18n.t("hero.sub1"));
  _e1262.appendChild(_e1266);
  const _e1267 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center wf-animate-fadeIn" }, () => WF.i18n.t("hero.sub2"));
  _e1262.appendChild(_e1267);
  const _e1268 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1268);
  const _e1269 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1270 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { WF.navigate("/getting-started"); } }, () => WF.i18n.t("hero.cta"));
  _e1269.appendChild(_e1270);
  const _e1271 = WF.h("button", { className: "wf-btn wf-btn--large", "on:click": (e) => { WF.navigate("/guide"); } }, () => WF.i18n.t("hero.guide"));
  _e1269.appendChild(_e1271);
  _e1262.appendChild(_e1269);
  const _e1272 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1272);
  const _e1273 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1274 = WF.h("div", { className: "wf-card__body" });
  const _e1275 = WF.h("code", { className: "wf-code wf-code--block" }, "Page Home (path: \"/\") {\n    Container {\n        Heading(\"Hello, WebFluent!\", h1)\n        Text(\"Build for the web. Nothing else.\")\n\n        Button(\"Get Started\", primary, large) {\n            navigate(\"/docs\")\n        }\n    }\n}");
  _e1274.appendChild(_e1275);
  _e1273.appendChild(_e1274);
  _e1262.appendChild(_e1273);
  const _e1276 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1276);
  const _e1277 = WF.h("hr", { className: "wf-divider" });
  _e1262.appendChild(_e1277);
  const _e1278 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1278);
  const _e1279 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-text--center" }, () => WF.i18n.t("demo.title"));
  _e1262.appendChild(_e1279);
  const _e1280 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("demo.subtitle"));
  _e1262.appendChild(_e1280);
  const _e1281 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1281);
  const _e1282 = WF.h("div", { className: "wf-grid wf-grid--gap-lg", style: { gridTemplateColumns: 'repeat(2, 1fr)' } });
  const _e1283 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1284 = WF.h("div", { className: "wf-card__header" });
  const _e1285 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.counter"));
  _e1284.appendChild(_e1285);
  _e1283.appendChild(_e1284);
  const _e1286 = WF.h("div", { className: "wf-card__body" });
  const _e1287 = WF.h("div", { className: "wf-row wf-row--center wf-row--gap-md" });
  const _e1288 = WF.h("button", { className: "wf-btn wf-btn--large", "on:click": (e) => { _counter.set((_counter() - 1)); } }, "-");
  _e1287.appendChild(_e1288);
  const _e1289 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-heading--primary" }, () => `${_counter()}`);
  _e1287.appendChild(_e1289);
  const _e1290 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { _counter.set((_counter() + 1)); } }, "+");
  _e1287.appendChild(_e1290);
  _e1286.appendChild(_e1287);
  const _e1291 = WF.h("div", { className: "wf-spacer" });
  _e1286.appendChild(_e1291);
  const _e1292 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.counter.hint"));
  _e1286.appendChild(_e1292);
  _e1283.appendChild(_e1286);
  _e1282.appendChild(_e1283);
  const _e1293 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1294 = WF.h("div", { className: "wf-card__header" });
  const _e1295 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.binding"));
  _e1294.appendChild(_e1295);
  _e1293.appendChild(_e1294);
  const _e1296 = WF.h("div", { className: "wf-card__body" });
  const _e1297 = WF.h("input", { className: "wf-input", value: () => _taskInput(), "on:input": (e) => _taskInput.set(e.target.value), placeholder: WF.i18n.t("demo.binding.placeholder"), label: "Input", type: "text" });
  _e1296.appendChild(_e1297);
  const _e1298 = WF.h("div", { className: "wf-spacer" });
  _e1296.appendChild(_e1298);
  WF.condRender(_e1296,
    () => (_taskInput() !== ""),
    () => {
      const _e1299 = document.createDocumentFragment();
      const _e1300 = WF.h("div", { className: "wf-alert wf-alert--info" }, () => `You typed: ${_taskInput()}`);
  ...
  const _e1301 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.binding.hint"));
  _e1296.appendChild(_e1301);
  _e1293.appendChild(_e1296);
  _e1282.appendChild(_e1293);
  const _e1302 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1303 = WF.h("div", { className: "wf-card__header" });
  const _e1304 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.conditional"));
  _e1303.appendChild(_e1304);
  _e1302.appendChild(_e1303);
  const _e1305 = WF.h("div", { className: "wf-card__body" });
  const _e1306 = WF.h("label", { className: "wf-switch" });
  const _e1307 = WF.h("input", { type: "checkbox", checked: () => _showDemo(), "on:change": () => _showDemo.set(!_showDemo()) });
  _e1306.appendChild(_e1307);
  const _e1308 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1306.appendChild(_e1308);
  _e1306.appendChild(WF.text(WF.i18n.t("demo.conditional.toggle")));
  _e1305.appendChild(_e1306);
  const _e1309 = WF.h("div", { className: "wf-spacer" });
  _e1305.appendChild(_e1309);
  WF.condRender(_e1305,
    () => _showDemo(),
    () => {
      const _e1310 = document.createDocumentFragment();
      const _e1311 = WF.h("div", { className: "wf-card wf-card--outlined" });
      const _e1312 = WF.h("div", { className: "wf-card__body" });
      const _e1313 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Visible!");
      _e1312.appendChild(_e1313);
      const _e1314 = WF.h("div", { className: "wf-spacer" });
      _e1312.appendChild(_e1314);
      const _e1315 = WF.h("p", { className: "wf-text" }, () => WF.i18n.t("demo.conditional.text"));
      _e1312.appendChild(_e1315);
  ...
  _e1302.appendChild(_e1305);
  _e1282.appendChild(_e1302);
  const _e1316 = WF.h("div", { className: "wf-card wf-card--elevated wf-animate-fadeIn" });
  const _e1317 = WF.h("div", { className: "wf-card__header" });
  const _e1318 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("demo.components"));
  _e1317.appendChild(_e1318);
  _e1316.appendChild(_e1317);
  const _e1319 = WF.h("div", { className: "wf-card__body" });
  const _e1320 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1321 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1322 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Primary");
  _e1321.appendChild(_e1322);
  const _e1323 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e1321.appendChild(_e1323);
  const _e1324 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e1321.appendChild(_e1324);
  _e1320.appendChild(_e1321);
  const _e1325 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1326 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "New");
  _e1325.appendChild(_e1326);
  const _e1327 = WF.h("span", { className: "wf-badge wf-badge--danger" }, "Sale");
  _e1325.appendChild(_e1327);
  const _e1328 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Active");
  _e1325.appendChild(_e1328);
  const _e1329 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e1325.appendChild(_e1329);
  _e1320.appendChild(_e1325);
  const _e1330 = WF.h("progress", { className: "wf-progress", value: 72, max: 100 });
  _e1320.appendChild(_e1330);
  const _e1331 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => WF.i18n.t("demo.components.hint"));
  _e1320.appendChild(_e1331);
  _e1319.appendChild(_e1320);
  _e1316.appendChild(_e1319);
  _e1282.appendChild(_e1316);
  _e1262.appendChild(_e1282);
  const _e1332 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1332);
  const _e1333 = WF.h("hr", { className: "wf-divider" });
  _e1262.appendChild(_e1333);
  const _e1334 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1334);
  const _e1335 = WF.h("h2", { className: "wf-heading wf-heading--h2 wf-text--center" }, () => WF.i18n.t("why.title"));
  _e1262.appendChild(_e1335);
  const _e1336 = WF.h("p", { className: "wf-text wf-text--muted wf-text--center" }, () => WF.i18n.t("why.subtitle"));
  _e1262.appendChild(_e1336);
  const _e1337 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1337);
  const _e1338 = WF.h("div", { className: "wf-grid wf-grid--gap-md", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e1339 = Component_FeatureCard({ title: WF.i18n.t("why.syntax"), description: WF.i18n.t("why.syntax.desc") });
  _e1338.appendChild(_e1339);
  const _e1340 = Component_FeatureCard({ title: WF.i18n.t("why.components"), description: WF.i18n.t("why.components.desc") });
  _e1338.appendChild(_e1340);
  const _e1341 = Component_FeatureCard({ title: WF.i18n.t("why.reactivity"), description: WF.i18n.t("why.reactivity.desc") });
  _e1338.appendChild(_e1341);
  const _e1342 = Component_FeatureCard({ title: WF.i18n.t("why.design"), description: WF.i18n.t("why.design.desc") });
  _e1338.appendChild(_e1342);
  const _e1343 = Component_FeatureCard({ title: WF.i18n.t("why.animation"), description: WF.i18n.t("why.animation.desc") });
  _e1338.appendChild(_e1343);
  const _e1344 = Component_FeatureCard({ title: WF.i18n.t("why.i18n"), description: WF.i18n.t("why.i18n.desc") });
  _e1338.appendChild(_e1344);
  const _e1345 = Component_FeatureCard({ title: WF.i18n.t("why.ssg"), description: WF.i18n.t("why.ssg.desc") });
  _e1338.appendChild(_e1345);
  const _e1346 = Component_FeatureCard({ title: WF.i18n.t("why.a11y"), description: WF.i18n.t("why.a11y.desc") });
  _e1338.appendChild(_e1346);
  const _e1347 = Component_FeatureCard({ title: WF.i18n.t("why.zero"), description: WF.i18n.t("why.zero.desc") });
  _e1338.appendChild(_e1347);
  _e1262.appendChild(_e1338);
  const _e1348 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1348);
  const _e1349 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1350 = WF.h("div", { className: "wf-card__body" });
  const _e1351 = WF.h("div", { className: "wf-row wf-row--center wf-row--between" });
  const _e1352 = WF.h("div", { className: "wf-stack" });
  const _e1353 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, () => WF.i18n.t("cta.title"));
  _e1352.appendChild(_e1353);
  const _e1354 = WF.h("p", { className: "wf-text wf-text--muted" }, () => WF.i18n.t("cta.subtitle"));
  _e1352.appendChild(_e1354);
  _e1351.appendChild(_e1352);
  const _e1355 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large", "on:click": (e) => { WF.navigate("/getting-started"); } }, () => WF.i18n.t("hero.cta"));
  _e1351.appendChild(_e1355);
  _e1350.appendChild(_e1351);
  _e1349.appendChild(_e1350);
  _e1262.appendChild(_e1349);
  const _e1356 = WF.h("div", { className: "wf-spacer" });
  _e1262.appendChild(_e1356);
  _root.appendChild(_e1262);
  return _root;
}
...
function Page_Components(params) {
  ...
  const _root = document.createDocumentFragment();
  const _e1357 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1358 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1358);
  const _e1359 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Components Reference");
  _e1357.appendChild(_e1359);
  const _e1360 = WF.h("p", { className: "wf-text wf-text--muted" }, "50+ built-in components. Below are live interactive examples you can play with.");
  _e1357.appendChild(_e1360);
  const _e1361 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1361);
  const _e1362 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Buttons");
  _e1357.appendChild(_e1362);
  const _e1363 = WF.h("p", { className: "wf-text" }, "Buttons support size, color, and shape modifiers.");
  _e1357.appendChild(_e1363);
  const _e1364 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1364);
  ...
  const _e1368 = WF.h("button", { className: "wf-btn" }, "Default");
  _e1367.appendChild(_e1368);
  const _e1369 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Primary");
  _e1367.appendChild(_e1369);
  const _e1370 = WF.h("button", { className: "wf-btn wf-btn--success" }, "Success");
  _e1367.appendChild(_e1370);
  const _e1371 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Danger");
  _e1367.appendChild(_e1371);
  const _e1372 = WF.h("button", { className: "wf-btn wf-btn--warning" }, "Warning");
  _e1367.appendChild(_e1372);
  const _e1373 = WF.h("button", { className: "wf-btn wf-btn--info" }, "Info");
  _e1367.appendChild(_e1373);
  _e1366.appendChild(_e1367);
  const _e1374 = WF.h("div", { className: "wf-spacer" });
  _e1366.appendChild(_e1374);
  const _e1375 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1376 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--small" }, "Small");
  _e1375.appendChild(_e1376);
  const _e1377 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Medium");
  _e1375.appendChild(_e1377);
  const _e1378 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--large" }, "Large");
  _e1375.appendChild(_e1378);
  const _e1379 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--rounded" }, "Rounded");
  _e1375.appendChild(_e1379);
  const _e1380 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--full" }, "Full Width");
  _e1375.appendChild(_e1380);
  _e1366.appendChild(_e1375);
  _e1365.appendChild(_e1366);
  _e1357.appendChild(_e1365);
  const _e1381 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1381);
  const _e1382 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1383 = WF.h("div", { className: "wf-card__body" });
  const _e1384 = WF.h("code", { className: "wf-code wf-code--block" }, "Button(\"Primary\", primary)\nButton(\"Large\", primary, large)\nButton(\"Rounded\", success, rounded)\nButton(\"Full Width\", danger, full)");
  _e1383.appendChild(_e1384);
  _e1382.appendChild(_e1383);
  _e1357.appendChild(_e1382);
  const _e1385 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1385);
  const _e1386 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1386);
  const _e1387 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1387);
  const _e1388 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Cards");
  _e1357.appendChild(_e1388);
  const _e1389 = WF.h("p", { className: "wf-text" }, "Cards are surfaces for grouping content. They support Header, Body, and Footer sub-components.");
  _e1357.appendChild(_e1389);
  const _e1390 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1390);
  const _e1391 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1392 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1393 = WF.h("div", { className: "wf-card" });
  const _e1394 = WF.h("div", { className: "wf-card__header" });
  const _e1395 = WF.h("p", { className: "wf-text wf-text--bold" }, "Default Card");
  _e1394.appendChild(_e1395);
  _e1393.appendChild(_e1394);
  const _e1396 = WF.h("div", { className: "wf-card__body" });
  const _e1397 = WF.h("p", { className: "wf-text wf-text--muted" }, "Basic card with header and body.");
  _e1396.appendChild(_e1397);
  _e1393.appendChild(_e1396);
  const _e1398 = WF.h("div", { className: "wf-card__footer" });
  const _e1399 = WF.h("button", { className: "wf-btn wf-btn--primary wf-btn--small" }, "Action");
  console.log("clicked");
  _e1398.appendChild(_e1399);
  _e1393.appendChild(_e1398);
  _e1392.appendChild(_e1393);
  _e1391.appendChild(_e1392);
  const _e1400 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1401 = WF.h("div", { className: "wf-card wf-card--elevated" });
  const _e1402 = WF.h("div", { className: "wf-card__header" });
  const _e1403 = WF.h("p", { className: "wf-text wf-text--bold" }, "Elevated");
  _e1402.appendChild(_e1403);
  _e1401.appendChild(_e1402);
  const _e1404 = WF.h("div", { className: "wf-card__body" });
  const _e1405 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with shadow elevation.");
  _e1404.appendChild(_e1405);
  _e1401.appendChild(_e1404);
  _e1400.appendChild(_e1401);
  _e1391.appendChild(_e1400);
  const _e1406 = WF.h("div", { className: "wf-col wf-col--4" });
  const _e1407 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1408 = WF.h("div", { className: "wf-card__header" });
  const _e1409 = WF.h("p", { className: "wf-text wf-text--bold" }, "Outlined");
  _e1408.appendChild(_e1409);
  _e1407.appendChild(_e1408);
  const _e1410 = WF.h("div", { className: "wf-card__body" });
  const _e1411 = WF.h("p", { className: "wf-text wf-text--muted" }, "Card with border only.");
  _e1410.appendChild(_e1411);
  _e1407.appendChild(_e1410);
  _e1406.appendChild(_e1407);
  _e1391.appendChild(_e1406);
  _e1357.appendChild(_e1391);
  const _e1412 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1412);
  const _e1413 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1413);
  const _e1414 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1414);
  const _e1415 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Form Controls");
  _e1357.appendChild(_e1415);
  const _e1416 = WF.h("p", { className: "wf-text" }, "All form inputs support two-way binding with the bind: attribute.");
  _e1357.appendChild(_e1416);
  const _e1417 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1417);
  const _e1418 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1419 = WF.h("div", { className: "wf-card__body" });
  const _e1420 = WF.h("div", { className: "wf-stack wf-stack--gap-md" });
  const _e1421 = WF.h("input", { className: "wf-input", value: () => _inputVal(), "on:input": (e) => _inputVal.set(e.target.value), label: "Text Input", placeholder: "Type here...", type: "text" });
  _e1420.appendChild(_e1421);
  WF.condRender(_e1420,
    () => (_inputVal() !== ""),
    () => {
      const _e1422 = document.createDocumentFragment();
      const _e1423 = WF.h("p", { className: "wf-text wf-text--primary wf-text--bold" }, () => `You typed: ${_inputVal()}`);
  ...
  const _e1424 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1424);
  const _e1425 = WF.h("select", { className: "wf-select", value: () => _selectVal(), "on:input": (e) => _selectVal.set(e.target.value), label: "Select" });
  const _e1426 = WF.h("option", {}, "opt1");
  _e1425.appendChild(_e1426);
  const _e1427 = WF.h("option", {}, "opt2");
  _e1425.appendChild(_e1427);
  const _e1428 = WF.h("option", {}, "opt3");
  _e1425.appendChild(_e1428);
  _e1420.appendChild(_e1425);
  const _e1429 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_selectVal()}`);
  _e1420.appendChild(_e1429);
  const _e1430 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1430);
  const _e1431 = WF.h("label", { className: "wf-checkbox" });
  const _e1432 = WF.h("input", { type: "checkbox", checked: () => _checkVal(), "on:change": () => _checkVal.set(!_checkVal()) });
  _e1431.appendChild(_e1432);
  _e1431.appendChild(WF.text("I agree to the terms"));
  _e1420.appendChild(_e1431);
  const _e1433 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Checked: ${_checkVal()}`);
  _e1420.appendChild(_e1433);
  const _e1434 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1434);
  const _e1435 = WF.h("div", { className: "wf-row wf-row--gap-lg" });
  const _e1436 = WF.h("label", { className: "wf-radio" });
  const _e1437 = WF.h("input", { type: "radio", checked: () => _radioVal() === "a", "on:change": () => _radioVal.set("a") });
  _e1436.appendChild(_e1437);
  _e1436.appendChild(WF.text("Option A"));
  _e1435.appendChild(_e1436);
  const _e1438 = WF.h("label", { className: "wf-radio" });
  const _e1439 = WF.h("input", { type: "radio", checked: () => _radioVal() === "b", "on:change": () => _radioVal.set("b") });
  _e1438.appendChild(_e1439);
  _e1438.appendChild(WF.text("Option B"));
  _e1435.appendChild(_e1438);
  const _e1440 = WF.h("label", { className: "wf-radio" });
  const _e1441 = WF.h("input", { type: "radio", checked: () => _radioVal() === "c", "on:change": () => _radioVal.set("c") });
  _e1440.appendChild(_e1441);
  _e1440.appendChild(WF.text("Option C"));
  _e1435.appendChild(_e1440);
  _e1420.appendChild(_e1435);
  const _e1442 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_radioVal()}`);
  _e1420.appendChild(_e1442);
  const _e1443 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1443);
  const _e1444 = WF.h("label", { className: "wf-switch" });
  const _e1445 = WF.h("input", { type: "checkbox", checked: () => _switchVal(), "on:change": () => _switchVal.set(!_switchVal()) });
  _e1444.appendChild(_e1445);
  const _e1446 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1444.appendChild(_e1446);
  _e1444.appendChild(WF.text("Dark Mode"));
  _e1420.appendChild(_e1444);
  const _e1447 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Enabled: ${_switchVal()}`);
  _e1420.appendChild(_e1447);
  const _e1448 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1448);
  const _e1449 = WF.h("div", { className: "wf-slider" });
  const _e1450 = WF.h("label", { className: "wf-form-label" }, "Volume");
  _e1449.appendChild(_e1450);
  const _e1451 = WF.h("input", { type: "range", min: 0, max: 100, step: 1, value: () => _sliderVal(), "on:input": (e) => _sliderVal.set(Number(e.target.value)) });
  _e1449.appendChild(_e1451);
  const _e1452 = WF.h("span", { className: "wf-slider__value" }, () => String(_sliderVal()));
  _e1449.appendChild(_e1452);
  _e1420.appendChild(_e1449);
  const _e1453 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Value: ${_sliderVal()}`);
  _e1420.appendChild(_e1453);
  const _e1454 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1454);
  const _e1456 = WF.h("div", { className: "wf-form-group" });
  const _e1457 = WF.h("label", { className: "wf-form-label" }, "Pick a Date");
  _e1456.appendChild(_e1457);
  const _e1458 = WF.h("input", { type: "date", className: "wf-input", value: () => _dateVal(), "on:change": (e) => _dateVal.set(e.target.value) });
  _e1456.appendChild(_e1458);
  const _e1455 = _e1456;
  _e1420.appendChild(_e1455);
  const _e1459 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, () => `Selected: ${_dateVal()}`);
  _e1420.appendChild(_e1459);
  const _e1460 = WF.h("hr", { className: "wf-divider" });
  _e1420.appendChild(_e1460);
  const _e1462 = WF.h("div", { className: "wf-file-upload" });
  const _e1463 = WF.h("label", { className: "wf-form-label" }, "Upload Image");
  _e1462.appendChild(_e1463);
  const _e1464 = WF.h("input", { type: "file", className: "wf-input", accept: "image/*" });
  _e1462.appendChild(_e1464);
  const _e1461 = _e1462;
  _e1420.appendChild(_e1461);
  const _e1466 = WF.h("div", { className: "wf-file-upload" });
  const _e1467 = WF.h("label", { className: "wf-form-label" }, "Documents");
  _e1466.appendChild(_e1467);
  const _e1468 = WF.h("input", { type: "file", className: "wf-input", accept: ".pdf,.doc" });
  _e1466.appendChild(_e1468);
  const _e1465 = _e1466;
  _e1420.appendChild(_e1465);
  _e1419.appendChild(_e1420);
  _e1418.appendChild(_e1419);
  _e1357.appendChild(_e1418);
  const _e1469 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1469);
  const _e1470 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1470);
  const _e1471 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1471);
  const _e1472 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Feedback");
  _e1357.appendChild(_e1472);
  const _e1473 = WF.h("p", { className: "wf-text" }, "Alerts, modals, progress bars, and loading indicators.");
  _e1357.appendChild(_e1473);
  const _e1474 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1474);
  const _e1475 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1476 = WF.h("div", { className: "wf-card__body" });
  const _e1477 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1478 = WF.h("div", { className: "wf-alert wf-alert--success" }, "This is a success alert.");
  _e1477.appendChild(_e1478);
  const _e1479 = WF.h("div", { className: "wf-alert wf-alert--warning" }, "This is a warning alert.");
  _e1477.appendChild(_e1479);
  const _e1480 = WF.h("div", { className: "wf-alert wf-alert--danger" }, "This is a danger alert.");
  _e1477.appendChild(_e1480);
  const _e1481 = WF.h("div", { className: "wf-alert wf-alert--info" }, "This is an info alert.");
  _e1477.appendChild(_e1481);
  _e1476.appendChild(_e1477);
  const _e1482 = WF.h("div", { className: "wf-spacer" });
  _e1476.appendChild(_e1482);
  const _e1483 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1484 = WF.h("div", { className: "wf-spinner" });
  _e1483.appendChild(_e1484);
  const _e1485 = WF.h("div", { className: "wf-spinner wf-spinner--large wf-spinner--primary" });
  _e1483.appendChild(_e1485);
  const _e1486 = WF.h("progress", { className: "wf-progress", value: _sliderVal(), max: 100 });
  _e1483.appendChild(_e1486);
  _e1476.appendChild(_e1483);
  const _e1487 = WF.h("div", { className: "wf-spacer" });
  _e1476.appendChild(_e1487);
  const _e1488 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(true); } }, "Open Modal");
  _e1476.appendChild(_e1488);
  _e1475.appendChild(_e1476);
  _e1357.appendChild(_e1475);
  const _e1489 = WF.h("div", { className: "wf-modal" });
  const _e1490 = WF.h("div", { className: "wf-modal__content" });
  const _e1491 = WF.h("div", { className: "wf-modal__header" }, WF.h("h3", {}, "Example Modal"));
  _e1490.appendChild(_e1491);
  const _e1492 = WF.h("div", { className: "wf-modal__body" });
  const _e1493 = WF.h("p", { className: "wf-text" }, "This is a real modal dialog. It was triggered by clicking the button.");
  _e1492.appendChild(_e1493);
  const _e1494 = WF.h("div", { className: "wf-spacer" });
  _e1492.appendChild(_e1494);
  const _e1495 = WF.h("p", { className: "wf-text wf-text--muted" }, "The modal is controlled by a state variable.");
  _e1492.appendChild(_e1495);
  _e1490.appendChild(_e1492);
  const _e1496 = WF.h("div", { className: "wf-modal__footer" });
  const _e1497 = WF.h("button", { className: "wf-btn", "on:click": (e) => { _activeModal.set(false); } }, "Close");
  _e1496.appendChild(_e1497);
  const _e1498 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { _activeModal.set(false); } }, "Confirm");
  _e1496.appendChild(_e1498);
  _e1490.appendChild(_e1496);
  _e1489.appendChild(_e1490);
  WF.effect(() => { _e1489.className = _activeModal() ? 'wf-modal open' : 'wf-modal'; });
  _e1357.appendChild(_e1489);
  const _e1499 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1499);
  const _e1500 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1500);
  const _e1501 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1501);
  const _e1502 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Data Display");
  _e1357.appendChild(_e1502);
  const _e1503 = WF.h("p", { className: "wf-text" }, "Tables, badges, avatars, tags, and tooltips.");
  _e1357.appendChild(_e1503);
  const _e1504 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1504);
  const _e1505 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1506 = WF.h("div", { className: "wf-card__body" });
  const _e1507 = WF.h("table", { className: "wf-table" });
  const _e1508 = WF.h("thead", {});
  const _e1509 = WF.h("td", {}, "Name");
  _e1508.appendChild(_e1509);
  const _e1510 = WF.h("td", {}, "Role");
  _e1508.appendChild(_e1510);
  const _e1511 = WF.h("td", {}, "Status");
  _e1508.appendChild(_e1511);
  _e1507.appendChild(_e1508);
  const _e1512 = WF.h("tr", {});
  const _e1513 = WF.h("td", {}, "Monzer Omer");
  _e1512.appendChild(_e1513);
  const _e1514 = WF.h("td", {}, "Creator");
  _e1512.appendChild(_e1514);
  const _e1515 = WF.h("td", {}, "Active");
  _e1512.appendChild(_e1515);
  _e1507.appendChild(_e1512);
  const _e1516 = WF.h("tr", {});
  const _e1517 = WF.h("td", {}, "Sara Ali");
  _e1516.appendChild(_e1517);
  const _e1518 = WF.h("td", {}, "Designer");
  _e1516.appendChild(_e1518);
  const _e1519 = WF.h("td", {}, "Active");
  _e1516.appendChild(_e1519);
  _e1507.appendChild(_e1516);
  const _e1520 = WF.h("tr", {});
  const _e1521 = WF.h("td", {}, "Omar Hassan");
  _e1520.appendChild(_e1521);
  const _e1522 = WF.h("td", {}, "Developer");
  _e1520.appendChild(_e1522);
  const _e1523 = WF.h("td", {}, "Away");
  _e1520.appendChild(_e1523);
  _e1507.appendChild(_e1520);
  _e1506.appendChild(_e1507);
  const _e1524 = WF.h("div", { className: "wf-spacer" });
  _e1506.appendChild(_e1524);
  const _e1525 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1526 = WF.h("div", { className: "wf-avatar wf-avatar--primary" }, "MO");
  _e1525.appendChild(_e1526);
  const _e1527 = WF.h("div", { className: "wf-avatar" }, "SA");
  _e1525.appendChild(_e1527);
  const _e1528 = WF.h("div", { className: "wf-avatar" }, "OH");
  _e1525.appendChild(_e1528);
  const _e1529 = WF.h("span", { className: "wf-badge wf-badge--primary" }, "Admin");
  _e1525.appendChild(_e1529);
  const _e1530 = WF.h("span", { className: "wf-badge wf-badge--success" }, "Online");
  _e1525.appendChild(_e1530);
  const _e1531 = WF.h("span", { className: "wf-tag" }, "WebFluent");
  _e1525.appendChild(_e1531);
  const _e1532 = WF.h("span", { className: "wf-tag" }, "Rust");
  _e1525.appendChild(_e1532);
  const _e1533 = WF.h("span", { className: "wf-tag" }, "Open Source");
  _e1525.appendChild(_e1533);
  _e1506.appendChild(_e1525);
  _e1505.appendChild(_e1506);
  _e1357.appendChild(_e1505);
  const _e1534 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1534);
  const _e1535 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1535);
  const _e1536 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1536);
  const _e1537 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Layout");
  _e1357.appendChild(_e1537);
  const _e1538 = WF.h("p", { className: "wf-text" }, "Container, Row, Column, Grid, Stack, Spacer, Divider.");
  _e1357.appendChild(_e1538);
  const _e1539 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1539);
  const _e1540 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1541 = WF.h("div", { className: "wf-card__body" });
  const _e1542 = WF.h("p", { className: "wf-text wf-text--bold" }, "Grid with 3 columns:");
  _e1541.appendChild(_e1542);
  const _e1543 = WF.h("div", { className: "wf-spacer" });
  _e1541.appendChild(_e1543);
  const _e1544 = WF.h("div", { className: "wf-grid wf-grid--gap-sm", style: { gridTemplateColumns: 'repeat(3, 1fr)' } });
  const _e1545 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1546 = WF.h("div", { className: "wf-card__body" });
  const _e1547 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 1");
  _e1546.appendChild(_e1547);
  _e1545.appendChild(_e1546);
  _e1544.appendChild(_e1545);
  const _e1548 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1549 = WF.h("div", { className: "wf-card__body" });
  const _e1550 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 2");
  _e1549.appendChild(_e1550);
  _e1548.appendChild(_e1549);
  _e1544.appendChild(_e1548);
  const _e1551 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1552 = WF.h("div", { className: "wf-card__body" });
  const _e1553 = WF.h("p", { className: "wf-text wf-text--center" }, "Column 3");
  _e1552.appendChild(_e1553);
  _e1551.appendChild(_e1552);
  _e1544.appendChild(_e1551);
  _e1541.appendChild(_e1544);
  const _e1554 = WF.h("div", { className: "wf-spacer" });
  _e1541.appendChild(_e1554);
  const _e1555 = WF.h("p", { className: "wf-text wf-text--bold" }, "Row with Columns (6/6 split):");
  _e1541.appendChild(_e1555);
  const _e1556 = WF.h("div", { className: "wf-spacer" });
  _e1541.appendChild(_e1556);
  const _e1557 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1558 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1559 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1560 = WF.h("div", { className: "wf-card__body" });
  const _e1561 = WF.h("p", { className: "wf-text wf-text--center" }, "Left Half");
  _e1560.appendChild(_e1561);
  _e1559.appendChild(_e1560);
  _e1558.appendChild(_e1559);
  _e1557.appendChild(_e1558);
  const _e1562 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1563 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1564 = WF.h("div", { className: "wf-card__body" });
  const _e1565 = WF.h("p", { className: "wf-text wf-text--center" }, "Right Half");
  _e1564.appendChild(_e1565);
  _e1563.appendChild(_e1564);
  _e1562.appendChild(_e1563);
  _e1557.appendChild(_e1562);
  _e1541.appendChild(_e1557);
  const _e1566 = WF.h("div", { className: "wf-spacer" });
  _e1541.appendChild(_e1566);
  const _e1567 = WF.h("p", { className: "wf-text wf-text--bold" }, "Stack (vertical):");
  _e1541.appendChild(_e1567);
  const _e1568 = WF.h("div", { className: "wf-spacer" });
  _e1541.appendChild(_e1568);
  const _e1569 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1570 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1571 = WF.h("div", { className: "wf-card__body" });
  const _e1572 = WF.h("p", { className: "wf-text" }, "Item 1");
  _e1571.appendChild(_e1572);
  _e1570.appendChild(_e1571);
  _e1569.appendChild(_e1570);
  const _e1573 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1574 = WF.h("div", { className: "wf-card__body" });
  const _e1575 = WF.h("p", { className: "wf-text" }, "Item 2");
  _e1574.appendChild(_e1575);
  _e1573.appendChild(_e1574);
  _e1569.appendChild(_e1573);
  const _e1576 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1577 = WF.h("div", { className: "wf-card__body" });
  const _e1578 = WF.h("p", { className: "wf-text" }, "Item 3");
  _e1577.appendChild(_e1578);
  _e1576.appendChild(_e1577);
  _e1569.appendChild(_e1576);
  _e1541.appendChild(_e1569);
  _e1540.appendChild(_e1541);
  _e1357.appendChild(_e1540);
  const _e1579 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1579);
  const _e1580 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1580);
  const _e1581 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1581);
  const _e1582 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Icons & Icon Buttons");
  _e1357.appendChild(_e1582);
  const _e1583 = WF.h("p", { className: "wf-text" }, "30 built-in SVG icons. Use Icon for display, IconButton for clickable actions.");
  _e1357.appendChild(_e1583);
  const _e1584 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1584);
  const _e1585 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1586 = WF.h("div", { className: "wf-card__body" });
  const _e1587 = WF.h("p", { className: "wf-text wf-text--bold" }, "Available Icons:");
  _e1586.appendChild(_e1587);
  const _e1588 = WF.h("div", { className: "wf-spacer" });
  _e1586.appendChild(_e1588);
  const _e1589 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1590 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1591 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1592 = WF.h("i", { className: "wf-icon" }, "home");
  _e1591.appendChild(_e1592);
  const _e1593 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "home");
  _e1591.appendChild(_e1593);
  _e1590.appendChild(_e1591);
  const _e1594 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1595 = WF.h("i", { className: "wf-icon" }, "search");
  _e1594.appendChild(_e1595);
  const _e1596 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "search");
  _e1594.appendChild(_e1596);
  _e1590.appendChild(_e1594);
  const _e1597 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1598 = WF.h("i", { className: "wf-icon" }, "user");
  _e1597.appendChild(_e1598);
  const _e1599 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "user");
  _e1597.appendChild(_e1599);
  _e1590.appendChild(_e1597);
  const _e1600 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1601 = WF.h("i", { className: "wf-icon" }, "settings");
  _e1600.appendChild(_e1601);
  const _e1602 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "settings");
  _e1600.appendChild(_e1602);
  _e1590.appendChild(_e1600);
  const _e1603 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1604 = WF.h("i", { className: "wf-icon" }, "mail");
  _e1603.appendChild(_e1604);
  const _e1605 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "mail");
  _e1603.appendChild(_e1605);
  _e1590.appendChild(_e1603);
  const _e1606 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1607 = WF.h("i", { className: "wf-icon" }, "bell");
  _e1606.appendChild(_e1607);
  const _e1608 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "bell");
  _e1606.appendChild(_e1608);
  _e1590.appendChild(_e1606);
  _e1589.appendChild(_e1590);
  const _e1609 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1610 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1611 = WF.h("i", { className: "wf-icon" }, "edit");
  _e1610.appendChild(_e1611);
  const _e1612 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "edit");
  _e1610.appendChild(_e1612);
  _e1609.appendChild(_e1610);
  const _e1613 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1614 = WF.h("i", { className: "wf-icon" }, "trash");
  _e1613.appendChild(_e1614);
  const _e1615 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "trash");
  _e1613.appendChild(_e1615);
  _e1609.appendChild(_e1613);
  const _e1616 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1617 = WF.h("i", { className: "wf-icon" }, "plus");
  _e1616.appendChild(_e1617);
  const _e1618 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "plus");
  _e1616.appendChild(_e1618);
  _e1609.appendChild(_e1616);
  const _e1619 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1620 = WF.h("i", { className: "wf-icon" }, "check");
  _e1619.appendChild(_e1620);
  const _e1621 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "check");
  _e1619.appendChild(_e1621);
  _e1609.appendChild(_e1619);
  const _e1622 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1623 = WF.h("i", { className: "wf-icon" }, "close");
  _e1622.appendChild(_e1623);
  const _e1624 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "close");
  _e1622.appendChild(_e1624);
  _e1609.appendChild(_e1622);
  const _e1625 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1626 = WF.h("i", { className: "wf-icon" }, "copy");
  _e1625.appendChild(_e1626);
  const _e1627 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "copy");
  _e1625.appendChild(_e1627);
  _e1609.appendChild(_e1625);
  _e1589.appendChild(_e1609);
  const _e1628 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1629 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1630 = WF.h("i", { className: "wf-icon" }, "star");
  _e1629.appendChild(_e1630);
  const _e1631 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "star");
  _e1629.appendChild(_e1631);
  _e1628.appendChild(_e1629);
  const _e1632 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1633 = WF.h("i", { className: "wf-icon" }, "heart");
  _e1632.appendChild(_e1633);
  const _e1634 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "heart");
  _e1632.appendChild(_e1634);
  _e1628.appendChild(_e1632);
  const _e1635 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1636 = WF.h("i", { className: "wf-icon" }, "eye");
  _e1635.appendChild(_e1636);
  const _e1637 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "eye");
  _e1635.appendChild(_e1637);
  _e1628.appendChild(_e1635);
  const _e1638 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1639 = WF.h("i", { className: "wf-icon" }, "download");
  _e1638.appendChild(_e1639);
  const _e1640 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "download");
  _e1638.appendChild(_e1640);
  _e1628.appendChild(_e1638);
  const _e1641 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1642 = WF.h("i", { className: "wf-icon" }, "upload");
  _e1641.appendChild(_e1642);
  const _e1643 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "upload");
  _e1641.appendChild(_e1643);
  _e1628.appendChild(_e1641);
  const _e1644 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1645 = WF.h("i", { className: "wf-icon" }, "link");
  _e1644.appendChild(_e1645);
  const _e1646 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "link");
  _e1644.appendChild(_e1646);
  _e1628.appendChild(_e1644);
  _e1589.appendChild(_e1628);
  const _e1647 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1648 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1649 = WF.h("i", { className: "wf-icon" }, "calendar");
  _e1648.appendChild(_e1649);
  const _e1650 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "calendar");
  _e1648.appendChild(_e1650);
  _e1647.appendChild(_e1648);
  const _e1651 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1652 = WF.h("i", { className: "wf-icon" }, "filter");
  _e1651.appendChild(_e1652);
  const _e1653 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "filter");
  _e1651.appendChild(_e1653);
  _e1647.appendChild(_e1651);
  const _e1654 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1655 = WF.h("i", { className: "wf-icon" }, "info");
  _e1654.appendChild(_e1655);
  const _e1656 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "info");
  _e1654.appendChild(_e1656);
  _e1647.appendChild(_e1654);
  const _e1657 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1658 = WF.h("i", { className: "wf-icon" }, "warning");
  _e1657.appendChild(_e1658);
  const _e1659 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "warning");
  _e1657.appendChild(_e1659);
  _e1647.appendChild(_e1657);
  const _e1660 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1661 = WF.h("i", { className: "wf-icon" }, "logout");
  _e1660.appendChild(_e1661);
  const _e1662 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "logout");
  _e1660.appendChild(_e1662);
  _e1647.appendChild(_e1660);
  const _e1663 = WF.h("div", { className: "wf-row wf-row--gap-sm wf-row--center" });
  const _e1664 = WF.h("i", { className: "wf-icon" }, "menu");
  _e1663.appendChild(_e1664);
  const _e1665 = WF.h("p", { className: "wf-text wf-text--muted wf-text--small" }, "menu");
  _e1663.appendChild(_e1665);
  _e1647.appendChild(_e1663);
  _e1589.appendChild(_e1647);
  _e1586.appendChild(_e1589);
  const _e1666 = WF.h("div", { className: "wf-spacer" });
  _e1586.appendChild(_e1666);
  const _e1667 = WF.h("p", { className: "wf-text wf-text--bold" }, "Icon Buttons:");
  _e1586.appendChild(_e1667);
  const _e1668 = WF.h("div", { className: "wf-spacer" });
  _e1586.appendChild(_e1668);
  const _e1669 = WF.h("div", { className: "wf-row wf-row--gap-sm" });
  const _e1670 = WF.h("button", { className: "wf-icon-btn", "data-icon": "edit", "aria-label": "Edit", title: "Edit" }, WF.h("span", { className: "wf-icon", "data-icon": "edit" }));
  _e1669.appendChild(_e1670);
  const _e1671 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--danger", "data-icon": "trash", "aria-label": "Delete", title: "Delete" }, WF.h("span", { className: "wf-icon", "data-icon": "trash" }));
  _e1669.appendChild(_e1671);
  const _e1672 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--primary", "data-icon": "plus", "aria-label": "Add", title: "Add" }, WF.h("span", { className: "wf-icon", "data-icon": "plus" }));
  _e1669.appendChild(_e1672);
  const _e1673 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--large", "data-icon": "search", "aria-label": "Search", title: "Search" }, WF.h("span", { className: "wf-icon", "data-icon": "search" }));
  _e1669.appendChild(_e1673);
  const _e1674 = WF.h("button", { className: "wf-icon-btn wf-icon-btn--small", "data-icon": "close", "aria-label": "Close", title: "Close" }, WF.h("span", { className: "wf-icon", "data-icon": "close" }));
  _e1669.appendChild(_e1674);
  _e1586.appendChild(_e1669);
  _e1585.appendChild(_e1586);
  _e1357.appendChild(_e1585);
  const _e1675 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1675);
  const _e1676 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1677 = WF.h("div", { className: "wf-card__body" });
  const _e1678 = WF.h("code", { className: "wf-code wf-code--block" }, "Icon(\"home\")\nIcon(\"search\", large, primary)\nIconButton(icon: \"edit\", label: \"Edit\")\nIconButton(icon: \"trash\", label: \"Delete\", danger)");
  _e1677.appendChild(_e1678);
  _e1676.appendChild(_e1677);
  _e1357.appendChild(_e1676);
  const _e1679 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1679);
  const _e1680 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1680);
  const _e1681 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1681);
  const _e1682 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Tooltips");
  _e1357.appendChild(_e1682);
  const _e1683 = WF.h("p", { className: "wf-text" }, "Wrap any element in a Tooltip to show text on hover.");
  _e1357.appendChild(_e1683);
  const _e1684 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1684);
  const _e1685 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1686 = WF.h("div", { className: "wf-card__body" });
  const _e1687 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1688 = WF.h("div", { className: "wf-tooltip" });
  const _e1689 = WF.h("button", { className: "wf-btn wf-btn--primary" }, "Hover me");
  _e1688.appendChild(_e1689);
  const _e1690 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip" }, "This is a primary button");
  _e1688.appendChild(_e1690);
  _e1687.appendChild(_e1688);
  const _e1691 = WF.h("div", { className: "wf-tooltip" });
  const _e1692 = WF.h("button", { className: "wf-btn wf-btn--danger" }, "Delete");
  _e1691.appendChild(_e1692);
  const _e1693 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip" }, "Deletes the item permanently");
  _e1691.appendChild(_e1693);
  _e1687.appendChild(_e1691);
  const _e1694 = WF.h("div", { className: "wf-tooltip" });
  const _e1695 = WF.h("div", { className: "wf-avatar wf-avatar--primary" }, "MO");
  _e1694.appendChild(_e1695);
  const _e1696 = WF.h("span", { className: "wf-tooltip__text", role: "tooltip" }, "User profile picture");
  _e1694.appendChild(_e1696);
  _e1687.appendChild(_e1694);
  _e1686.appendChild(_e1687);
  _e1685.appendChild(_e1686);
  _e1357.appendChild(_e1685);
  const _e1697 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1697);
  const _e1698 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1699 = WF.h("div", { className: "wf-card__body" });
  const _e1700 = WF.h("code", { className: "wf-code wf-code--block" }, "Tooltip(text: \"Help text\") {\n    Button(\"Hover me\", primary)\n}");
  _e1699.appendChild(_e1700);
  _e1698.appendChild(_e1699);
  _e1357.appendChild(_e1698);
  const _e1701 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1701);
  const _e1702 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1702);
  const _e1703 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1703);
  const _e1704 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Sidebar");
  _e1357.appendChild(_e1704);
  const _e1705 = WF.h("p", { className: "wf-text" }, "Sidebar navigation with header, items, and dividers. Items support icons and links.");
  _e1357.appendChild(_e1705);
  const _e1706 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1706);
  const _e1707 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1708 = WF.h("div", { className: "wf-card__body" });
  const _e1709 = WF.h("div", { className: "wf-row wf-row--gap-lg" });
  const _e1710 = WF.h("aside", { className: "wf-sidebar" });
  const _e1711 = WF.h("div", { className: "wf-sidebar__header" });
  const _e1712 = WF.h("p", { className: "wf-text wf-text--heading" }, "My App");
  _e1711.appendChild(_e1712);
  _e1710.appendChild(_e1711);
  const _e1713 = WF.h("a", { className: "wf-sidebar__item", href: WF._basePath +  "/" });
  _e1713.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "home" }));
  const _e1714 = WF.h("p", { className: "wf-text" }, "Dashboard");
  _e1713.appendChild(_e1714);
  _e1710.appendChild(_e1713);
  const _e1715 = WF.h("a", { className: "wf-sidebar__item", href: WF._basePath +  "/components" });
  _e1715.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "settings" }));
  const _e1716 = WF.h("p", { className: "wf-text" }, "Settings");
  _e1715.appendChild(_e1716);
  _e1710.appendChild(_e1715);
  const _e1717 = WF.h("div", { className: "wf-sidebar__item" });
  _e1717.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "user" }));
  const _e1718 = WF.h("p", { className: "wf-text" }, "Profile");
  _e1717.appendChild(_e1718);
  _e1710.appendChild(_e1717);
  _e1710.appendChild(WF.h("div", { className: "wf-sidebar__divider" }));
  const _e1719 = WF.h("div", { className: "wf-sidebar__item" });
  _e1719.appendChild(WF.h("span", { className: "wf-icon", "data-icon": "logout" }));
  const _e1720 = WF.h("p", { className: "wf-text" }, "Logout");
  _e1719.appendChild(_e1720);
  _e1710.appendChild(_e1719);
  _e1709.appendChild(_e1710);
  const _e1721 = WF.h("div", { className: "wf-stack" });
  const _e1722 = WF.h("p", { className: "wf-text wf-text--muted" }, "The sidebar renders with proper structure:");
  _e1721.appendChild(_e1722);
  const _e1723 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Header for the title");
  _e1721.appendChild(_e1723);
  const _e1724 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Item with to: and icon: props");
  _e1721.appendChild(_e1724);
  const _e1725 = WF.h("p", { className: "wf-text wf-text--small" }, "Sidebar.Divider for separation");
  _e1721.appendChild(_e1725);
  _e1709.appendChild(_e1721);
  _e1708.appendChild(_e1709);
  _e1707.appendChild(_e1708);
  _e1357.appendChild(_e1707);
  const _e1726 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1726);
  const _e1727 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1728 = WF.h("div", { className: "wf-card__body" });
  const _e1729 = WF.h("code", { className: "wf-code wf-code--block" }, "Sidebar {\n    Sidebar.Header { Text(\"My App\", heading) }\n    Sidebar.Item(to: \"/\", icon: \"home\") { Text(\"Dashboard\") }\n    Sidebar.Item(icon: \"settings\") { Text(\"Settings\") }\n    Sidebar.Divider()\n    Sidebar.Item(icon: \"logout\") { Text(\"Logout\") }\n}");
  _e1728.appendChild(_e1729);
  _e1727.appendChild(_e1728);
  _e1357.appendChild(_e1727);
  const _e1730 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1730);
  const _e1731 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1731);
  const _e1732 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1732);
  const _e1733 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Breadcrumb");
  _e1357.appendChild(_e1733);
  const _e1734 = WF.h("p", { className: "wf-text" }, "Show navigation hierarchy with automatic separators.");
  _e1357.appendChild(_e1734);
  const _e1735 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1735);
  const _e1736 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1737 = WF.h("div", { className: "wf-card__body" });
  const _e1738 = WF.h("nav", { className: "wf-breadcrumb", "aria-label": "breadcrumb" });
  const _e1739 = WF.h("a", { className: "wf-breadcrumb__item", href: WF._basePath + "/" });
  const _e1740 = WF.h("p", { className: "wf-text" }, "Home");
  _e1739.appendChild(_e1740);
  _e1738.appendChild(_e1739);
  const _e1741 = WF.h("a", { className: "wf-breadcrumb__item", href: WF._basePath + "/components" });
  const _e1742 = WF.h("p", { className: "wf-text" }, "Components");
  _e1741.appendChild(_e1742);
  _e1738.appendChild(_e1741);
  const _e1743 = WF.h("span", { className: "wf-breadcrumb__item" });
  const _e1744 = WF.h("p", { className: "wf-text" }, "Breadcrumb");
  _e1743.appendChild(_e1744);
  _e1738.appendChild(_e1743);
  _e1737.appendChild(_e1738);
  _e1736.appendChild(_e1737);
  _e1357.appendChild(_e1736);
  const _e1745 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1745);
  const _e1746 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1747 = WF.h("div", { className: "wf-card__body" });
  const _e1748 = WF.h("code", { className: "wf-code wf-code--block" }, "Breadcrumb {\n    Breadcrumb.Item(to: \"/\") { Text(\"Home\") }\n    Breadcrumb.Item(to: \"/docs\") { Text(\"Docs\") }\n    Breadcrumb.Item { Text(\"Current Page\") }\n}");
  _e1747.appendChild(_e1748);
  _e1746.appendChild(_e1747);
  _e1357.appendChild(_e1746);
  const _e1749 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1749);
  const _e1750 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1750);
  const _e1751 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1751);
  const _e1752 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Skeleton Loading");
  _e1357.appendChild(_e1752);
  const _e1753 = WF.h("p", { className: "wf-text" }, "Placeholder shapes that shimmer while content loads.");
  _e1357.appendChild(_e1753);
  const _e1754 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1754);
  const _e1755 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1756 = WF.h("div", { className: "wf-card__body" });
  const _e1757 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1758 = WF.h("div", { className: "wf-skeleton" });
  _e1758.style.height = "16px";
  _e1758.style.width = "80%";
  _e1757.appendChild(_e1758);
  const _e1759 = WF.h("div", { className: "wf-skeleton" });
  _e1759.style.height = "16px";
  _e1759.style.width = "60%";
  _e1757.appendChild(_e1759);
  const _e1760 = WF.h("div", { className: "wf-skeleton" });
  _e1760.style.height = "16px";
  _e1760.style.width = "40%";
  _e1757.appendChild(_e1760);
  const _e1761 = WF.h("div", { className: "wf-spacer" });
  _e1757.appendChild(_e1761);
  const _e1762 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1763 = WF.h("div", { className: "wf-skeleton" });
  _e1762.appendChild(_e1763);
  const _e1764 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e1765 = WF.h("div", { className: "wf-skeleton" });
  _e1765.style.height = "14px";
  _e1765.style.width = "120px";
  _e1764.appendChild(_e1765);
  const _e1766 = WF.h("div", { className: "wf-skeleton" });
  _e1766.style.height = "12px";
  _e1766.style.width = "80px";
  _e1764.appendChild(_e1766);
  _e1762.appendChild(_e1764);
  _e1757.appendChild(_e1762);
  _e1756.appendChild(_e1757);
  _e1755.appendChild(_e1756);
  _e1357.appendChild(_e1755);
  const _e1767 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1767);
  const _e1768 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1769 = WF.h("div", { className: "wf-card__body" });
  const _e1770 = WF.h("code", { className: "wf-code wf-code--block" }, "Skeleton(height: \"16px\", width: \"80%\")\nSkeleton(circle, size: \"48px\")");
  _e1769.appendChild(_e1770);
  _e1768.appendChild(_e1769);
  _e1357.appendChild(_e1768);
  const _e1771 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1771);
  const _e1772 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1772);
  const _e1773 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1773);
  const _e1774 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Dropdown & Menu");
  _e1357.appendChild(_e1774);
  const _e1775 = WF.h("p", { className: "wf-text" }, "Click-to-toggle dropdown menus with auto-close on outside click.");
  _e1357.appendChild(_e1775);
  const _e1776 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1776);
  const _e1777 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1778 = WF.h("div", { className: "wf-card__body" });
  const _e1779 = WF.h("div", { className: "wf-row wf-row--gap-lg" });
  const _e1781 = WF.signal(false);
  const _e1780 = WF.h("div", { className: () => _e1781() ? "wf-dropdown open" : "wf-dropdown" });
  const _e1782 = WF.h("button", { className: "wf-btn", "on:click": () => _e1781.set(!_e1781()) }, "Actions");
  _e1780.appendChild(_e1782);
  const _e1783 = WF.h("div", { className: "wf-dropdown__items" });
  const _e1784 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1785 = WF.h("p", { className: "wf-text" }, "Edit");
  _e1784.appendChild(_e1785);
  _e1783.appendChild(_e1784);
  const _e1786 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1787 = WF.h("p", { className: "wf-text" }, "Duplicate");
  _e1786.appendChild(_e1787);
  _e1783.appendChild(_e1786);
  const _e1788 = WF.h("div", { className: "wf-dropdown__divider" });
  _e1783.appendChild(_e1788);
  const _e1789 = WF.h("li", { className: "wf-dropdown__item" });
  const _e1790 = WF.h("p", { className: "wf-text" }, "Delete");
  _e1789.appendChild(_e1790);
  _e1783.appendChild(_e1789);
  _e1780.appendChild(_e1783);
  document.addEventListener('click', (e) => { if (!_e1780.contains(e.target)) _e1781.set(false); });
  _e1779.appendChild(_e1780);
  const _e1792 = WF.signal(false);
  const _e1791 = WF.h("div", { className: () => _e1792() ? "wf-menu open" : "wf-menu" });
  const _e1793 = WF.h("button", { className: "wf-btn", "on:click": () => _e1792.set(!_e1792()) }, "Options");
  _e1791.appendChild(_e1793);
  const _e1794 = WF.h("div", { className: "wf-menu__items" });
  const _e1795 = WF.h("li", { className: "wf-menu__item" });
  const _e1796 = WF.h("p", { className: "wf-text" }, "Profile");
  _e1795.appendChild(_e1796);
  _e1794.appendChild(_e1795);
  const _e1797 = WF.h("li", { className: "wf-menu__item" });
  const _e1798 = WF.h("p", { className: "wf-text" }, "Settings");
  _e1797.appendChild(_e1798);
  _e1794.appendChild(_e1797);
  const _e1799 = WF.h("div", { className: "wf-menu__divider" });
  _e1794.appendChild(_e1799);
  const _e1800 = WF.h("li", { className: "wf-menu__item" });
  const _e1801 = WF.h("p", { className: "wf-text" }, "Logout");
  _e1800.appendChild(_e1801);
  _e1794.appendChild(_e1800);
  _e1791.appendChild(_e1794);
  document.addEventListener('click', (e) => { if (!_e1791.contains(e.target)) _e1792.set(false); });
  _e1779.appendChild(_e1791);
  _e1778.appendChild(_e1779);
  _e1777.appendChild(_e1778);
  _e1357.appendChild(_e1777);
  const _e1802 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1802);
  const _e1803 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1804 = WF.h("div", { className: "wf-card__body" });
  const _e1805 = WF.h("code", { className: "wf-code wf-code--block" }, "Dropdown(label: \"Actions\") {\n    Dropdown.Item { Text(\"Edit\") }\n    Dropdown.Divider()\n    Dropdown.Item { Text(\"Delete\") }\n}");
  _e1804.appendChild(_e1805);
  _e1803.appendChild(_e1804);
  _e1357.appendChild(_e1803);
  const _e1806 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1806);
  const _e1807 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1807);
  const _e1808 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1808);
  const _e1809 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Navigation");
  _e1357.appendChild(_e1809);
  const _e1810 = WF.h("p", { className: "wf-text" }, "Tabs let you switch between content panels.");
  _e1357.appendChild(_e1810);
  const _e1811 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1811);
  const _e1812 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1813 = WF.h("div", { className: "wf-card__body" });
  const _e1814 = WF.h("div", { className: "wf-tabs" });
  const _e1815 = WF.h("div", { className: "wf-tabs__nav" });
  const _e1816 = WF.signal(0);
  const _e1817 = WF.h("button", { className: () => _e1816() === 0 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1816.set(0) }, "Profile");
  _e1815.appendChild(_e1817);
  const _e1818 = WF.h("button", { className: () => _e1816() === 1 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1816.set(1) }, "Settings");
  _e1815.appendChild(_e1818);
  const _e1819 = WF.h("button", { className: () => _e1816() === 2 ? "wf-tabs__tab active" : "wf-tabs__tab", "on:click": () => _e1816.set(2) }, "About");
  _e1815.appendChild(_e1819);
  _e1814.appendChild(_e1815);
  const _e1820 = WF.h("div", { className: "wf-tab-page" });
  const _e1821 = WF.h("div", { className: "wf-spacer" });
  _e1820.appendChild(_e1821);
  const _e1822 = WF.h("div", { className: "wf-row wf-row--gap-md wf-row--center" });
  const _e1823 = WF.h("div", { className: "wf-avatar wf-avatar--primary wf-avatar--large" }, "MO");
  _e1822.appendChild(_e1823);
  const _e1824 = WF.h("div", { className: "wf-stack" });
  const _e1825 = WF.h("p", { className: "wf-text wf-text--bold" }, "Monzer Omer");
  _e1824.appendChild(_e1825);
  const _e1826 = WF.h("p", { className: "wf-text wf-text--muted" }, "Creator of WebFluent");
  _e1824.appendChild(_e1826);
  _e1822.appendChild(_e1824);
  _e1820.appendChild(_e1822);
  WF.effect(() => { _e1820.style.display = _e1816() === 0 ? 'block' : 'none'; });
  _e1814.appendChild(_e1820);
  const _e1827 = WF.h("div", { className: "wf-tab-page" });
  const _e1828 = WF.h("div", { className: "wf-spacer" });
  _e1827.appendChild(_e1828);
  const _e1829 = WF.h("label", { className: "wf-switch" });
  const _e1830 = WF.h("input", { type: "checkbox", checked: () => _switchVal(), "on:change": () => _switchVal.set(!_switchVal()) });
  _e1829.appendChild(_e1830);
  const _e1831 = WF.h("span", { className: "wf-switch__track" }, WF.h("span", { className: "wf-switch__thumb" }));
  _e1829.appendChild(_e1831);
  _e1829.appendChild(WF.text("Enable notifications"));
  _e1827.appendChild(_e1829);
  const _e1832 = WF.h("div", { className: "wf-spacer" });
  _e1827.appendChild(_e1832);
  const _e1833 = WF.h("div", { className: "wf-slider" });
  const _e1834 = WF.h("label", { className: "wf-form-label" }, "Volume");
  _e1833.appendChild(_e1834);
  const _e1835 = WF.h("input", { type: "range", min: 0, max: 100, step: 1, value: () => _sliderVal(), "on:input": (e) => _sliderVal.set(Number(e.target.value)) });
  _e1833.appendChild(_e1835);
  const _e1836 = WF.h("span", { className: "wf-slider__value" }, () => String(_sliderVal()));
  _e1833.appendChild(_e1836);
  _e1827.appendChild(_e1833);
  WF.effect(() => { _e1827.style.display = _e1816() === 1 ? 'block' : 'none'; });
  _e1814.appendChild(_e1827);
  const _e1837 = WF.h("div", { className: "wf-tab-page" });
  const _e1838 = WF.h("div", { className: "wf-spacer" });
  _e1837.appendChild(_e1838);
  const _e1839 = WF.h("p", { className: "wf-text" }, "WebFluent is a web-first programming language.");
  _e1837.appendChild(_e1839);
  const _e1840 = WF.h("p", { className: "wf-text wf-text--muted" }, "It compiles to HTML, CSS, and JavaScript.");
  _e1837.appendChild(_e1840);
  WF.effect(() => { _e1837.style.display = _e1816() === 2 ? 'block' : 'none'; });
  _e1814.appendChild(_e1837);
  _e1813.appendChild(_e1814);
  _e1812.appendChild(_e1813);
  _e1357.appendChild(_e1812);
  const _e1841 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1841);
  const _e1842 = WF.h("hr", { className: "wf-divider" });
  _e1357.appendChild(_e1842);
  const _e1843 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1843);
  const _e1844 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Typography");
  _e1357.appendChild(_e1844);
  const _e1845 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1845);
  const _e1846 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1847 = WF.h("div", { className: "wf-card__body" });
  const _e1848 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Heading h2");
  _e1847.appendChild(_e1848);
  const _e1849 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Heading h2");
  _e1847.appendChild(_e1849);
  const _e1850 = WF.h("h2", { className: "wf-heading wf-heading--h3" }, "Heading h3");
  _e1847.appendChild(_e1850);
  const _e1851 = WF.h("div", { className: "wf-spacer" });
  _e1847.appendChild(_e1851);
  const _e1852 = WF.h("p", { className: "wf-text" }, "Normal text paragraph.");
  _e1847.appendChild(_e1852);
  const _e1853 = WF.h("p", { className: "wf-text wf-text--bold" }, "Bold text.");
  _e1847.appendChild(_e1853);
  const _e1854 = WF.h("p", { className: "wf-text wf-text--muted" }, "Muted text.");
  _e1847.appendChild(_e1854);
  const _e1855 = WF.h("p", { className: "wf-text wf-text--primary" }, "Primary colored.");
  _e1847.appendChild(_e1855);
  const _e1856 = WF.h("p", { className: "wf-text wf-text--danger" }, "Danger colored.");
  _e1847.appendChild(_e1856);
  const _e1857 = WF.h("p", { className: "wf-text wf-text--small" }, "Small text.");
  _e1847.appendChild(_e1857);
  const _e1858 = WF.h("p", { className: "wf-text wf-text--uppercase" }, "Uppercase.");
  _e1847.appendChild(_e1858);
  const _e1859 = WF.h("p", { className: "wf-text wf-text--center" }, "Centered text.");
  _e1847.appendChild(_e1859);
  const _e1860 = WF.h("div", { className: "wf-spacer" });
  _e1847.appendChild(_e1860);
  const _e1861 = WF.h("blockquote", { className: "wf-blockquote" }, "The best way to predict the future is to create it.");
  _e1847.appendChild(_e1861);
  const _e1862 = WF.h("div", { className: "wf-spacer" });
  _e1847.appendChild(_e1862);
  const _e1863 = WF.h("code", { className: "wf-code" }, "const greeting = \"Hello, WebFluent!\";");
  _e1847.appendChild(_e1863);
  _e1846.appendChild(_e1847);
  _e1357.appendChild(_e1846);
  const _e1864 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1864);
  const _e1865 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1866 = WF.h("button", { className: "wf-btn wf-btn--primary", "on:click": (e) => { WF.navigate("/styling"); } }, "Styling Guide");
  _e1865.appendChild(_e1866);
  const _e1867 = WF.h("button", { className: "wf-btn", "on:click": (e) => { WF.navigate("/animation"); } }, "Animation System");
  _e1865.appendChild(_e1867);
  _e1357.appendChild(_e1865);
  const _e1868 = WF.h("div", { className: "wf-spacer" });
  _e1357.appendChild(_e1868);
  _root.appendChild(_e1357);
  return _root;
}

function Page_Accessibility(params) {
  const _root = document.createDocumentFragment();
  const _e1869 = WF.h("div", { className: "wf-container wf-animate-fadeIn" });
  const _e1870 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1870);
  const _e1871 = WF.h("h2", { className: "wf-heading wf-heading--h1" }, "Accessibility Linting");
  _e1869.appendChild(_e1871);
  const _e1872 = WF.h("p", { className: "wf-text wf-text--muted" }, "WebFluent checks your code for accessibility issues at compile time. Warnings are printed during build but never block compilation.");
  _e1869.appendChild(_e1872);
  const _e1873 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1873);
  const _e1874 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "How It Works");
  _e1869.appendChild(_e1874);
  const _e1875 = WF.h("p", { className: "wf-text" }, "The linter runs automatically after parsing, before code generation. It walks the AST and checks each component against 12 rules.");
  _e1869.appendChild(_e1875);
  const _e1876 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1876);
  const _e1877 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1878 = WF.h("div", { className: "wf-card__body" });
  const _e1879 = WF.h("code", { className: "wf-code wf-code--block" }, "$ wf build\nBuilding my-app...\n  Warning [A01]: Image missing \"alt\" attribute at src/pages/Home.wf:12:5\n    Add alt text: Image(src: \"...\", alt: \"Description of image\")\n  Warning [A03]: Input missing \"label\" attribute at src/pages/Form.wf:8:9\n    Add a label: Input(text, label: \"Username\")\n  3 pages, 2 components, 1 stores\n  Build complete with 2 accessibility warning(s).");
  _e1878.appendChild(_e1879);
  _e1877.appendChild(_e1878);
  _e1869.appendChild(_e1877);
  const _e1880 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1880);
  const _e1881 = WF.h("hr", { className: "wf-divider" });
  _e1869.appendChild(_e1881);
  const _e1882 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1882);
  const _e1883 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Lint Rules");
  _e1869.appendChild(_e1883);
  const _e1884 = WF.h("table", { className: "wf-table" });
  const _e1885 = WF.h("thead", {});
  const _e1886 = WF.h("td", {}, "Rule");
  _e1885.appendChild(_e1886);
  const _e1887 = WF.h("td", {}, "Component");
  _e1885.appendChild(_e1887);
  const _e1888 = WF.h("td", {}, "Check");
  _e1885.appendChild(_e1888);
  _e1884.appendChild(_e1885);
  const _e1889 = WF.h("tr", {});
  const _e1890 = WF.h("td", {}, "A01");
  _e1889.appendChild(_e1890);
  const _e1891 = WF.h("td", {}, "Image");
  _e1889.appendChild(_e1891);
  const _e1892 = WF.h("td", {}, "Must have alt attribute");
  _e1889.appendChild(_e1892);
  _e1884.appendChild(_e1889);
  const _e1893 = WF.h("tr", {});
  const _e1894 = WF.h("td", {}, "A02");
  _e1893.appendChild(_e1894);
  const _e1895 = WF.h("td", {}, "IconButton");
  _e1893.appendChild(_e1895);
  const _e1896 = WF.h("td", {}, "Must have label attribute (no visible text)");
  _e1893.appendChild(_e1896);
  _e1884.appendChild(_e1893);
  const _e1897 = WF.h("tr", {});
  const _e1898 = WF.h("td", {}, "A03");
  _e1897.appendChild(_e1898);
  const _e1899 = WF.h("td", {}, "Input");
  _e1897.appendChild(_e1899);
  const _e1900 = WF.h("td", {}, "Must have label or placeholder");
  _e1897.appendChild(_e1900);
  _e1884.appendChild(_e1897);
  const _e1901 = WF.h("tr", {});
  const _e1902 = WF.h("td", {}, "A04");
  _e1901.appendChild(_e1902);
  const _e1903 = WF.h("td", {}, "Checkbox, Radio, Switch, Slider");
  _e1901.appendChild(_e1903);
  const _e1904 = WF.h("td", {}, "Must have label attribute");
  _e1901.appendChild(_e1904);
  _e1884.appendChild(_e1901);
  const _e1905 = WF.h("tr", {});
  const _e1906 = WF.h("td", {}, "A05");
  _e1905.appendChild(_e1906);
  const _e1907 = WF.h("td", {}, "Button");
  _e1905.appendChild(_e1907);
  const _e1908 = WF.h("td", {}, "Must have text content");
  _e1905.appendChild(_e1908);
  _e1884.appendChild(_e1905);
  const _e1909 = WF.h("tr", {});
  const _e1910 = WF.h("td", {}, "A06");
  _e1909.appendChild(_e1910);
  const _e1911 = WF.h("td", {}, "Link");
  _e1909.appendChild(_e1911);
  const _e1912 = WF.h("td", {}, "Must have text content or children");
  _e1909.appendChild(_e1912);
  _e1884.appendChild(_e1909);
  const _e1913 = WF.h("tr", {});
  const _e1914 = WF.h("td", {}, "A07");
  _e1913.appendChild(_e1914);
  const _e1915 = WF.h("td", {}, "Heading");
  _e1913.appendChild(_e1915);
  const _e1916 = WF.h("td", {}, "Must not be empty");
  _e1913.appendChild(_e1916);
  _e1884.appendChild(_e1913);
  const _e1917 = WF.h("tr", {});
  const _e1918 = WF.h("td", {}, "A08");
  _e1917.appendChild(_e1918);
  const _e1919 = WF.h("td", {}, "Modal, Dialog");
  _e1917.appendChild(_e1919);
  const _e1920 = WF.h("td", {}, "Must have title attribute");
  _e1917.appendChild(_e1920);
  _e1884.appendChild(_e1917);
  const _e1921 = WF.h("tr", {});
  const _e1922 = WF.h("td", {}, "A09");
  _e1921.appendChild(_e1922);
  const _e1923 = WF.h("td", {}, "Video");
  _e1921.appendChild(_e1923);
  const _e1924 = WF.h("td", {}, "Must have controls attribute");
  _e1921.appendChild(_e1924);
  _e1884.appendChild(_e1921);
  const _e1925 = WF.h("tr", {});
  const _e1926 = WF.h("td", {}, "A10");
  _e1925.appendChild(_e1926);
  const _e1927 = WF.h("td", {}, "Table");
  _e1925.appendChild(_e1927);
  const _e1928 = WF.h("td", {}, "Must have Thead header row");
  _e1925.appendChild(_e1928);
  _e1884.appendChild(_e1925);
  const _e1929 = WF.h("tr", {});
  const _e1930 = WF.h("td", {}, "A11");
  _e1929.appendChild(_e1930);
  const _e1931 = WF.h("td", {}, "Heading");
  _e1929.appendChild(_e1931);
  const _e1932 = WF.h("td", {}, "Levels must not skip (h1 to h3)");
  _e1929.appendChild(_e1932);
  _e1884.appendChild(_e1929);
  const _e1933 = WF.h("tr", {});
  const _e1934 = WF.h("td", {}, "A12");
  _e1933.appendChild(_e1934);
  const _e1935 = WF.h("td", {}, "Page");
  _e1933.appendChild(_e1935);
  const _e1936 = WF.h("td", {}, "Must have exactly one h1");
  _e1933.appendChild(_e1936);
  _e1884.appendChild(_e1933);
  _e1869.appendChild(_e1884);
  const _e1937 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1937);
  const _e1938 = WF.h("hr", { className: "wf-divider" });
  _e1869.appendChild(_e1938);
  const _e1939 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1939);
  const _e1940 = WF.h("h2", { className: "wf-heading wf-heading--h2" }, "Examples");
  _e1869.appendChild(_e1940);
  const _e1941 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e1942 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1943 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1944 = WF.h("div", { className: "wf-card__body" });
  const _e1945 = WF.h("p", { className: "wf-text wf-text--danger wf-text--bold" }, "Bad (triggers warning)");
  _e1944.appendChild(_e1945);
  const _e1946 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\")\nIconButton(icon: \"close\")\nInput(text)\nCheckbox(bind: agreed)\nButton()");
  _e1944.appendChild(_e1946);
  _e1943.appendChild(_e1944);
  _e1942.appendChild(_e1943);
  _e1941.appendChild(_e1942);
  const _e1947 = WF.h("div", { className: "wf-col wf-col--6" });
  const _e1948 = WF.h("div", { className: "wf-card wf-card--outlined" });
  const _e1949 = WF.h("div", { className: "wf-card__body" });
  const _e1950 = WF.h("p", { className: "wf-text wf-text--success wf-text--bold" }, "Good (no warnings)");
  _e1949.appendChild(_e1950);
  const _e1951 = WF.h("code", { className: "wf-code wf-code--block" }, "Image(src: \"/photo.jpg\", alt: \"Team photo\")\nIconButton(icon: \"close\", label: \"Close\")\nInput(text, label: \"Username\")\nCheckbox(bind: agreed, label: \"I agree\")\nButton(\"Save\")");
  _e1949.appendChild(_e1951);
  _e1948.appendChild(_e1949);
  _e1947.appendChild(_e1948);
  _e1941.appendChild(_e1947);
  _e1869.appendChild(_e1941);
  const _e1952 = WF.h("div", { className: "wf-spacer" });
  _e1869.appendChild(_e1952);
  _root.appendChild(_e1869);
  return _root;
}
