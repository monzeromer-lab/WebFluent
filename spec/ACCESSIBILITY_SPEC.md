...
> **Status: a design note, kept for its reasoning.** The current, tested description is the guide — [`md-docs/`](../md-docs/README.md), here 22-accessibility.md and 39-diagnostics.md. Where the two differ, the guide is right.
