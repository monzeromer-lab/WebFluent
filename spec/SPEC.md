...
> **Status: a design note, kept for its reasoning.** The current, tested description is the guide — [`md-docs/`](../md-docs/README.md), here 15-styling.md, 05-language-basics.md and 36-components-reference.md. Where the two differ, the guide is right.
