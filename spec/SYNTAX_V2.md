...
> **Status: a design note, kept for its reasoning.** The current, tested description is the guide — [`md-docs/`](../md-docs/README.md), here 43-grammar.md. Where the two differ, the guide is right.
